...
class NewRFSDataNode:
    #Defines the RFSharing Report column index 
    #which maps to the database search result
    ...
    _VERERSION = 3
    _OPERATIONL = 4
    _SHARED = 5 # The shared status, Master or Slave
    _CRITICAL_ALARM = 6 # Number of critical alarms
    _MAJOR_ALARM = 7 # Number of major alarms
    _MINOR_ALARM = 8 # Number of minor alarms
    _COMMON_STATE = 9 # State of common object
    _AD = 10 # Administrative state 
    _MEDIATOR = 11
    _MEDIATOR_3G = 12
    _MEDIATOR_4G = 13
    _CLASS_ID = 14
    ...
    def getExportValues(self):
        ...
        return [self.nodeValues[1], self.nodeValues[2]
                ,self.nodeValues[3], self.nodeValues[4]
                ,self.nodeValues[5]]
    
    def getAllColumnValues(self):
        return [ self._data[self._GID]
                 ,self._data[self._DN]
                 ,self._data[self._MRSITE]
                 ,self._data[self._SHARED]
                 ,self._data[self._MEDIATOR]
                 ,self.getAlarms()
                 ,self._data[self._VERERSION]
                 ,self._data[self._COMMON_STATE]]
    ...
    def setDN(self, value):
        self._data[self._DN] = value
    
    def getDN(self):
        return self._data[self._DN]
    
    def setMRSITE(self, value):
        self._data[self._MRSITE] = value 
    
    def getMRSITE(self):
        return self._data[self._MRSITE]
    ...
    def setMediator(self, value):
        self._data[self._MEDIATOR] = value
    
    def getMediator(self):
        return self._data[self._MEDIATOR]
    
    def set3gMediator(self, value):
        self._data[self._MEDIATOR_3G] = value
    
    def get3gMediator(self):
        return self._data[self._MEDIATOR_3G]
    
    def set4gMediator(self, value):
        self._data[self._MEDIATOR_4G] = value
        
    def get4gMediator(self):
        return self._data[self._MEDIATOR_4G]
    ...
    def setTopOMS(self, value):
        self._data[self._TEMP_OMS] = value
        
    def getTopOMS(self):
        return self._data[self._TEMP_OMS]       
