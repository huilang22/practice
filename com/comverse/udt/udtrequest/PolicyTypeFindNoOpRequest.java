 ...
 * Filename
 * ========
 * PolicyTypeFindNoOpRequest.java
 *
...
/**
 *
 * NoOp class used to simulate a PolicyTypeFindNoOpRequest Udt Request/Response
 *
 */
public class PolicyTypeFindNoOpRequest extends ComponentPolicyMapRequest {
/**
 *
 * Constructor to create a   PolicyTypeFindNoOpRequest
 * @param id Unique request name
 * @param noOpIn Simulated response object
 *
 */
  public PolicyTypeFindNoOpRequest(String id, ComponentPolicyMapObjectDataList noOpIn) {
    super(id, "PolicyTypeFindNoOpRequest");
    if (noOpIn != null) {
