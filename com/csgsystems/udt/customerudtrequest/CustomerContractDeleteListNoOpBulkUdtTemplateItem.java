 ...
 * Generated file: CustomerContractDeleteListNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a CustomerContractDeleteListNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class CustomerContractDeleteListNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected CustomerContractObjectBaseDataList noOpIn;

/**
 *
 * Constructor to create a   CustomerContractDeleteListNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public CustomerContractDeleteListNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, CustomerContractObjectBaseDataList noOpInIn) {
