 ...
 * Generated file: CustomerIdEquipMapFindPendingNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a CustomerIdEquipMapFindPendingNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class CustomerIdEquipMapFindPendingNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected CustomerIdEquipMapObjectDataList noOpIn;

/**
 *
 * Constructor to create a   CustomerIdEquipMapFindPendingNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public CustomerIdEquipMapFindPendingNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, CustomerIdEquipMapObjectDataList noOpInIn) {
