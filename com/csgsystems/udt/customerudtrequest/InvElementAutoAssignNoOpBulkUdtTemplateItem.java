 ...
 * Generated file: InvElementAutoAssignNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvElementAutoAssignNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvElementAutoAssignNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvElementObjDataList noOpIn;

/**
 *
 * Constructor to create a   InvElementAutoAssignNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvElementAutoAssignNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvElementObjDataList noOpInIn) {
