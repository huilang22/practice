 ...
 * Generated file: TransferReasonGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a TransferReasonGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class TransferReasonGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected TransferReasonObjectData noOpIn;

/**
 *
 * Constructor to create a   TransferReasonGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public TransferReasonGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, TransferReasonObjectData noOpInIn) {
