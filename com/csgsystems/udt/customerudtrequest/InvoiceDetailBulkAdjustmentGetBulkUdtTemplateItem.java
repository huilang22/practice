 ...
 * Generated file: InvoiceDetailBulkAdjustmentGetBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a InvoiceDetailBulkAdjustmentGetBulkUdtTemplateItem Bulk Template
 *
 */

public class InvoiceDetailBulkAdjustmentGetBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected BatchRequestObjectKeyData ___BatchRequest;
/**
 *
 * Constructor to create a  InvoiceDetailBulkAdjustmentGetBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public InvoiceDetailBulkAdjustmentGetBulkUdtTemplateItem(String id, BSDMSessionContext context, BatchRequestObjectKeyData ___BatchRequestIn) {
