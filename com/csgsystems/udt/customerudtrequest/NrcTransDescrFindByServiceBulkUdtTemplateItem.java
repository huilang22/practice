 ...
 * Generated file: NrcTransDescrFindByServiceBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a NrcTransDescrFindByServiceBulkUdtTemplateItem Bulk Template
 *
 */

public class NrcTransDescrFindByServiceBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected Integer LanguageCode;
  protected Integer service_internal_id;
  protected Integer service_internal_id_resets;
/**
 *
 * Constructor to create a  NrcTransDescrFindByServiceBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public NrcTransDescrFindByServiceBulkUdtTemplateItem(String id, BSDMSessionContext context, Integer LanguageCodeIn, Integer service_internal_idIn, Integer service_internal_id_resetsIn) {
