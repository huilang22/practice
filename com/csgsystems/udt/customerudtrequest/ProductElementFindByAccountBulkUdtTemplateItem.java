 ...
 * Generated file: ProductElementFindByAccountBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ProductElementFindByAccountBulkUdtTemplateItem Bulk Template
 *
 */

public class ProductElementFindByAccountBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected Integer language_code;
  protected Integer account_internal_id;
/**
 *
 * Constructor to create a  ProductElementFindByAccountBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ProductElementFindByAccountBulkUdtTemplateItem(String id, BSDMSessionContext context, Integer language_codeIn, Integer account_internal_idIn) {
