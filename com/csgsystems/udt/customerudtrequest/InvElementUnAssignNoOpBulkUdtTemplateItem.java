 ...
 * Generated file: InvElementUnAssignNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvElementUnAssignNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvElementUnAssignNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvElementObjDataList noOpIn;

/**
 *
 * Constructor to create a   InvElementUnAssignNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvElementUnAssignNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvElementObjDataList noOpInIn) {
