 ...
 * Generated file: ServServiceTypeFindBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ServServiceTypeFindBulkUdtTemplateItem Bulk Template
 *
 */

public class ServServiceTypeFindBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected BigInteger AddressIdIn;
  protected Integer IndustryTypeId;
  protected Date ServiceableDt;
/**
 *
 * Constructor to create a  ServServiceTypeFindBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ServServiceTypeFindBulkUdtTemplateItem(String id, BSDMSessionContext context, BigInteger AddressIdInIn, Integer IndustryTypeIdIn, Date ServiceableDtIn) {
