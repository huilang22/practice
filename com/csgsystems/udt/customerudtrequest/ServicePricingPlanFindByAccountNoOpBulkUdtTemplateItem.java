 ...
 * Generated file: ServicePricingPlanFindByAccountNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ServicePricingPlanFindByAccountNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ServicePricingPlanFindByAccountNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ServicePricingPlanObjectDataList noOpIn;

/**
 *
 * Constructor to create a   ServicePricingPlanFindByAccountNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ServicePricingPlanFindByAccountNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ServicePricingPlanObjectDataList noOpInIn) {
