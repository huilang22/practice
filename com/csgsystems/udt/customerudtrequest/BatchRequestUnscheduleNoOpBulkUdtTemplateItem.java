 ...
 * Generated file: BatchRequestUnscheduleNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BatchRequestUnscheduleNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BatchRequestUnscheduleNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BatchRequestObjectData noOpIn;

/**
 *
 * Constructor to create a   BatchRequestUnscheduleNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BatchRequestUnscheduleNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BatchRequestObjectData noOpInIn) {
