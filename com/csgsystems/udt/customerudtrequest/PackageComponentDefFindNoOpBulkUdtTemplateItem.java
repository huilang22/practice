 ...
 * Generated file: PackageComponentDefFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a PackageComponentDefFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class PackageComponentDefFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected PCDObjectDataList noOpIn;

/**
 *
 * Constructor to create a   PackageComponentDefFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public PackageComponentDefFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, PCDObjectDataList noOpInIn) {
