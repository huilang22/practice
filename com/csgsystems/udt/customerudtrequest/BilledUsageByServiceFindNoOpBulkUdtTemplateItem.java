 ...
 * Generated file: BilledUsageByServiceFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BilledUsageByServiceFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BilledUsageByServiceFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BilledUsageObjectDataList noOpIn;

/**
 *
 * Constructor to create a   BilledUsageByServiceFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BilledUsageByServiceFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BilledUsageObjectDataList noOpInIn) {
