 ...
 * Generated file: CustomerContractHqFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a CustomerContractHqFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class CustomerContractHqFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected CustomerContractObjectBaseDataList noOpIn;

/**
 *
 * Constructor to create a   CustomerContractHqFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public CustomerContractHqFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, CustomerContractObjectBaseDataList noOpInIn) {
