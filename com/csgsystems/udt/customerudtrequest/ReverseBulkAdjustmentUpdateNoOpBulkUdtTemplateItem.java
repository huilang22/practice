 ...
 * Generated file: ReverseBulkAdjustmentUpdateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ReverseBulkAdjustmentUpdateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ReverseBulkAdjustmentUpdateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BatchRequestObjectData noOpIn;

/**
 *
 * Constructor to create a   ReverseBulkAdjustmentUpdateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ReverseBulkAdjustmentUpdateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BatchRequestObjectData noOpInIn) {
