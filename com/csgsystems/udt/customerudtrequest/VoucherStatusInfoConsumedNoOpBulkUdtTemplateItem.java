 ...
 * Generated file: VoucherStatusInfoConsumedNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a VoucherStatusInfoConsumedNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class VoucherStatusInfoConsumedNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected VoucherStatusInfoObjectData noOpIn;

/**
 *
 * Constructor to create a   VoucherStatusInfoConsumedNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public VoucherStatusInfoConsumedNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, VoucherStatusInfoObjectData noOpInIn) {
