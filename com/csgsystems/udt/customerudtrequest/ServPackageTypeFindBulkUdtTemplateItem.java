 ...
 * Generated file: ServPackageTypeFindBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ServPackageTypeFindBulkUdtTemplateItem Bulk Template
 *
 */

public class ServPackageTypeFindBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected BigInteger AddressIdIn;
  protected Integer IndustryTypeId;
  protected Date ServiceableDt;
/**
 *
 * Constructor to create a  ServPackageTypeFindBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ServPackageTypeFindBulkUdtTemplateItem(String id, BSDMSessionContext context, BigInteger AddressIdInIn, Integer IndustryTypeIdIn, Date ServiceableDtIn) {
    super(id, context, "ServPackageTypeFind");
