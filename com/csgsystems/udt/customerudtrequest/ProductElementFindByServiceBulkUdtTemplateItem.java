 ...
 * Generated file: ProductElementFindByServiceBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ProductElementFindByServiceBulkUdtTemplateItem Bulk Template
 *
 */

public class ProductElementFindByServiceBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected Integer LanguageCode;
  protected Integer service_internal_id;
  protected Integer service_internal_id_resets;
/**
 *
 * Constructor to create a  ProductElementFindByServiceBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ProductElementFindByServiceBulkUdtTemplateItem(String id, BSDMSessionContext context, Integer LanguageCodeIn, Integer service_internal_idIn, Integer service_internal_id_resetsIn) {
    super(id, context, "ProductElementFindByService");
