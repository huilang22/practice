 ...
 * Generated file: ServiceablePackageTypeFindBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ServiceablePackageTypeFindBulkUdtTemplateItem Bulk Template
 *
 */

public class ServiceablePackageTypeFindBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected BigInteger AddressIdIn;
  protected Integer IndustryTypeId;
  protected Date ServiceableDt;
/**
 *
 * Constructor to create a  ServiceablePackageTypeFindBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ServiceablePackageTypeFindBulkUdtTemplateItem(String id, BSDMSessionContext context, BigInteger AddressIdInIn, Integer IndustryTypeIdIn, Date ServiceableDtIn) {
