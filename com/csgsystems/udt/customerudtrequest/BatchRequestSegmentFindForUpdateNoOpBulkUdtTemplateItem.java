 ...
 * Generated file: BatchRequestSegmentFindForUpdateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BatchRequestSegmentFindForUpdateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BatchRequestSegmentFindForUpdateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BatchRequestSegmentObjectDataList noOpIn;

/**
 *
 * Constructor to create a   BatchRequestSegmentFindForUpdateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BatchRequestSegmentFindForUpdateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BatchRequestSegmentObjectDataList noOpInIn) {
