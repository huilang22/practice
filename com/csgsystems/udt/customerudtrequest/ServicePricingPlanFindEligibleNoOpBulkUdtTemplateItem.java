 ...
 * Generated file: ServicePricingPlanFindEligibleNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ServicePricingPlanFindEligibleNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ServicePricingPlanFindEligibleNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ServicePricingPlanObjectDataList noOpIn;

/**
 *
 * Constructor to create a   ServicePricingPlanFindEligibleNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ServicePricingPlanFindEligibleNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ServicePricingPlanObjectDataList noOpInIn) {
