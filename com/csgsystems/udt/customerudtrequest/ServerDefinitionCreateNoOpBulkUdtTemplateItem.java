 ...
 * Generated file: ServerDefinitionCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ServerDefinitionCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ServerDefinitionCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ServerDefinitionObjectData noOpIn;

/**
 *
 * Constructor to create a   ServerDefinitionCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ServerDefinitionCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ServerDefinitionObjectData noOpInIn) {
