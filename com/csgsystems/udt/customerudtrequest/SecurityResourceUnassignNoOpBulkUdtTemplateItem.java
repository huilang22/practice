 ...
 * Generated file: SecurityResourceUnassignNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a SecurityResourceUnassignNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class SecurityResourceUnassignNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected SecurityResourceObjectDataList noOpIn;

/**
 *
 * Constructor to create a   SecurityResourceUnassignNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public SecurityResourceUnassignNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, SecurityResourceObjectDataList noOpInIn) {
