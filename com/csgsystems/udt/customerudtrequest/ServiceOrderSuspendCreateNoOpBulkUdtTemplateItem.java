 ...
 * Generated file: ServiceOrderSuspendCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ServiceOrderSuspendCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ServiceOrderSuspendCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ServiceOrderObjectBaseDataList noOpIn;

/**
 *
 * Constructor to create a   ServiceOrderSuspendCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ServiceOrderSuspendCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ServiceOrderObjectBaseDataList noOpInIn) {
