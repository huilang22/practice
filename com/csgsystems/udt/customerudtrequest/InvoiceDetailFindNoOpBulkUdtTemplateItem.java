 ...
 * Generated file: InvoiceDetailFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvoiceDetailFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvoiceDetailFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvoiceDetailObjectDataList noOpIn;

/**
 *
 * Constructor to create a   InvoiceDetailFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvoiceDetailFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvoiceDetailObjectDataList noOpInIn) {
