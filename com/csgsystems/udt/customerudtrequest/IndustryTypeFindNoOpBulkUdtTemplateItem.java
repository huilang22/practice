 ...
 * Generated file: IndustryTypeFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a IndustryTypeFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class IndustryTypeFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected IndustryTypeObjectDataList noOpIn;

/**
 *
 * Constructor to create a   IndustryTypeFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public IndustryTypeFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, IndustryTypeObjectDataList noOpInIn) {
