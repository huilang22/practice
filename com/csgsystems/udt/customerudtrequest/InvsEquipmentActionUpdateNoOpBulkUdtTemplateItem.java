 ...
 * Generated file: InvsEquipmentActionUpdateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvsEquipmentActionUpdateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvsEquipmentActionUpdateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvsEquipmentActionObjectData noOpIn;

/**
 *
 * Constructor to create a   InvsEquipmentActionUpdateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvsEquipmentActionUpdateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvsEquipmentActionObjectData noOpInIn) {
