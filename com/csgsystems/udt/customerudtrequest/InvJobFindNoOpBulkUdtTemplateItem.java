 ...
 * Generated file: InvJobFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvJobFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvJobFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvJobObjectDataList noOpIn;

/**
 *
 * Constructor to create a   InvJobFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvJobFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvJobObjectDataList noOpInIn) {
