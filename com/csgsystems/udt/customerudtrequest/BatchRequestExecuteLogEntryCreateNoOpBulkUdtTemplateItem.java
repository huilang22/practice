 ...
 * Generated file: BatchRequestExecuteLogEntryCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BatchRequestExecuteLogEntryCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BatchRequestExecuteLogEntryCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BatchRequestExecuteLogEntryObjectData noOpIn;

/**
 *
 * Constructor to create a   BatchRequestExecuteLogEntryCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BatchRequestExecuteLogEntryCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BatchRequestExecuteLogEntryObjectData noOpInIn) {
