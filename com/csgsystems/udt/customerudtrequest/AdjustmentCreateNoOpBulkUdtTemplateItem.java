 ...
 * Generated file: AdjustmentCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a AdjustmentCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class AdjustmentCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected AdjustmentObjectData noOpIn;

/**
 *
 * Constructor to create a   AdjustmentCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public AdjustmentCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, AdjustmentObjectData noOpInIn) {
