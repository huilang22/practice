 ...
 * Generated file: DistanceBandGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a DistanceBandGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class DistanceBandGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected DistanceBandObjectData noOpIn;

/**
 *
 * Constructor to create a   DistanceBandGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public DistanceBandGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, DistanceBandObjectData noOpInIn) {
