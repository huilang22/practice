 ...
 * Generated file: AdjustmentTypeByGroupFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a AdjustmentTypeByGroupFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class AdjustmentTypeByGroupFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected AdjustmentTypeObjectDataList noOpIn;

/**
 *
 * Constructor to create a   AdjustmentTypeByGroupFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public AdjustmentTypeByGroupFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, AdjustmentTypeObjectDataList noOpInIn) {
