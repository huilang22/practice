 ...
 * Generated file: AccountLocateFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a AccountLocateFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class AccountLocateFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected AccountLocateXIDObjectDataList noOpIn;

/**
 *
 * Constructor to create a   AccountLocateFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public AccountLocateFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, AccountLocateXIDObjectDataList noOpInIn) {
