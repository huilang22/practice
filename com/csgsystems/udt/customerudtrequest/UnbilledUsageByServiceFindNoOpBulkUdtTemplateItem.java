 ...
 * Generated file: UnbilledUsageByServiceFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a UnbilledUsageByServiceFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class UnbilledUsageByServiceFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected UnbilledUsageObjectDataList noOpIn;

/**
 *
 * Constructor to create a   UnbilledUsageByServiceFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public UnbilledUsageByServiceFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, UnbilledUsageObjectDataList noOpInIn) {
