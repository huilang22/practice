 ...
 * Generated file: BsdConstraintDescriptionCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BsdConstraintDescriptionCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BsdConstraintDescriptionCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BsdConstraintDescriptionObjectData noOpIn;

/**
 *
 * Constructor to create a   BsdConstraintDescriptionCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BsdConstraintDescriptionCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BsdConstraintDescriptionObjectData noOpInIn) {
