 ...
 * Generated file: ProductElementFindEligibleNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ProductElementFindEligibleNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ProductElementFindEligibleNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ProductElementObjectDataList noOpIn;

/**
 *
 * Constructor to create a   ProductElementFindEligibleNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ProductElementFindEligibleNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ProductElementObjectDataList noOpInIn) {
