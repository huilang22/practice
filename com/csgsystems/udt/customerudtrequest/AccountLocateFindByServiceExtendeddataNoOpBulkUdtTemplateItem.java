 ...
 * Generated file: AccountLocateFindByServiceExtendeddataNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a AccountLocateFindByServiceExtendeddataNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class AccountLocateFindByServiceExtendeddataNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected AccountLocateXIDObjectDataList noOpIn;

/**
 *
 * Constructor to create a   AccountLocateFindByServiceExtendeddataNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public AccountLocateFindByServiceExtendeddataNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, AccountLocateXIDObjectDataList noOpInIn) {
