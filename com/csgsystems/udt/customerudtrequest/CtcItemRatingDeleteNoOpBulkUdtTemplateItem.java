 ...
 * Generated file: CtcItemRatingDeleteNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a CtcItemRatingDeleteNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class CtcItemRatingDeleteNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected CtcItemRatingObjectData noOpIn;

/**
 *
 * Constructor to create a   CtcItemRatingDeleteNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public CtcItemRatingDeleteNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, CtcItemRatingObjectData noOpInIn) {
