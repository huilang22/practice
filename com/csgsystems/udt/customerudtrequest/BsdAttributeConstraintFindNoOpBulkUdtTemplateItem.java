 ...
 * Generated file: BsdAttributeConstraintFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BsdAttributeConstraintFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BsdAttributeConstraintFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BsdAttributeConstraintObjectDataList noOpIn;

/**
 *
 * Constructor to create a   BsdAttributeConstraintFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BsdAttributeConstraintFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BsdAttributeConstraintObjectDataList noOpInIn) {
