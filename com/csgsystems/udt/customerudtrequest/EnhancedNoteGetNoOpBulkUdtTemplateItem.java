 ...
 * Generated file: EnhancedNoteGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a EnhancedNoteGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class EnhancedNoteGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected EnhancedNoteObjectData noOpIn;

/**
 *
 * Constructor to create a   EnhancedNoteGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public EnhancedNoteGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, EnhancedNoteObjectData noOpInIn) {
