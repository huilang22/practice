 ...
 * Generated file: ServiceOrderGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ServiceOrderGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ServiceOrderGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ServiceOrderObjectBaseData noOpIn;

/**
 *
 * Constructor to create a   ServiceOrderGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ServiceOrderGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ServiceOrderObjectBaseData noOpInIn) {
