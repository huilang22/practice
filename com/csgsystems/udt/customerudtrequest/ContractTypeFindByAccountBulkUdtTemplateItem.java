 ...
 * Generated file: ContractTypeFindByAccountBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ContractTypeFindByAccountBulkUdtTemplateItem Bulk Template
 *
 */

public class ContractTypeFindByAccountBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected Integer language_code;
  protected Integer account_internal_id;
/**
 *
 * Constructor to create a  ContractTypeFindByAccountBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ContractTypeFindByAccountBulkUdtTemplateItem(String id, BSDMSessionContext context, Integer language_codeIn, Integer account_internal_idIn) {
