 ...
 * Generated file: OrderFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a OrderFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class OrderFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected OrderObjectDataList noOpIn;

/**
 *
 * Constructor to create a   OrderFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public OrderFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, OrderObjectDataList noOpInIn) {
