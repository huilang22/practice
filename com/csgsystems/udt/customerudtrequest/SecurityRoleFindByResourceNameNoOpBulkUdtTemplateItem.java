 ...
 * Generated file: SecurityRoleFindByResourceNameNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a SecurityRoleFindByResourceNameNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class SecurityRoleFindByResourceNameNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected SecurityRoleObjectDataList noOpIn;

/**
 *
 * Constructor to create a   SecurityRoleFindByResourceNameNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public SecurityRoleFindByResourceNameNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, SecurityRoleObjectDataList noOpInIn) {
