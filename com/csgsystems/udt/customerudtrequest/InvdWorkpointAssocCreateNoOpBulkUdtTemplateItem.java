 ...
 * Generated file: InvdWorkpointAssocCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvdWorkpointAssocCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvdWorkpointAssocCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvdWorkpointAssocObjectData noOpIn;

/**
 *
 * Constructor to create a   InvdWorkpointAssocCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvdWorkpointAssocCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvdWorkpointAssocObjectData noOpInIn) {
