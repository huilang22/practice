 ...
 * Generated file: CustomerDocumentUpdateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a CustomerDocumentUpdateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class CustomerDocumentUpdateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected CustomerDocumentObjectData noOpIn;

/**
 *
 * Constructor to create a   CustomerDocumentUpdateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public CustomerDocumentUpdateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, CustomerDocumentObjectData noOpInIn) {
