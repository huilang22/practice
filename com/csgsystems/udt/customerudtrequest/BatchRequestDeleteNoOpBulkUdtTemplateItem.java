 ...
 * Generated file: BatchRequestDeleteNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BatchRequestDeleteNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BatchRequestDeleteNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BatchRequestObjectData noOpIn;

/**
 *
 * Constructor to create a   BatchRequestDeleteNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BatchRequestDeleteNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BatchRequestObjectData noOpInIn) {
