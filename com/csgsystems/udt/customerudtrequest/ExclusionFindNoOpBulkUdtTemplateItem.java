 ...
 * Generated file: ExclusionFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ExclusionFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ExclusionFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ExclusionObjectDataList noOpIn;

/**
 *
 * Constructor to create a   ExclusionFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ExclusionFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ExclusionObjectDataList noOpInIn) {
