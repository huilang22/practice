 ...
 * Generated file: ProductPackageOwnerFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ProductPackageOwnerFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ProductPackageOwnerFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ProductPackageObjectDataList noOpIn;

/**
 *
 * Constructor to create a   ProductPackageOwnerFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ProductPackageOwnerFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ProductPackageObjectDataList noOpInIn) {
