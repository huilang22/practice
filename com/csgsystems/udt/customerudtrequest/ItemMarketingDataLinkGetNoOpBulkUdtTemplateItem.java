 ...
 * Generated file: ItemMarketingDataLinkGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ItemMarketingDataLinkGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ItemMarketingDataLinkGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ItemMarketingDataLinkObjectData noOpIn;

/**
 *
 * Constructor to create a   ItemMarketingDataLinkGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ItemMarketingDataLinkGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ItemMarketingDataLinkObjectData noOpInIn) {
