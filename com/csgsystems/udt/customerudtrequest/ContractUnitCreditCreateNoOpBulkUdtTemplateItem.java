 ...
 * Generated file: ContractUnitCreditCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ContractUnitCreditCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ContractUnitCreditCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ContractUnitCreditObjectData noOpIn;

/**
 *
 * Constructor to create a   ContractUnitCreditCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ContractUnitCreditCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ContractUnitCreditObjectData noOpInIn) {
