 ...
 * Generated file: ServiceableProductTypeFindBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ServiceableProductTypeFindBulkUdtTemplateItem Bulk Template
 *
 */

public class ServiceableProductTypeFindBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected BigInteger AddressIdIn;
  protected Integer IndustryTypeId;
  protected Date ServiceableDt;
/**
 *
 * Constructor to create a  ServiceableProductTypeFindBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ServiceableProductTypeFindBulkUdtTemplateItem(String id, BSDMSessionContext context, BigInteger AddressIdInIn, Integer IndustryTypeIdIn, Date ServiceableDtIn) {
