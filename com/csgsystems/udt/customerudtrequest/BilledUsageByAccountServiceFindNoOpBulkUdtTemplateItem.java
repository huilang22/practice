 ...
 * Generated file: BilledUsageByAccountServiceFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BilledUsageByAccountServiceFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BilledUsageByAccountServiceFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BilledUsageObjectDataList noOpIn;

/**
 *
 * Constructor to create a   BilledUsageByAccountServiceFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BilledUsageByAccountServiceFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BilledUsageObjectDataList noOpInIn) {
