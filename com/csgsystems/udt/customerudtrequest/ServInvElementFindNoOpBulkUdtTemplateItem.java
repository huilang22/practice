 ...
 * Generated file: ServInvElementFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ServInvElementFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ServInvElementFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvElementObjDataList noOpIn;

/**
 *
 * Constructor to create a   ServInvElementFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ServInvElementFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvElementObjDataList noOpInIn) {
