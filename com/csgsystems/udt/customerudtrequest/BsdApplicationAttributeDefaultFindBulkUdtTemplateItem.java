 ...
 * Generated file: BsdApplicationAttributeDefaultFindBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a BsdApplicationAttributeDefaultFindBulkUdtTemplateItem Bulk Template
 *
 */

public class BsdApplicationAttributeDefaultFindBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected String BusinessUnitName;
  protected String ApplicationName;
  protected Integer LanguageCode;
/**
 *
 * Constructor to create a  BsdApplicationAttributeDefaultFindBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public BsdApplicationAttributeDefaultFindBulkUdtTemplateItem(String id, BSDMSessionContext context, String BusinessUnitNameIn, String ApplicationNameIn, Integer LanguageCodeIn) {
