 ...
 * Generated file: SecurityRoleAssignNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a SecurityRoleAssignNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class SecurityRoleAssignNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected SecurityRoleObjectDataList noOpIn;

/**
 *
 * Constructor to create a   SecurityRoleAssignNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public SecurityRoleAssignNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, SecurityRoleObjectDataList noOpInIn) {
