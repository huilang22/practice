 ...
 * Generated file: CtcOfferExtendedDataCreateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a CtcOfferExtendedDataCreateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class CtcOfferExtendedDataCreateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected CtcOfferExtendedDataObjectData noOpIn;

/**
 *
 * Constructor to create a   CtcOfferExtendedDataCreateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public CtcOfferExtendedDataCreateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, CtcOfferExtendedDataObjectData noOpInIn) {
