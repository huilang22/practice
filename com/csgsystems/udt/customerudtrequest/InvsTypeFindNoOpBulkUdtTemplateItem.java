 ...
 * Generated file: InvsTypeFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvsTypeFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvsTypeFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvsTypeObjectDataList noOpIn;

/**
 *
 * Constructor to create a   InvsTypeFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvsTypeFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvsTypeObjectDataList noOpInIn) {
