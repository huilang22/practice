 ...
 * Generated file: BsdQueueFindInternalNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BsdQueueFindInternalNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BsdQueueFindInternalNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BsdQueueObjectDataList noOpIn;

/**
 *
 * Constructor to create a   BsdQueueFindInternalNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BsdQueueFindInternalNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BsdQueueObjectDataList noOpInIn) {
