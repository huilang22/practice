 ...
 * Generated file: InvoiceAdjustmentTotalGetBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a InvoiceAdjustmentTotalGetBulkUdtTemplateItem Bulk Template
 *
 */

public class InvoiceAdjustmentTotalGetBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected Integer bill_ref_no;
  protected Integer bill_ref_resets;
  protected Integer open_item_id;
/**
 *
 * Constructor to create a  InvoiceAdjustmentTotalGetBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public InvoiceAdjustmentTotalGetBulkUdtTemplateItem(String id, BSDMSessionContext context, Integer bill_ref_noIn, Integer bill_ref_resetsIn, Integer open_item_idIn) {
