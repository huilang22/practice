 ...
 * Generated file: ServiceOrderFindInnerNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a ServiceOrderFindInnerNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class ServiceOrderFindInnerNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected ServiceOrderObjectBaseDataList noOpIn;

/**
 *
 * Constructor to create a   ServiceOrderFindInnerNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public ServiceOrderFindInnerNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, ServiceOrderObjectBaseDataList noOpInIn) {
