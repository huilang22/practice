 ...
 * Generated file: ServiceableComponentTypeFindBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a ServiceableComponentTypeFindBulkUdtTemplateItem Bulk Template
 *
 */

public class ServiceableComponentTypeFindBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected BigInteger AddressIdIn;
  protected Integer IndustryTypeId;
  protected Date ServiceableDt;
/**
 *
 * Constructor to create a  ServiceableComponentTypeFindBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public ServiceableComponentTypeFindBulkUdtTemplateItem(String id, BSDMSessionContext context, BigInteger AddressIdInIn, Integer IndustryTypeIdIn, Date ServiceableDtIn) {
