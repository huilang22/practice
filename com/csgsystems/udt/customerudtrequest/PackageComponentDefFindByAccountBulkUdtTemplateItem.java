 ...
 * Generated file: PackageComponentDefFindByAccountBulkUdtTemplateItem.java
...
/**
 *
 * Class used to create a PackageComponentDefFindByAccountBulkUdtTemplateItem Bulk Template
 *
 */

public class PackageComponentDefFindByAccountBulkUdtTemplateItem extends BulkUdtTemplateItem {
  protected Integer language_code;
  protected Integer account_internal_id;
/**
 *
 * Constructor to create a  PackageComponentDefFindByAccountBulkUdtTemplateItem
 * @param id Unique request name
 *
 */
  public PackageComponentDefFindByAccountBulkUdtTemplateItem(String id, BSDMSessionContext context, Integer language_codeIn, Integer account_internal_idIn) {
