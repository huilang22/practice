 ...
 * Generated file: GeoAreaBoundaryGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a GeoAreaBoundaryGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class GeoAreaBoundaryGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected GeoAreaBoundaryObjectData noOpIn;

/**
 *
 * Constructor to create a   GeoAreaBoundaryGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public GeoAreaBoundaryGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, GeoAreaBoundaryObjectData noOpInIn) {
