 ...
 * Generated file: NrcTransDescrFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a NrcTransDescrFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class NrcTransDescrFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected NrcTransDescrObjectDataList noOpIn;

/**
 *
 * Constructor to create a   NrcTransDescrFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public NrcTransDescrFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, NrcTransDescrObjectDataList noOpInIn) {
