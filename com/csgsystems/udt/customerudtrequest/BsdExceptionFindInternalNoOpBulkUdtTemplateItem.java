 ...
 * Generated file: BsdExceptionFindInternalNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BsdExceptionFindInternalNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BsdExceptionFindInternalNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BsdExceptionObjectDataList noOpIn;

/**
 *
 * Constructor to create a   BsdExceptionFindInternalNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BsdExceptionFindInternalNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BsdExceptionObjectDataList noOpInIn) {
