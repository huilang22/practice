 ...
 * Generated file: InvsSimResellerUpdateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvsSimResellerUpdateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvsSimResellerUpdateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvsSimResellerObjectData noOpIn;

/**
 *
 * Constructor to create a   InvsSimResellerUpdateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvsSimResellerUpdateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvsSimResellerObjectData noOpInIn) {
