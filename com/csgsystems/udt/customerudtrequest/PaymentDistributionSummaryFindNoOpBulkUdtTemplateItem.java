 ...
 * Generated file: PaymentDistributionSummaryFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a PaymentDistributionSummaryFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class PaymentDistributionSummaryFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected PaymentDistributionObjectDataList noOpIn;

/**
 *
 * Constructor to create a   PaymentDistributionSummaryFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public PaymentDistributionSummaryFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, PaymentDistributionObjectDataList noOpInIn) {
