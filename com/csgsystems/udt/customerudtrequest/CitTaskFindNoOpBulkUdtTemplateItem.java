 ...
 * Generated file: CitTaskFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a CitTaskFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class CitTaskFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected CitTaskObjectDataList noOpIn;

/**
 *
 * Constructor to create a   CitTaskFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public CitTaskFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, CitTaskObjectDataList noOpInIn) {
