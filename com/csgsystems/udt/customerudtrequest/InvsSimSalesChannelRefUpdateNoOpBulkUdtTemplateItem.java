 ...
 * Generated file: InvsSimSalesChannelRefUpdateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvsSimSalesChannelRefUpdateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvsSimSalesChannelRefUpdateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvsSimSalesChannelRefObjectData noOpIn;

/**
 *
 * Constructor to create a   InvsSimSalesChannelRefUpdateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvsSimSalesChannelRefUpdateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvsSimSalesChannelRefObjectData noOpInIn) {
