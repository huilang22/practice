 ...
 * Generated file: UnitCrDefinitionFindNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a UnitCrDefinitionFindNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class UnitCrDefinitionFindNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected UnitCrDefinitionObjectDataList noOpIn;

/**
 *
 * Constructor to create a   UnitCrDefinitionFindNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public UnitCrDefinitionFindNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, UnitCrDefinitionObjectDataList noOpInIn) {
