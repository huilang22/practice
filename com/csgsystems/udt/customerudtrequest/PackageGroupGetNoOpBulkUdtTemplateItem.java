 ...
 * Generated file: PackageGroupGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a PackageGroupGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class PackageGroupGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected PGObjectData noOpIn;

/**
 *
 * Constructor to create a   PackageGroupGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public PackageGroupGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, PGObjectData noOpInIn) {
