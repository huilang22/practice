 ...
 * Generated file: BatchRequestScheduleNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a BatchRequestScheduleNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class BatchRequestScheduleNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected BatchRequestObjectData noOpIn;

/**
 *
 * Constructor to create a   BatchRequestScheduleNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public BatchRequestScheduleNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, BatchRequestObjectData noOpInIn) {
