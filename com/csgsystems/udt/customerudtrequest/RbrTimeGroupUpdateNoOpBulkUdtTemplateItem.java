 ...
 * Generated file: RbrTimeGroupUpdateNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a RbrTimeGroupUpdateNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class RbrTimeGroupUpdateNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected RbrTmGrpObjectData noOpIn;

/**
 *
 * Constructor to create a   RbrTimeGroupUpdateNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public RbrTimeGroupUpdateNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, RbrTmGrpObjectData noOpInIn) {
