 ...
 * Generated file: InvdReserveEndGetNoOpBulkUdtTemplateItem.java
...
/**
 *
 * NoOp class used to simulate a InvdReserveEndGetNoOpBulkUdtTemplateItem Bulk Request/Response
 *
 */
public class InvdReserveEndGetNoOpBulkUdtTemplateItem extends BulkUdtTemplateItem {

  protected InvdReserveEndObjectData noOpIn;

/**
 *
 * Constructor to create a   InvdReserveEndGetNoOpBulkUdtTemplateItem
 * @param id Unique request name
 * @param noOpInIn Simulated response object
 *
 */
  public InvdReserveEndGetNoOpBulkUdtTemplateItem(String id, BSDMSessionContext context, InvdReserveEndObjectData noOpInIn) {
