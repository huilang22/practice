 ...
 * Generated  File: ExtendedDataLocateObjectKeyData.java
...
/** ExtendedDataLocateObject's Key Data class. */
public class ExtendedDataLocateObjectKeyData  extends BaseObjectData
{
  /** EXT_DATA_LOOKUP.account_no field */
  ...
  private String _objName = "ExtendedDataLocateObjectKeyData";
  /** default constructor */
  public ExtendedDataLocateObjectKeyData ()
  {
  }
  /** copy constructor
   * @param other the object to copy
   */
  public ExtendedDataLocateObjectKeyData (ExtendedDataLocateObjectKeyData other)
  {
  ...
  /** set the fields value: AccountInternalId (EXT_DATA_LOOKUP.account_no)
  ...
  /** get the value of the field: AccountInternalId (EXT_DATA_LOOKUP.account_no)
   * @return Integer the value
   */
  public Integer getAccountInternalId () {
    return this.AccountInternalId;
  }
  /** Change the field to not being actively set: AccountInternalId (EXT_DATA_LOOKUP.account_no)
   */
  public void unsetAccountInternalId () {
    this._AccountInternalIdSet = false;
  }
  /** See if the field is actively set: AccountInternalId (EXT_DATA_LOOKUP.account_no)
