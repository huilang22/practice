 ...
 * Generated  File: AccountCodeGroupObjectKeyFilter.java
...
/** Key Filter for AccountCodeGroupObject object. */
public class AccountCodeGroupObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: CMF_ACCOUNT_CODE_GROUPS.account_code_group) */
  public    StringFilter[] AccountCodeGroup  = null;
  protected boolean AccountCodeGroupFetch = false;
  protected boolean AccountCodeGroupSortAscending = true;
  protected boolean AccountCodeGroupCaseInsensitive = false;
  protected Integer AccountCodeGroupSort = null;
  /** raw field for: CMF_ACCOUNT_CODE_GROUPS.account_no) */
  ...
  private String _objName = "AccountCodeGroupObjectKeyFilter";
  /** default constructor */
  public AccountCodeGroupObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public AccountCodeGroupObjectKeyFilter (AccountCodeGroupObjectKeyFilter other)
  {
    if (other == null) return;
    this.AccountCodeGroup = other.AccountCodeGroup;
    this.AccountCodeGroupFetch = other.AccountCodeGroupFetch;
    this.AccountCodeGroupSort = other.AccountCodeGroupSort;
    this.AccountCodeGroupCaseInsensitive = other.AccountCodeGroupCaseInsensitive;
    this.AccountCodeGroupSortAscending = other.AccountCodeGroupSortAscending;
  ...
  public void setAccountCodeGroupFetch (boolean fetch) {
    this.AccountCodeGroupFetch = fetch;
  }
  ...
  public boolean getAccountCodeGroupFetch () {
    return this.AccountCodeGroupFetch;
  }
  ...
  public void setAccountCodeGroupSortOrder (Integer value) {
    this.AccountCodeGroupSort = value;
  }
  ...
  public Integer getAccountCodeGroupSortOrder () {
    return this.AccountCodeGroupSort;
  }
  ...
  public void setAccountCodeGroupSortDirection (boolean ascending) {
    this.AccountCodeGroupSortAscending = ascending;
  }
  ...
  public boolean getAccountCodeGroupSortDirection () {
    return this.AccountCodeGroupSortAscending;
  }
  ...
  public void setAccountCodeGroupCaseInsensitive (boolean ascending) {
    this.AccountCodeGroupCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: AccountCodeGroup (CMF_ACCOUNT_CODE_GROUPS.account_code_group)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getAccountCodeGroupCaseInsensitive () {
    return this.AccountCodeGroupCaseInsensitive;
  }
  ...
  /**
   * Retrieves the AccountCodeGroupFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The AccountCodeGroupFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the AccountCodeGroupFilter field
   */
  public String[] getAccountCodeGroupFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getAccountCodeGroupFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getAccountCodeGroupFilter(), _locale, false, false);
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getAccountCodeGroupFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("AccountCodeGroupFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getAccountCodeGroupFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the AccountCodeGroupFilter filter value from a formatted string
   *
   * @param _value the AccountCodeGroupFilter filter value(s) in formatted form. If the requested
   ...
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the AccountCodeGroupFilter filter field
   */
  public void setAccountCodeGroupFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setAccountCodeGroupFilterFromFormattedString");
    try {
      this.setAccountCodeGroupFilter((StringFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("AccountCodeGroupFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setAccountCodeGroupFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setAccountCodeGroupFilterFromFormattedString");
  }
  ...
  public Map toMap() {
    return AccountCodeGroupObjectKeyHelper.toMap(this, null);
  }
}
