 ...
 * Generated  File: BilledUsageServiceObjectHelper.java
...
/** Helper class to convert BilledUsageServiceObject JavaBean objects to/from HashMaps.
 */
public class BilledUsageServiceObjectHelper implements ArubaObjectHelper
{
  /** convert BilledUsageServiceObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (BilledUsageServiceObjectData in, Map record)
  {
   ...
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @param rootName use this name as the root name for the object (defaults to "BilledUsageServiceObject")
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageServiceObjectData in, Map record, String rootName)
  {
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BilledUsageServiceObject";
    Map map = getMap (in, (Map) record.get (rootName));
    map = BilledUsageObjectHelper.getMap (in, map);
    record.put (rootName, map);
    return record;
  }
  /** convert BilledUsageServiceObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageServiceObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BilledUsageServiceObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageServiceObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BilledUsageServiceObject";
  ...
  /** convert Map to BilledUsageServiceObjectData.
   * @param record the Map containing the data to convert to the object
   * @return BilledUsageServiceObjectData the converted object
   */
  public static BilledUsageServiceObjectData fromMap (Map record)
  {
    return fromMap (record, null);
  }
  /** convert Map to BilledUsageServiceObjectData.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the mape (defaults to "BilledUsageServiceObject")
   * @return BilledUsageServiceObjectData the converted object
   */
  public static BilledUsageServiceObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BilledUsageServiceObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return BilledUsageServiceObjectFilter the converted object
   */
  public static BilledUsageServiceObjectFilter fromMapFilter (Map record) {
    return fromMapFilter (record, null);
  }
  /** convert Map to BilledUsageServiceObjectFilter.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the map (defaults to "BilledUsageServiceObject")
   * @return BilledUsageServiceObjectFilter the converted object
   */
  public static BilledUsageServiceObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BilledUsageServiceObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to BilledUsageServiceObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return BilledUsageServiceObjectDataList the converted object
   */
  public static BilledUsageServiceObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to BilledUsageServiceObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "BilledUsageServiceObjectList")
   * @return BilledUsageServiceObjectDataList the converted object
   */
  public static BilledUsageServiceObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "BilledUsageServiceObjectList";
    Object[] root = (Object[]) record.get (rootName);
    BilledUsageServiceObjectData[] array = null;
    if (root != null)
    {
      array = new BilledUsageServiceObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = BilledUsageServiceObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new BilledUsageServiceObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new BilledUsageServiceObjectDataList (array, index, total);
  }
  /** convert BilledUsageServiceObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BilledUsageServiceObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
  ...
  /** convert BilledUsageServiceObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BilledUsageServiceObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return BilledUsageServiceObjectData the converted object
   */
  public static BilledUsageServiceObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BilledUsageServiceObjectData out = new BilledUsageServiceObjectData (BilledUsageObjectHelper.getObj (record));
   ...
   * @return BilledUsageServiceObjectFilter the converted object
   */
  public static BilledUsageServiceObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BilledUsageServiceObjectFilter out = new BilledUsageServiceObjectFilter (BilledUsageObjectHelper.getFilter (record));
