 ...
 * Generated  File: AdjustmentReasonObjectData.java
...
/** AdjustmentReasonObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class AdjustmentReasonObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public AdjustmentReasonObjectKeyData Key = null;
  /** ADJ_REASON_CODE_REF.journal_code field */
  public    Integer JournalCode  = null;
  protected boolean _JournalCodeSet = false;
  /** ADJ_REASON_CODE_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** ADJ_REASON_CODE_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** ADJ_REASON_CODE_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** ADJ_REASON_CODE_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** ADJ_REASON_CODE_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "AdjustmentReasonObjectData";
  /** Default constructor */
  public AdjustmentReasonObjectData ()
  {
    super ();
   ...
   */
  public AdjustmentReasonObjectData (AdjustmentReasonObjectData other)
  {

    if (other == null) return;
    this.Key = new AdjustmentReasonObjectKeyData (other.Key);
    this.JournalCode = other.JournalCode;
    this._JournalCodeSet = other._JournalCodeSet;
   ...
   * @return AdjustmentReasonObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public AdjustmentReasonObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (AdjustmentReasonObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setAdjReasonCode (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new AdjustmentReasonObjectKeyData ();
    this.Key.AdjReasonCode = value;
    this.Key._AdjReasonCodeSet = true;
  }
  ...
  public void unsetAdjReasonCode () {
    ...
    this.Key._AdjReasonCodeSet = false;
  }
  ...
  public boolean issetAdjReasonCode () {
    ...
    return this.Key._AdjReasonCodeSet;
  }
  ...
  /** set the fields value: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("JournalCode") 
  public void setJournalCode (Integer value) throws ServiceException
  {
    if (value == null)
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_NULL_VALUE", "The field's value cannot be NULL", _objName, "JournalCode", "setJournalCode");
    }
    this.JournalCode = value;
    this._JournalCodeSet = true;
  }

  /** Retrieves the JournalCode field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The JournalCode field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the JournalCode field
   */
   public String getJournalCodeAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getJournalCodeAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getJournalCodeAsFormattedString");
       return fmtMgr.formatNumber(this.getJournalCode(), _locale);
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("JournalCode");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getJournalCodeAsFormattedString");
       throw x;
     }
   }
  /** Sets the JournalCode field from a formatted string
   *
   * @param _value the JournalCode field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the JournalCode field
   */
   public void setJournalCodeFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getJournalCodeFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setJournalCode(fmtMgr.parseNumber(_value, _locale));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("JournalCode");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setJournalCodeFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setJournalCodeFromFormattedString");
   }

  /** get the value of the field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @return Integer the value
   */
  public Integer getJournalCode () {
    return this.JournalCode;
  }
  /** Change the field to not being actively set: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   */
  public void unsetJournalCode () {
    this._JournalCodeSet = false;
  }
  /** See if the field is actively set: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @return boolean whether the field is actively set
   */
  public boolean issetJournalCode () {
    return this._JournalCodeSet;
  }
  /** set the fields value: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (ADJ_REASON_CODE_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
  ...
  /** ADJ_REASON_CODE_REF.journal_code field */
    if(!nonNullOnly || (JournalCode != null))  _JournalCodeSet = flag;
  /** ADJ_REASON_CODE_REF.is_default field */
