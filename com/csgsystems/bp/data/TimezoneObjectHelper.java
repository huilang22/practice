 ...
 * Generated  File: TimezoneObjectHelper.java
...
/** Helper class to convert TimezoneObject JavaBean objects to/from HashMaps.
 */
public class TimezoneObjectHelper implements ArubaObjectHelper
{
  /** convert TimezoneObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (TimezoneObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (TimezoneObjectData in, Map record, String rootName)
  {
  ...
  /** convert TimezoneObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (TimezoneObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert TimezoneObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (TimezoneObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "TimezoneObject";
  ...
  /** convert Map to TimezoneObjectData.
   * @param record the Map containing the data to convert to the object
   * @return TimezoneObjectData the converted object
   */
  public static TimezoneObjectData fromMap (Map record)
  {
   ...
   * @return TimezoneObjectData the converted object
   */
  public static TimezoneObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to TimezoneObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return TimezoneObjectFilter the converted object
   */
  public static TimezoneObjectFilter fromMapFilter (Map record) {
   ...
   * @return TimezoneObjectFilter the converted object
   */
  public static TimezoneObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "TimezoneObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to TimezoneObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return TimezoneObjectDataList the converted object
   */
  public static TimezoneObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to TimezoneObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "TimezoneObjectList")
   * @return TimezoneObjectDataList the converted object
   */
  public static TimezoneObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "TimezoneObjectList";
    Object[] root = (Object[]) record.get (rootName);
    TimezoneObjectData[] array = null;
    if (root != null)
    {
      array = new TimezoneObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = TimezoneObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new TimezoneObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new TimezoneObjectDataList (array, index, total);
  }
  /** convert TimezoneObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (TimezoneObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", TimezoneObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
    if (in._UnixTzSet) record.put ("UnixTz", in.UnixTz);
  
    if (in._IsdstSet) record.put ("Isdst", in.Isdst);
  ...
  /** convert TimezoneObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (TimezoneObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
    ...
    if (in.Key != null) record.put ("Key", TimezoneObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
      map = DataHelper.filterToMap (in.UnixTz, in.UnixTzSort, in.UnixTzSortAscending, in.UnixTzFetch, in.UnixTzCaseInsensitive);
      if (map != null) record.put ("UnixTz", map);
      map = DataHelper.filterToMap (in.Isdst, in.IsdstSort, in.IsdstSortAscending, in.IsdstFetch);
      if (map != null) record.put ("Isdst", map);
   ...
   * @return TimezoneObjectData the converted object
   */
  public static TimezoneObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    TimezoneObjectData out = new TimezoneObjectData ();

    out.Key = TimezoneObjectKeyHelper.getObj ((Map) record.get ("Key"));
    if ((obj = record.get ("UnixTz")) != null)
    {
      out.UnixTz = (String) obj;
    }
  
    if ((obj = record.get ("Isdst")) != null)
    {
      out.Isdst = (Boolean) obj;
    }
   ...
   * @return TimezoneObjectFilter the converted object
   */
  public static TimezoneObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    TimezoneObjectFilter out = new TimezoneObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = TimezoneObjectKeyHelper.getFilter ((Map) record.get ("Key"));
    Map UnixTzMap = (Map)record.get("UnixTz");
    Boolean UnixTzFetch = DataHelper.getFetch(UnixTzMap);
    Boolean UnixTzSortDir = DataHelper.getSortDirection(UnixTzMap);
    Integer UnixTzSortOrder = DataHelper.getSortOrder(UnixTzMap);
    if (UnixTzFetch != null) out.setUnixTzFetch(UnixTzFetch);
    if (UnixTzSortDir != null) out.setUnixTzSortDirection(UnixTzSortDir);
    if (UnixTzSortOrder != null) out.setUnixTzSortOrder(UnixTzSortOrder);

    Filter[] UnixTzFilter = DataHelper.mapToFilterArray(UnixTzMap, String.class);
    if (UnixTzFilter != null) {
      StringFilter[] UnixTzFilters = new StringFilter[UnixTzFilter.length];
      for (int i = 0; i < UnixTzFilters.length; i++) {
        UnixTzFilters[i] = (StringFilter)UnixTzFilter[i];
      }
      try {
        out.setUnixTzFilter(UnixTzFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
  
    Map IsdstMap = (Map)record.get("Isdst");
    Boolean IsdstFetch = DataHelper.getFetch(IsdstMap);
    Boolean IsdstSortDir = DataHelper.getSortDirection(IsdstMap);
    Integer IsdstSortOrder = DataHelper.getSortOrder(IsdstMap);
    if (IsdstFetch != null) out.setIsdstFetch(IsdstFetch);
    if (IsdstSortDir != null) out.setIsdstSortDirection(IsdstSortDir);
    if (IsdstSortOrder != null) out.setIsdstSortOrder(IsdstSortOrder);

    Filter[] IsdstFilter = DataHelper.mapToFilterArray(IsdstMap, Boolean.class);
    if (IsdstFilter != null) {
      BooleanFilter[] IsdstFilters = new BooleanFilter[IsdstFilter.length];
      for (int i = 0; i < IsdstFilters.length; i++) {
        IsdstFilters[i] = (BooleanFilter)IsdstFilter[i];
      }
      try {
        out.setIsdstFilter(IsdstFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
