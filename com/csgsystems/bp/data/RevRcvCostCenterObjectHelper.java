 ...
 * Generated  File: RevRcvCostCenterObjectHelper.java
...
/** Helper class to convert RevRcvCostCenterObject JavaBean objects to/from HashMaps.
 */
public class RevRcvCostCenterObjectHelper implements ArubaObjectHelper
{
  /** convert RevRcvCostCenterObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (RevRcvCostCenterObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (RevRcvCostCenterObjectData in, Map record, String rootName)
  {
  ...
  /** convert RevRcvCostCenterObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (RevRcvCostCenterObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert RevRcvCostCenterObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (RevRcvCostCenterObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "RevRcvCostCenterObject";
  ...
  /** convert Map to RevRcvCostCenterObjectData.
   * @param record the Map containing the data to convert to the object
   * @return RevRcvCostCenterObjectData the converted object
   */
  public static RevRcvCostCenterObjectData fromMap (Map record)
  {
   ...
   * @return RevRcvCostCenterObjectData the converted object
   */
  public static RevRcvCostCenterObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to RevRcvCostCenterObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return RevRcvCostCenterObjectFilter the converted object
   */
  public static RevRcvCostCenterObjectFilter fromMapFilter (Map record) {
   ...
   * @return RevRcvCostCenterObjectFilter the converted object
   */
  public static RevRcvCostCenterObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "RevRcvCostCenterObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to RevRcvCostCenterObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return RevRcvCostCenterObjectDataList the converted object
   */
  public static RevRcvCostCenterObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to RevRcvCostCenterObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "RevRcvCostCenterObjectList")
   * @return RevRcvCostCenterObjectDataList the converted object
   */
  public static RevRcvCostCenterObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "RevRcvCostCenterObjectList";
    Object[] root = (Object[]) record.get (rootName);
    RevRcvCostCenterObjectData[] array = null;
    if (root != null)
    {
      array = new RevRcvCostCenterObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = RevRcvCostCenterObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new RevRcvCostCenterObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new RevRcvCostCenterObjectDataList (array, index, total);
  }
  /** convert RevRcvCostCenterObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (RevRcvCostCenterObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", RevRcvCostCenterObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert RevRcvCostCenterObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (RevRcvCostCenterObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return RevRcvCostCenterObjectData the converted object
   */
  public static RevRcvCostCenterObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    RevRcvCostCenterObjectData out = new RevRcvCostCenterObjectData ();

    out.Key = RevRcvCostCenterObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return RevRcvCostCenterObjectFilter the converted object
   */
  public static RevRcvCostCenterObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    RevRcvCostCenterObjectFilter out = new RevRcvCostCenterObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = RevRcvCostCenterObjectKeyHelper.getFilter ((Map) record.get ("Key"));
