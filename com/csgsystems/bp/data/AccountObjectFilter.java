 ...
 * Generated  File: AccountObjectFilter.java
...
/** Filter object */
public class AccountObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public AccountObjectKeyFilter Key = null;
  /** raw field */
  ...
  /** raw field for: CMF.rev_rcv_cost_ctr) */
  ...
  protected Integer AutoWriteoffStatusSort = null;  /** ExtendedData filter Map */
  public Map extendedDataFilter = null;

  private String _objName = "AccountObjectFilter";
  /** default constructor */
  public AccountObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AccountObjectFilter (AccountObjectFilter other)
  {
    if (other == null) return;
    this.Key = new AccountObjectKeyFilter (other.Key);
    ...
    this.AutoWriteoffStatusSortAscending = other.AutoWriteoffStatusSortAscending;  this.extendedDataFilter = other.extendedDataFilter;    
  }
  /** get the filter for this object's key
   * @return AccountObjectKeyFilter
   */
  public AccountObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (AccountObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  /** Set the field level Fetch value for field: AccountInternalId (CMF.account_no)
   * @param fetch whether to fetch this field or not
   */
  public void setAccountInternalIdFetch (boolean fetch)
  {
    if (this.Key == null) this.Key = new AccountObjectKeyFilter ();
    this.Key.AccountInternalIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: AccountInternalId (CMF.account_no)
  ...
  /** Set the SortOrder for field: AccountInternalId (CMF.account_no)
  ...
  /** Retrieve SortOrder for field: AccountInternalId (CMF.account_no)
  ...
  /** Set the sort direction for field: AccountInternalId (CMF.account_no)
  ...
  /** Retrieve SortDirection for field: AccountInternalId (CMF.account_no)
  ...
  /** Set the field level filters for field: AccountInternalId (CMF.account_no)
  ...
  /** Retrieve filter for field: AccountInternalId (CMF.account_no)
  ...
  /** Set the field level Fetch value for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * @param fetch whether to fetch this field or not
   */
  public void setRevRcvCostCtrFetch (boolean fetch) {
    this.RevRcvCostCtrFetch = fetch;
  }
  /** Retrieve Fetch value for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * @return boolean the Fetch value for this field
   */
  public boolean getRevRcvCostCtrFetch () {
    return this.RevRcvCostCtrFetch;
  }
  /** Set the SortOrder for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getRevRcvCostCtrSortOrder () {
    return this.RevRcvCostCtrSort;
  }
  /** Set the sort direction for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setRevRcvCostCtrSortDirection (boolean ascending) {
    this.RevRcvCostCtrSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getRevRcvCostCtrSortDirection () {
    return this.RevRcvCostCtrSortAscending;
  }
  /** Set the field level filters for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: RevRcvCostCtr (CMF.rev_rcv_cost_ctr)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  public String toString() {
    return AccountObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return AccountObjectHelper.toMap(this, null);
  }
}
