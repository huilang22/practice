 ...
 * Generated  File: TimezoneObjectData.java
...
/** TimezoneObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class TimezoneObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public TimezoneObjectKeyData Key = null;
  /** TIMEZONE_REF.unix_tz field */
  public    String UnixTz  = null;
  protected boolean _UnixTzSet = false;
  /** TIMEZONE_REF.isdst field */
  public    Boolean Isdst  = null;
  protected boolean _IsdstSet = false;
  /** TIMEZONE_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** TIMEZONE_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** TIMEZONE_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** TIMEZONE_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** TIMEZONE_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "TimezoneObjectData";
  /** Default constructor */
  public TimezoneObjectData ()
  {
    super ();
   ...
   */
  public TimezoneObjectData (TimezoneObjectData other)
  {

    if (other == null) return;
    this.Key = new TimezoneObjectKeyData (other.Key);
    this.UnixTz = other.UnixTz;
    this._UnixTzSet = other._UnixTzSet;
    this.Isdst = other.Isdst;
    this._IsdstSet = other._IsdstSet;
   ...
   * @return TimezoneObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public TimezoneObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (TimezoneObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setTimezoneCode (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new TimezoneObjectKeyData ();
    this.Key.TimezoneCode = value;
    this.Key._TimezoneCodeSet = true;
  }
  ...
  public void unsetTimezoneCode () {
    ...
    this.Key._TimezoneCodeSet = false;
  }
  ...
  public boolean issetTimezoneCode () {
    ...
    return this.Key._TimezoneCodeSet;
  }
  ...
  /** set the fields value: UnixTz (TIMEZONE_REF.unix_tz)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("UnixTz") 
  public void setUnixTz (String value) throws ServiceException
  {
    if (value == null)
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_NULL_VALUE", "The field's value cannot be NULL", _objName, "UnixTz", "setUnixTz");
    }
    if (value != null && !DataHelper.validLength (value, 14))
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_LENGTH", "The field's value is too long", _objName, "UnixTz", "setUnixTz");
    }
    this.UnixTz = value;
    this._UnixTzSet = true;
  }

  /** Retrieves the UnixTz field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The UnixTz field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the UnixTz field
   */
   public String getUnixTzAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getUnixTzAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getUnixTzAsFormattedString");
       return fmtMgr.formatString(this.getUnixTz());
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("UnixTz");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getUnixTzAsFormattedString");
       throw x;
     }
   }
  /** Sets the UnixTz field from a formatted string
   *
   * @param _value the UnixTz field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the UnixTz field
   */
   public void setUnixTzFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getUnixTzFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setUnixTz(fmtMgr.parseString(_value));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("UnixTz");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setUnixTzFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setUnixTzFromFormattedString");
   }

  /** get the value of the field: UnixTz (TIMEZONE_REF.unix_tz)
   * @return String the value
   */
  public String getUnixTz () {
    return this.UnixTz;
  }
  /** Change the field to not being actively set: UnixTz (TIMEZONE_REF.unix_tz)
   */
  public void unsetUnixTz () {
    this._UnixTzSet = false;
  }
  /** See if the field is actively set: UnixTz (TIMEZONE_REF.unix_tz)
   * @return boolean whether the field is actively set
   */
  public boolean issetUnixTz () {
    return this._UnixTzSet;
  }
  /** set the fields value: Isdst (TIMEZONE_REF.isdst)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("Isdst") 
  public void setIsdst (Boolean value) throws ServiceException
  {
    if (value == null)
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_NULL_VALUE", "The field's value cannot be NULL", _objName, "Isdst", "setIsdst");
    }
    this.Isdst = value;
    this._IsdstSet = true;
  }

  /** Retrieves the Isdst field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The Isdst field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the Isdst field
   */
   public String getIsdstAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getIsdstAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getIsdstAsFormattedString");
       return fmtMgr.formatBoolean(this.getIsdst());
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("Isdst");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getIsdstAsFormattedString");
       throw x;
     }
   }
  /** Sets the Isdst field from a formatted string
   *
   * @param _value the Isdst field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the Isdst field
   */
   public void setIsdstFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getIsdstFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setIsdst(fmtMgr.parseBoolean(_value));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("Isdst");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setIsdstFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setIsdstFromFormattedString");
   }

  /** get the value of the field: Isdst (TIMEZONE_REF.isdst)
   * @return Boolean the value
   */
  public Boolean getIsdst () {
    return this.Isdst;
  }
  /** Change the field to not being actively set: Isdst (TIMEZONE_REF.isdst)
   */
  public void unsetIsdst () {
    this._IsdstSet = false;
  }
  /** See if the field is actively set: Isdst (TIMEZONE_REF.isdst)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsdst () {
    return this._IsdstSet;
  }
  /** set the fields value: IsDefault (TIMEZONE_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (TIMEZONE_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (TIMEZONE_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (TIMEZONE_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (TIMEZONE_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (TIMEZONE_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (TIMEZONE_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (TIMEZONE_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: ConfigTagId (TIMEZONE_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (TIMEZONE_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (TIMEZONE_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (TIMEZONE_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (TIMEZONE_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (TIMEZONE_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (TIMEZONE_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (TIMEZONE_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (TIMEZONE_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (TIMEZONE_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (TIMEZONE_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (TIMEZONE_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
  ...
  /** TIMEZONE_REF.unix_tz field */
    if(!nonNullOnly || (UnixTz != null))  _UnixTzSet = flag;
  /** TIMEZONE_REF.isdst field */
    if(!nonNullOnly || (Isdst != null))  _IsdstSet = flag;
  /** TIMEZONE_REF.is_default field */
