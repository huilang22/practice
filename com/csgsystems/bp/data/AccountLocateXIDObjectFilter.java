 ...
 * Generated  File: AccountLocateXIDObjectFilter.java
...
/** Filter object */
public class AccountLocateXIDObjectFilter extends AccountLocateObjectFilter  implements Serializable
{
  ...
  private String _objName = "AccountLocateXIDObjectFilter";
  /** default constructor */
  public AccountLocateXIDObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AccountLocateXIDObjectFilter (AccountLocateXIDObjectFilter other)
  {
    super (other);
   ...
   */
  public AccountLocateXIDObjectFilter (AccountLocateObjectFilter other)
  {
    super (other);
  ...
  public String toString() {
    return AccountLocateXIDObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return AccountLocateXIDObjectHelper.toMap(this, null);
  }
}
