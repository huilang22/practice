 ...
 * Generated  File: ClearingHouseObjectHelper.java
...
/** Helper class to convert ClearingHouseObject JavaBean objects to/from HashMaps.
 */
public class ClearingHouseObjectHelper implements ArubaObjectHelper
{
  /** convert ClearingHouseObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (ClearingHouseObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ClearingHouseObjectData in, Map record, String rootName)
  {
  ...
  /** convert ClearingHouseObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (ClearingHouseObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert ClearingHouseObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ClearingHouseObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "ClearingHouseObject";
  ...
  /** convert Map to ClearingHouseObjectData.
   * @param record the Map containing the data to convert to the object
   * @return ClearingHouseObjectData the converted object
   */
  public static ClearingHouseObjectData fromMap (Map record)
  {
   ...
   * @return ClearingHouseObjectData the converted object
   */
  public static ClearingHouseObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to ClearingHouseObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return ClearingHouseObjectFilter the converted object
   */
  public static ClearingHouseObjectFilter fromMapFilter (Map record) {
   ...
   * @return ClearingHouseObjectFilter the converted object
   */
  public static ClearingHouseObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "ClearingHouseObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to ClearingHouseObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return ClearingHouseObjectDataList the converted object
   */
  public static ClearingHouseObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to ClearingHouseObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "ClearingHouseObjectList")
   * @return ClearingHouseObjectDataList the converted object
   */
  public static ClearingHouseObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "ClearingHouseObjectList";
    Object[] root = (Object[]) record.get (rootName);
    ClearingHouseObjectData[] array = null;
    if (root != null)
    {
      array = new ClearingHouseObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = ClearingHouseObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new ClearingHouseObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new ClearingHouseObjectDataList (array, index, total);
  }
  /** convert ClearingHouseObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ClearingHouseObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", ClearingHouseObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert ClearingHouseObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ClearingHouseObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return ClearingHouseObjectData the converted object
   */
  public static ClearingHouseObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ClearingHouseObjectData out = new ClearingHouseObjectData ();

    out.Key = ClearingHouseObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return ClearingHouseObjectFilter the converted object
   */
  public static ClearingHouseObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ClearingHouseObjectFilter out = new ClearingHouseObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = ClearingHouseObjectKeyHelper.getFilter ((Map) record.get ("Key"));
