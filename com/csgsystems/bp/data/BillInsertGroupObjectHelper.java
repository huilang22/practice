 ...
 * Generated  File: BillInsertGroupObjectHelper.java
...
/** Helper class to convert BillInsertGroupObject JavaBean objects to/from HashMaps.
 */
public class BillInsertGroupObjectHelper implements ArubaObjectHelper
{
  /** convert BillInsertGroupObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (BillInsertGroupObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillInsertGroupObjectData in, Map record, String rootName)
  {
  ...
  /** convert BillInsertGroupObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BillInsertGroupObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BillInsertGroupObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillInsertGroupObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BillInsertGroupObject";
  ...
  /** convert Map to BillInsertGroupObjectData.
   * @param record the Map containing the data to convert to the object
   * @return BillInsertGroupObjectData the converted object
   */
  public static BillInsertGroupObjectData fromMap (Map record)
  {
   ...
   * @return BillInsertGroupObjectData the converted object
   */
  public static BillInsertGroupObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BillInsertGroupObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return BillInsertGroupObjectFilter the converted object
   */
  public static BillInsertGroupObjectFilter fromMapFilter (Map record) {
   ...
   * @return BillInsertGroupObjectFilter the converted object
   */
  public static BillInsertGroupObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BillInsertGroupObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to BillInsertGroupObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return BillInsertGroupObjectDataList the converted object
   */
  public static BillInsertGroupObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to BillInsertGroupObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "BillInsertGroupObjectList")
   * @return BillInsertGroupObjectDataList the converted object
   */
  public static BillInsertGroupObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "BillInsertGroupObjectList";
    Object[] root = (Object[]) record.get (rootName);
    BillInsertGroupObjectData[] array = null;
    if (root != null)
    {
      array = new BillInsertGroupObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = BillInsertGroupObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new BillInsertGroupObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new BillInsertGroupObjectDataList (array, index, total);
  }
  /** convert BillInsertGroupObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BillInsertGroupObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", BillInsertGroupObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
    if (in._IsDefaultSet) record.put ("IsDefault", in.IsDefault);
  
    if (in._IsInternalSet) record.put ("IsInternal", in.IsInternal);
  
    if (in._MaxInsertsSet) record.put ("MaxInserts", in.MaxInserts);
  ...
  /** convert BillInsertGroupObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BillInsertGroupObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
    ...
    if (in.Key != null) record.put ("Key", BillInsertGroupObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
      ...
      map = DataHelper.filterToMap (in.MaxInserts, in.MaxInsertsSort, in.MaxInsertsSortAscending, in.MaxInsertsFetch);
      if (map != null) record.put ("MaxInserts", map);
   ...
   * @return BillInsertGroupObjectData the converted object
   */
  public static BillInsertGroupObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillInsertGroupObjectData out = new BillInsertGroupObjectData ();

    out.Key = BillInsertGroupObjectKeyHelper.getObj ((Map) record.get ("Key"));
    ...
    if ((obj = record.get ("MaxInserts")) != null)
    {
      out.MaxInserts = (Integer) obj;
    }
   ...
   * @return BillInsertGroupObjectFilter the converted object
   */
  public static BillInsertGroupObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillInsertGroupObjectFilter out = new BillInsertGroupObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = BillInsertGroupObjectKeyHelper.getFilter ((Map) record.get ("Key"));
    ...
    Map MaxInsertsMap = (Map)record.get("MaxInserts");
    Boolean MaxInsertsFetch = DataHelper.getFetch(MaxInsertsMap);
    Boolean MaxInsertsSortDir = DataHelper.getSortDirection(MaxInsertsMap);
    Integer MaxInsertsSortOrder = DataHelper.getSortOrder(MaxInsertsMap);
    if (MaxInsertsFetch != null) out.setMaxInsertsFetch(MaxInsertsFetch);
    if (MaxInsertsSortDir != null) out.setMaxInsertsSortDirection(MaxInsertsSortDir);
    if (MaxInsertsSortOrder != null) out.setMaxInsertsSortOrder(MaxInsertsSortOrder);

    Filter[] MaxInsertsFilter = DataHelper.mapToFilterArray(MaxInsertsMap, Integer.class);
    if (MaxInsertsFilter != null) {
      IntegerFilter[] MaxInsertsFilters = new IntegerFilter[MaxInsertsFilter.length];
      for (int i = 0; i < MaxInsertsFilters.length; i++) {
        MaxInsertsFilters[i] = (IntegerFilter)MaxInsertsFilter[i];
      }
      try {
        out.setMaxInsertsFilter(MaxInsertsFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
