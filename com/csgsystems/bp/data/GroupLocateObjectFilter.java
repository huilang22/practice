 ...
 * Generated  File: GroupLocateObjectFilter.java
...
/** Filter object */
public class GroupLocateObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public GroupLocateObjectKeyFilter Key = null;
  /** raw field for: EXTERNAL_ID_GROUP_MAP.group_no) */
  ...
  /** raw field for: EXTERNAL_ID_GROUP_MAP.group_type) */
  ...
  /** raw field for: EXTERNAL_ID_GROUP_MAP.server_id) */
  ...
  /** raw field for: EXTERNAL_ID_GROUP_MAP.group_level) */
  ...
  private String _objName = "GroupLocateObjectFilter";
  /** default constructor */
  public GroupLocateObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public GroupLocateObjectFilter (GroupLocateObjectFilter other)
  {
    if (other == null) return;
    this.Key = new GroupLocateObjectKeyFilter (other.Key);
   ...
   * @return GroupLocateObjectKeyFilter
   */
  public GroupLocateObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (GroupLocateObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdFetch = fetch;
  }
  ...
  public boolean getGroupExternalIdFetch ()
  {
    ...
    return this.Key.GroupExternalIdFetch;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdSort = value;
  }
  ...
  public Integer getGroupExternalIdSortOrder ()
  {
    ...
    return this.Key.GroupExternalIdSort;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdSortAscending = ascending;
  }
  ...
  {
    if (this.Key == null) return true;
    return this.Key.GroupExternalIdSortAscending;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsentive for field: GroupExternalId (EXTERNAL_ID_GROUP_MAP.external_id)
   * @return boolean whether the field is case insensitive
   */
  public boolean getGroupExternalIdCaseInsensitive ()
  {
    if (this.Key == null) return false;
    return this.Key.GroupExternalIdCaseInsensitive;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalId = value;
  }
  ...
  {
    if (this.Key == null) return null;
    return this.Key.GroupExternalId;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdTypeFetch = fetch;
  }
  ...
  {
    if (this.Key == null) return true;
    return this.Key.GroupExternalIdTypeFetch;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdTypeSort = value;
  }
  ...
  {
    if (this.Key == null) return null;
    return this.Key.GroupExternalIdTypeSort;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdTypeSortAscending = ascending;
  }
  ...
  {
    if (this.Key == null) return true;
    return this.Key.GroupExternalIdTypeSortAscending;
  }
  ...
  {
    if (this.Key == null) this.Key = new GroupLocateObjectKeyFilter ();
    this.Key.GroupExternalIdType = value;
  }
  ...
  {
    if (this.Key == null) return null;
    return this.Key.GroupExternalIdType;
  }
  /** Set the field level Fetch value for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * @param fetch whether to fetch this field or not
   */
  public void setGroupNoFetch (boolean fetch) {
    this.GroupNoFetch = fetch;
  }
  /** Retrieve Fetch value for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * @return boolean the Fetch value for this field
   */
  public boolean getGroupNoFetch () {
    return this.GroupNoFetch;
  }
  /** Set the SortOrder for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getGroupNoSortOrder () {
    return this.GroupNoSort;
  }
  /** Set the sort direction for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setGroupNoSortDirection (boolean ascending) {
    this.GroupNoSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getGroupNoSortDirection () {
    return this.GroupNoSortAscending;
  }
  /** Set the field level filters for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: GroupNo (EXTERNAL_ID_GROUP_MAP.group_no)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * @param fetch whether to fetch this field or not
   */
  public void setGroupTypeFetch (boolean fetch) {
    this.GroupTypeFetch = fetch;
  }
  /** Retrieve Fetch value for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * @return boolean the Fetch value for this field
   */
  public boolean getGroupTypeFetch () {
    return this.GroupTypeFetch;
  }
  /** Set the SortOrder for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getGroupTypeSortOrder () {
    return this.GroupTypeSort;
  }
  /** Set the sort direction for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setGroupTypeSortDirection (boolean ascending) {
    this.GroupTypeSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getGroupTypeSortDirection () {
    return this.GroupTypeSortAscending;
  }
  /** Set the field level filters for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: GroupType (EXTERNAL_ID_GROUP_MAP.group_type)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * @param fetch whether to fetch this field or not
   */
  public void setServerIdFetch (boolean fetch) {
    this.ServerIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getServerIdFetch () {
    return this.ServerIdFetch;
  }
  /** Set the SortOrder for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getServerIdSortOrder () {
    return this.ServerIdSort;
  }
  /** Set the sort direction for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setServerIdSortDirection (boolean ascending) {
    this.ServerIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getServerIdSortDirection () {
    return this.ServerIdSortAscending;
  }
  /** Set the field level filters for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ServerId (EXTERNAL_ID_GROUP_MAP.server_id)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * @param fetch whether to fetch this field or not
   */
  public void setGroupLevelFetch (boolean fetch) {
    this.GroupLevelFetch = fetch;
  }
  /** Retrieve Fetch value for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * @return boolean the Fetch value for this field
   */
  public boolean getGroupLevelFetch () {
    return this.GroupLevelFetch;
  }
  /** Set the SortOrder for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getGroupLevelSortOrder () {
    return this.GroupLevelSort;
  }
  /** Set the sort direction for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setGroupLevelSortDirection (boolean ascending) {
    this.GroupLevelSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getGroupLevelSortDirection () {
    return this.GroupLevelSortAscending;
  }
  /** Set the field level filters for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: GroupLevel (EXTERNAL_ID_GROUP_MAP.group_level)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  public String toString() {
    return GroupLocateObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return GroupLocateObjectHelper.toMap(this, null);
  }
}
