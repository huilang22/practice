 ...
 * Generated  File: GroupMemberObjectData.java
...
/** GroupMemberObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class GroupMemberObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public GroupMemberObjectKeyData Key = null;
  ...
  /** GROUP_MEMBER.inactive_dt field */
  public    Date InactiveDt  = null;
  protected boolean _InactiveDtSet = false;
  /** GROUP_MEMBER.chg_dt field */
  public    Date ChgDt  = null;
  protected boolean _ChgDtSet = false;
  /** GROUP_MEMBER.chg_who field */
  public    String ChgWho  = null;
  protected boolean _ChgWhoSet = false;
  /** GROUP_MEMBER.create_dt field */
  public    Date CreateDt  = null;
  protected boolean _CreateDtSet = false;
  /** GROUP_MEMBER.is_designated field */
  public    Integer IsDesignated  = null;
  protected boolean _IsDesignatedSet = false;
  private String _objName = "GroupMemberObjectData";
  /** Default constructor */
  public GroupMemberObjectData ()
  {
    super ();
   ...
   */
  public GroupMemberObjectData (GroupMemberObjectData other)
  {

    if (other == null) return;
    this.Key = new GroupMemberObjectKeyData (other.Key);
    ...
    this._IsDesignatedSet = other._IsDesignatedSet;
  }

  /** get the Key for this object
   * @return GroupMemberObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public GroupMemberObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (GroupMemberObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setAccountInternalId (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new GroupMemberObjectKeyData ();
  ...
  /** set the fields value: InactiveDt (GROUP_MEMBER.inactive_dt)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: InactiveDt (GROUP_MEMBER.inactive_dt)
   * @return Date the value
   */
  public Date getInactiveDt () {
    return this.InactiveDt;
  }
  /** Change the field to not being actively set: InactiveDt (GROUP_MEMBER.inactive_dt)
   */
  public void unsetInactiveDt () {
    this._InactiveDtSet = false;
  }
  /** See if the field is actively set: InactiveDt (GROUP_MEMBER.inactive_dt)
   * @return boolean whether the field is actively set
   */
  public boolean issetInactiveDt () {
    return this._InactiveDtSet;
  }
  /** set the fields value: ChgDt (GROUP_MEMBER.chg_dt)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("ChgDt") 
  ...
  /** get the value of the field: ChgDt (GROUP_MEMBER.chg_dt)
   * @return Date the value
   */
  public Date getChgDt () {
    return this.ChgDt;
  }
  /** Change the field to not being actively set: ChgDt (GROUP_MEMBER.chg_dt)
   */
  public void unsetChgDt () {
    this._ChgDtSet = false;
  }
  /** See if the field is actively set: ChgDt (GROUP_MEMBER.chg_dt)
   * @return boolean whether the field is actively set
   */
  public boolean issetChgDt () {
    return this._ChgDtSet;
  }
  /** set the fields value: ChgWho (GROUP_MEMBER.chg_who)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("ChgWho") 
  ...
  /** get the value of the field: ChgWho (GROUP_MEMBER.chg_who)
   * @return String the value
   */
  public String getChgWho () {
    return this.ChgWho;
  }
  /** Change the field to not being actively set: ChgWho (GROUP_MEMBER.chg_who)
   */
  public void unsetChgWho () {
    this._ChgWhoSet = false;
  }
  /** See if the field is actively set: ChgWho (GROUP_MEMBER.chg_who)
   * @return boolean whether the field is actively set
   */
  public boolean issetChgWho () {
    return this._ChgWhoSet;
  }
  /** set the fields value: CreateDt (GROUP_MEMBER.create_dt)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("CreateDt") 
  ...
  /** get the value of the field: CreateDt (GROUP_MEMBER.create_dt)
   * @return Date the value
   */
  public Date getCreateDt () {
    return this.CreateDt;
  }
  /** Change the field to not being actively set: CreateDt (GROUP_MEMBER.create_dt)
   */
  public void unsetCreateDt () {
    this._CreateDtSet = false;
  }
  /** See if the field is actively set: CreateDt (GROUP_MEMBER.create_dt)
   * @return boolean whether the field is actively set
   */
  public boolean issetCreateDt () {
    return this._CreateDtSet;
  }
  /** set the fields value: IsDesignated (GROUP_MEMBER.is_designated)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("IsDesignated") 
  public void setIsDesignated (Integer value) throws ServiceException
  {
    if (value == null)
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_NULL_VALUE", "The field's value cannot be NULL", _objName, "IsDesignated", "setIsDesignated");
    }
    this.IsDesignated = value;
    this._IsDesignatedSet = true;
  }

  /** Retrieves the IsDesignated field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The IsDesignated field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the IsDesignated field
   */
   public String getIsDesignatedAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getIsDesignatedAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getIsDesignatedAsFormattedString");
       return fmtMgr.formatNumber(this.getIsDesignated(), _locale);
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("IsDesignated");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getIsDesignatedAsFormattedString");
       throw x;
     }
   }
  /** Sets the IsDesignated field from a formatted string
   *
   * @param _value the IsDesignated field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the IsDesignated field
   */
   public void setIsDesignatedFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getIsDesignatedFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setIsDesignated(fmtMgr.parseNumber(_value, _locale));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("IsDesignated");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setIsDesignatedFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setIsDesignatedFromFormattedString");
   }

  /** get the value of the field: IsDesignated (GROUP_MEMBER.is_designated)
   * @return Integer the value
   */
  public Integer getIsDesignated () {
    return this.IsDesignated;
  }
  /** Change the field to not being actively set: IsDesignated (GROUP_MEMBER.is_designated)
   */
  public void unsetIsDesignated () {
    this._IsDesignatedSet = false;
  }
  /** See if the field is actively set: IsDesignated (GROUP_MEMBER.is_designated)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDesignated () {
    return this._IsDesignatedSet;
  }
  ...
  /** GROUP_MEMBER.is_designated field */
    if(!nonNullOnly || (IsDesignated != null))  _IsDesignatedSet = flag;
  }
}
