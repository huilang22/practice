 ...
 * Generated  File: InvoiceDetailAccountObjectHelper.java
...
/** Helper class to convert InvoiceDetailAccountObject JavaBean objects to/from HashMaps.
 */
public class InvoiceDetailAccountObjectHelper implements ArubaObjectHelper
{
  /** convert InvoiceDetailAccountObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (InvoiceDetailAccountObjectData in, Map record)
  {
   ...
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @param rootName use this name as the root name for the object (defaults to "InvoiceDetailAccountObject")
   * @return Map     the output Map
   */
  public static Map toMap (InvoiceDetailAccountObjectData in, Map record, String rootName)
  {
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "InvoiceDetailAccountObject";
    Map map = getMap (in, (Map) record.get (rootName));
    map = InvoiceDetailObjectHelper.getMap (in, map);
    record.put (rootName, map);
    return record;
  }
  /** convert InvoiceDetailAccountObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (InvoiceDetailAccountObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert InvoiceDetailAccountObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (InvoiceDetailAccountObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "InvoiceDetailAccountObject";
  ...
  /** convert Map to InvoiceDetailAccountObjectData.
   * @param record the Map containing the data to convert to the object
   * @return InvoiceDetailAccountObjectData the converted object
   */
  public static InvoiceDetailAccountObjectData fromMap (Map record)
  {
    return fromMap (record, null);
  }
  /** convert Map to InvoiceDetailAccountObjectData.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the mape (defaults to "InvoiceDetailAccountObject")
   * @return InvoiceDetailAccountObjectData the converted object
   */
  public static InvoiceDetailAccountObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to InvoiceDetailAccountObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return InvoiceDetailAccountObjectFilter the converted object
   */
  public static InvoiceDetailAccountObjectFilter fromMapFilter (Map record) {
    return fromMapFilter (record, null);
  }
  /** convert Map to InvoiceDetailAccountObjectFilter.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the map (defaults to "InvoiceDetailAccountObject")
   * @return InvoiceDetailAccountObjectFilter the converted object
   */
  public static InvoiceDetailAccountObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "InvoiceDetailAccountObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to InvoiceDetailAccountObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return InvoiceDetailAccountObjectDataList the converted object
   */
  public static InvoiceDetailAccountObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to InvoiceDetailAccountObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "InvoiceDetailAccountObjectList")
   * @return InvoiceDetailAccountObjectDataList the converted object
   */
  public static InvoiceDetailAccountObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "InvoiceDetailAccountObjectList";
    Object[] root = (Object[]) record.get (rootName);
    InvoiceDetailAccountObjectData[] array = null;
    if (root != null)
    {
      array = new InvoiceDetailAccountObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = InvoiceDetailAccountObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new InvoiceDetailAccountObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new InvoiceDetailAccountObjectDataList (array, index, total);
  }
  /** convert InvoiceDetailAccountObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (InvoiceDetailAccountObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in._AccountCurrencyCodeSet) record.put ("AccountCurrencyCode", in.AccountCurrencyCode);
  ...
  /** convert InvoiceDetailAccountObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (InvoiceDetailAccountObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
    ...
    if (in._fetch) record.put ("Fetch", Boolean.TRUE);
      ...
      map = DataHelper.filterToMap (in.AccountCurrencyCode, in.AccountCurrencyCodeSort, in.AccountCurrencyCodeSortAscending, in.AccountCurrencyCodeFetch);
      if (map != null) record.put ("AccountCurrencyCode", map);
   ...
   * @return InvoiceDetailAccountObjectData the converted object
   */
  public static InvoiceDetailAccountObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    InvoiceDetailAccountObjectData out = new InvoiceDetailAccountObjectData (InvoiceDetailObjectHelper.getObj (record));

    if ((obj = record.get ("AccountCurrencyCode")) != null)
    {
      out.AccountCurrencyCode = (Integer) obj;
    }
   ...
   * @return InvoiceDetailAccountObjectFilter the converted object
   */
  public static InvoiceDetailAccountObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    InvoiceDetailAccountObjectFilter out = new InvoiceDetailAccountObjectFilter (InvoiceDetailObjectHelper.getFilter (record));
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    Map AccountCurrencyCodeMap = (Map)record.get("AccountCurrencyCode");
    Boolean AccountCurrencyCodeFetch = DataHelper.getFetch(AccountCurrencyCodeMap);
    Boolean AccountCurrencyCodeSortDir = DataHelper.getSortDirection(AccountCurrencyCodeMap);
    Integer AccountCurrencyCodeSortOrder = DataHelper.getSortOrder(AccountCurrencyCodeMap);
    if (AccountCurrencyCodeFetch != null) out.setAccountCurrencyCodeFetch(AccountCurrencyCodeFetch);
    if (AccountCurrencyCodeSortDir != null) out.setAccountCurrencyCodeSortDirection(AccountCurrencyCodeSortDir);
    if (AccountCurrencyCodeSortOrder != null) out.setAccountCurrencyCodeSortOrder(AccountCurrencyCodeSortOrder);

    Filter[] AccountCurrencyCodeFilter = DataHelper.mapToFilterArray(AccountCurrencyCodeMap, Integer.class);
    if (AccountCurrencyCodeFilter != null) {
      IntegerFilter[] AccountCurrencyCodeFilters = new IntegerFilter[AccountCurrencyCodeFilter.length];
      for (int i = 0; i < AccountCurrencyCodeFilters.length; i++) {
        AccountCurrencyCodeFilters[i] = (IntegerFilter)AccountCurrencyCodeFilter[i];
      }
      try {
        out.setAccountCurrencyCodeFilter(AccountCurrencyCodeFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
