 ...
 * Generated  File: CmfStatusChgReasonObjectData.java
...
/** CmfStatusChgReasonObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class CmfStatusChgReasonObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public CmfStatusChgReasonObjectKeyData Key = null;
  /** CMF_STATUS_CHG_REASON_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** CMF_STATUS_CHG_REASON_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** CMF_STATUS_CHG_REASON_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** CMF_STATUS_CHG_REASON_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** CMF_STATUS_CHG_REASON_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "CmfStatusChgReasonObjectData";
  /** Default constructor */
  public CmfStatusChgReasonObjectData ()
  {
    super ();
   ...
   */
  public CmfStatusChgReasonObjectData (CmfStatusChgReasonObjectData other)
  {

    if (other == null) return;
    this.Key = new CmfStatusChgReasonObjectKeyData (other.Key);
   ...
   * @return CmfStatusChgReasonObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public CmfStatusChgReasonObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (CmfStatusChgReasonObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setChgReasonValue (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new CmfStatusChgReasonObjectKeyData ();
    this.Key.ChgReasonValue = value;
    this.Key._ChgReasonValueSet = true;
  }
  ...
  public void unsetChgReasonValue () {
    ...
    this.Key._ChgReasonValueSet = false;
  }
  ...
  public boolean issetChgReasonValue () {
    ...
    return this.Key._ChgReasonValueSet;
  }
  ...
  /** set the fields value: IsDefault (CMF_STATUS_CHG_REASON_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (CMF_STATUS_CHG_REASON_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (CMF_STATUS_CHG_REASON_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (CMF_STATUS_CHG_REASON_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (CMF_STATUS_CHG_REASON_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (CMF_STATUS_CHG_REASON_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (CMF_STATUS_CHG_REASON_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (CMF_STATUS_CHG_REASON_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: ConfigTagId (CMF_STATUS_CHG_REASON_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (CMF_STATUS_CHG_REASON_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (CMF_STATUS_CHG_REASON_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (CMF_STATUS_CHG_REASON_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (CMF_STATUS_CHG_REASON_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (CMF_STATUS_CHG_REASON_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (CMF_STATUS_CHG_REASON_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (CMF_STATUS_CHG_REASON_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (CMF_STATUS_CHG_REASON_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (CMF_STATUS_CHG_REASON_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (CMF_STATUS_CHG_REASON_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (CMF_STATUS_CHG_REASON_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
