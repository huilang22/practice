 ...
 * Generated  File: AxrtPaymentObjectHelper.java
...
/** Helper class to convert AxrtPaymentObject JavaBean objects to/from HashMaps.
 */
public class AxrtPaymentObjectHelper implements ArubaObjectHelper
{
  /** convert AxrtPaymentObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (AxrtPaymentObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AxrtPaymentObjectData in, Map record, String rootName)
  {
  ...
  /** convert AxrtPaymentObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (AxrtPaymentObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert AxrtPaymentObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AxrtPaymentObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "AxrtPaymentObject";
  ...
  /** convert Map to AxrtPaymentObjectData.
   * @param record the Map containing the data to convert to the object
   * @return AxrtPaymentObjectData the converted object
   */
  public static AxrtPaymentObjectData fromMap (Map record)
  {
   ...
   * @return AxrtPaymentObjectData the converted object
   */
  public static AxrtPaymentObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to AxrtPaymentObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return AxrtPaymentObjectFilter the converted object
   */
  public static AxrtPaymentObjectFilter fromMapFilter (Map record) {
   ...
   * @return AxrtPaymentObjectFilter the converted object
   */
  public static AxrtPaymentObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "AxrtPaymentObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to AxrtPaymentObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return AxrtPaymentObjectDataList the converted object
   */
  public static AxrtPaymentObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to AxrtPaymentObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "AxrtPaymentObjectList")
   * @return AxrtPaymentObjectDataList the converted object
   */
  public static AxrtPaymentObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "AxrtPaymentObjectList";
    Object[] root = (Object[]) record.get (rootName);
    AxrtPaymentObjectData[] array = null;
    if (root != null)
    {
      array = new AxrtPaymentObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = AxrtPaymentObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new AxrtPaymentObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new AxrtPaymentObjectDataList (array, index, total);
  }
  /** convert AxrtPaymentObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AxrtPaymentObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", AxrtPaymentObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert AxrtPaymentObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AxrtPaymentObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return AxrtPaymentObjectData the converted object
   */
  public static AxrtPaymentObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AxrtPaymentObjectData out = new AxrtPaymentObjectData ();

    out.Key = AxrtPaymentObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return AxrtPaymentObjectFilter the converted object
   */
  public static AxrtPaymentObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AxrtPaymentObjectFilter out = new AxrtPaymentObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = AxrtPaymentObjectKeyHelper.getFilter ((Map) record.get ("Key"));
