 ...
 * Generated  File: AdjustmentReasonObjectHelper.java
...
/** Helper class to convert AdjustmentReasonObject JavaBean objects to/from HashMaps.
 */
public class AdjustmentReasonObjectHelper implements ArubaObjectHelper
{
  /** convert AdjustmentReasonObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (AdjustmentReasonObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AdjustmentReasonObjectData in, Map record, String rootName)
  {
  ...
  /** convert AdjustmentReasonObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (AdjustmentReasonObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert AdjustmentReasonObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AdjustmentReasonObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "AdjustmentReasonObject";
  ...
  /** convert Map to AdjustmentReasonObjectData.
   * @param record the Map containing the data to convert to the object
   * @return AdjustmentReasonObjectData the converted object
   */
  public static AdjustmentReasonObjectData fromMap (Map record)
  {
   ...
   * @return AdjustmentReasonObjectData the converted object
   */
  public static AdjustmentReasonObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to AdjustmentReasonObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return AdjustmentReasonObjectFilter the converted object
   */
  public static AdjustmentReasonObjectFilter fromMapFilter (Map record) {
   ...
   * @return AdjustmentReasonObjectFilter the converted object
   */
  public static AdjustmentReasonObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "AdjustmentReasonObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to AdjustmentReasonObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return AdjustmentReasonObjectDataList the converted object
   */
  public static AdjustmentReasonObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to AdjustmentReasonObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "AdjustmentReasonObjectList")
   * @return AdjustmentReasonObjectDataList the converted object
   */
  public static AdjustmentReasonObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "AdjustmentReasonObjectList";
    Object[] root = (Object[]) record.get (rootName);
    AdjustmentReasonObjectData[] array = null;
    if (root != null)
    {
      array = new AdjustmentReasonObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = AdjustmentReasonObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new AdjustmentReasonObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new AdjustmentReasonObjectDataList (array, index, total);
  }
  /** convert AdjustmentReasonObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AdjustmentReasonObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", AdjustmentReasonObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
    if (in._JournalCodeSet) record.put ("JournalCode", in.JournalCode);
  ...
  /** convert AdjustmentReasonObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AdjustmentReasonObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
    ...
    if (in.Key != null) record.put ("Key", AdjustmentReasonObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
      map = DataHelper.filterToMap (in.JournalCode, in.JournalCodeSort, in.JournalCodeSortAscending, in.JournalCodeFetch);
      if (map != null) record.put ("JournalCode", map);
   ...
   * @return AdjustmentReasonObjectData the converted object
   */
  public static AdjustmentReasonObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AdjustmentReasonObjectData out = new AdjustmentReasonObjectData ();

    out.Key = AdjustmentReasonObjectKeyHelper.getObj ((Map) record.get ("Key"));
    if ((obj = record.get ("JournalCode")) != null)
    {
      out.JournalCode = (Integer) obj;
    }
   ...
   * @return AdjustmentReasonObjectFilter the converted object
   */
  public static AdjustmentReasonObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AdjustmentReasonObjectFilter out = new AdjustmentReasonObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = AdjustmentReasonObjectKeyHelper.getFilter ((Map) record.get ("Key"));
    Map JournalCodeMap = (Map)record.get("JournalCode");
    Boolean JournalCodeFetch = DataHelper.getFetch(JournalCodeMap);
    Boolean JournalCodeSortDir = DataHelper.getSortDirection(JournalCodeMap);
    Integer JournalCodeSortOrder = DataHelper.getSortOrder(JournalCodeMap);
    if (JournalCodeFetch != null) out.setJournalCodeFetch(JournalCodeFetch);
    if (JournalCodeSortDir != null) out.setJournalCodeSortDirection(JournalCodeSortDir);
    if (JournalCodeSortOrder != null) out.setJournalCodeSortOrder(JournalCodeSortOrder);

    Filter[] JournalCodeFilter = DataHelper.mapToFilterArray(JournalCodeMap, Integer.class);
    if (JournalCodeFilter != null) {
      IntegerFilter[] JournalCodeFilters = new IntegerFilter[JournalCodeFilter.length];
      for (int i = 0; i < JournalCodeFilters.length; i++) {
        JournalCodeFilters[i] = (IntegerFilter)JournalCodeFilter[i];
      }
      try {
        out.setJournalCodeFilter(JournalCodeFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
