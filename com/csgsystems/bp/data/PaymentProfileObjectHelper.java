 ...
 * Generated  File: PaymentProfileObjectHelper.java
...
/** Helper class to convert PaymentProfileObject JavaBean objects to/from HashMaps.
 */
public class PaymentProfileObjectHelper implements ArubaObjectHelper
{
  /** convert PaymentProfileObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (PaymentProfileObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (PaymentProfileObjectData in, Map record, String rootName)
  {
  ...
  /** convert PaymentProfileObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (PaymentProfileObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert PaymentProfileObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (PaymentProfileObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "PaymentProfileObject";
  ...
  /** convert Map to PaymentProfileObjectData.
   * @param record the Map containing the data to convert to the object
   * @return PaymentProfileObjectData the converted object
   */
  public static PaymentProfileObjectData fromMap (Map record)
  {
   ...
   * @return PaymentProfileObjectData the converted object
   */
  public static PaymentProfileObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to PaymentProfileObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return PaymentProfileObjectFilter the converted object
   */
  public static PaymentProfileObjectFilter fromMapFilter (Map record) {
   ...
   * @return PaymentProfileObjectFilter the converted object
   */
  public static PaymentProfileObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "PaymentProfileObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to PaymentProfileObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return PaymentProfileObjectDataList the converted object
   */
  public static PaymentProfileObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to PaymentProfileObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "PaymentProfileObjectList")
   * @return PaymentProfileObjectDataList the converted object
   */
  public static PaymentProfileObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "PaymentProfileObjectList";
    Object[] root = (Object[]) record.get (rootName);
    PaymentProfileObjectData[] array = null;
    if (root != null)
    {
      array = new PaymentProfileObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = PaymentProfileObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new PaymentProfileObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new PaymentProfileObjectDataList (array, index, total);
  }
  /** convert PaymentProfileObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (PaymentProfileObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", PaymentProfileObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert PaymentProfileObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (PaymentProfileObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return PaymentProfileObjectData the converted object
   */
  public static PaymentProfileObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    PaymentProfileObjectData out = new PaymentProfileObjectData ();

    out.Key = PaymentProfileObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return PaymentProfileObjectFilter the converted object
   */
  public static PaymentProfileObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    PaymentProfileObjectFilter out = new PaymentProfileObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = PaymentProfileObjectKeyHelper.getFilter ((Map) record.get ("Key"));
