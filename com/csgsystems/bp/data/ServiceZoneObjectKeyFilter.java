 ...
 * Generated  File: ServiceZoneObjectKeyFilter.java
...
/** Key Filter for ServiceZoneObject object. */
public class ServiceZoneObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: SERVICE_ZONE.tracking_id) */
  ...
  /** raw field for: SERVICE_ZONE.tracking_id_serv) */
  ...
  private String _objName = "ServiceZoneObjectKeyFilter";
  /** default constructor */
  public ServiceZoneObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public ServiceZoneObjectKeyFilter (ServiceZoneObjectKeyFilter other)
  {
  ...
  public Map toMap() {
    return ServiceZoneObjectKeyHelper.toMap(this, null);
  }
}
