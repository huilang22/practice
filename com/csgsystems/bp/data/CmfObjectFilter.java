 ...
 * Generated  File: CmfObjectFilter.java
...
/** Filter object */
public class CmfObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public CmfObjectKeyFilter Key = null;
  ...
  private String _objName = "CmfObjectFilter";
  /** default constructor */
  public CmfObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public CmfObjectFilter (CmfObjectFilter other)
  {
    if (other == null) return;
    this.Key = new CmfObjectKeyFilter (other.Key);
   ...
   * @return CmfObjectKeyFilter
   */
  public CmfObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (CmfObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new CmfObjectKeyFilter ();
  ...
  public String toString() {
    return CmfObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return CmfObjectHelper.toMap(this, null);
  }
}
