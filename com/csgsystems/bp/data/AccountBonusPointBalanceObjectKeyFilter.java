 ...
 * Generated  File: AccountBonusPointBalanceObjectKeyFilter.java
...
/** Key Filter for AccountBonusPointBalanceObject object. */
public class AccountBonusPointBalanceObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: CMF_POINT_BALANCE.account_no) */
  ...
  /** raw field for: CMF_POINT_BALANCE.bill_ref_no) */
  ...
  /** raw field for: CMF_POINT_BALANCE.bill_ref_resets) */
  ...
  private String _objName = "AccountBonusPointBalanceObjectKeyFilter";
  /** default constructor */
  public AccountBonusPointBalanceObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public AccountBonusPointBalanceObjectKeyFilter (AccountBonusPointBalanceObjectKeyFilter other)
  {
  ...
  public Map toMap() {
    return AccountBonusPointBalanceObjectKeyHelper.toMap(this, null);
  }
}
