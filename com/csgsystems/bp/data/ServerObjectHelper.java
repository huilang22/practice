 ...
 * Generated  File: ServerObjectHelper.java
...
/** Helper class to convert ServerObject JavaBean objects to/from HashMaps.
 */
public class ServerObjectHelper implements ArubaObjectHelper
{
  /** convert ServerObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (ServerObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ServerObjectData in, Map record, String rootName)
  {
  ...
  /** convert ServerObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (ServerObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert ServerObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ServerObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "ServerObject";
  ...
  /** convert Map to ServerObjectData.
   * @param record the Map containing the data to convert to the object
   * @return ServerObjectData the converted object
   */
  public static ServerObjectData fromMap (Map record)
  {
   ...
   * @return ServerObjectData the converted object
   */
  public static ServerObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to ServerObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return ServerObjectFilter the converted object
   */
  public static ServerObjectFilter fromMapFilter (Map record) {
   ...
   * @return ServerObjectFilter the converted object
   */
  public static ServerObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "ServerObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to ServerObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return ServerObjectDataList the converted object
   */
  public static ServerObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to ServerObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "ServerObjectList")
   * @return ServerObjectDataList the converted object
   */
  public static ServerObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "ServerObjectList";
    Object[] root = (Object[]) record.get (rootName);
    ServerObjectData[] array = null;
    if (root != null)
    {
      array = new ServerObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = ServerObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new ServerObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new ServerObjectDataList (array, index, total);
  }
  /** convert ServerObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ServerObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", ServerObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert ServerObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ServerObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return ServerObjectData the converted object
   */
  public static ServerObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ServerObjectData out = new ServerObjectData ();

    out.Key = ServerObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return ServerObjectFilter the converted object
   */
  public static ServerObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ServerObjectFilter out = new ServerObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = ServerObjectKeyHelper.getFilter ((Map) record.get ("Key"));
