 ...
 * Generated  File: TSObjectHelper.java
...
/** Helper class to convert TSObject JavaBean objects to/from HashMaps.
 */
public class TSObjectHelper implements ArubaObjectHelper
{
  /** convert TSObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (TSObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (TSObjectData in, Map record, String rootName)
  {
  ...
  /** convert TSObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (TSObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert TSObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (TSObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "TSObject";
  ...
  /** convert Map to TSObjectData.
   * @param record the Map containing the data to convert to the object
   * @return TSObjectData the converted object
   */
  public static TSObjectData fromMap (Map record)
  {
   ...
   * @return TSObjectData the converted object
   */
  public static TSObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to TSObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return TSObjectFilter the converted object
   */
  public static TSObjectFilter fromMapFilter (Map record) {
   ...
   * @return TSObjectFilter the converted object
   */
  public static TSObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "TSObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to TSObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return TSObjectDataList the converted object
   */
  public static TSObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to TSObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "TSObjectList")
   * @return TSObjectDataList the converted object
   */
  public static TSObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "TSObjectList";
    Object[] root = (Object[]) record.get (rootName);
    TSObjectData[] array = null;
    if (root != null)
    {
      array = new TSObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = TSObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new TSObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new TSObjectDataList (array, index, total);
  }
  /** convert TSObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (TSObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", TSObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert TSObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (TSObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return TSObjectData the converted object
   */
  public static TSObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    TSObjectData out = new TSObjectData ();

    out.Key = TSObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return TSObjectFilter the converted object
   */
  public static TSObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    TSObjectFilter out = new TSObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = TSObjectKeyHelper.getFilter ((Map) record.get ("Key"));
