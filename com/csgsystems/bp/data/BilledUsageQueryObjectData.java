 ...
 * Generated  File: BilledUsageQueryObjectData.java
...
/** BilledUsageQueryObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class BilledUsageQueryObjectData extends BilledUsageObjectData  implements Serializable
{
  ...
  private String _objName = "BilledUsageQueryObjectData";
  /** Default constructor */
  public BilledUsageQueryObjectData ()
  {
    super ();
   ...
   */
  public BilledUsageQueryObjectData (BilledUsageQueryObjectData other)
  {
   ...
   * @param other the object to copy
   */
  public BilledUsageQueryObjectData (BilledUsageObjectData other)
  {
    super (other);
