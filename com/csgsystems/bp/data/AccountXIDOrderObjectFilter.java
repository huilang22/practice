 ...
 * Generated  File: AccountXIDOrderObjectFilter.java
...
/** Filter object */
public class AccountXIDOrderObjectFilter extends AccountObjectFilter  implements Serializable
{
  ...
  /** raw field for: ORD_ORDER.order_number) */
  ...
  private String _objName = "AccountXIDOrderObjectFilter";
  /** default constructor */
  public AccountXIDOrderObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AccountXIDOrderObjectFilter (AccountXIDOrderObjectFilter other)
  {
    super (other);
  ...
  /** Set the field level Fetch value for field: OrderNumber (ORD_ORDER.order_number)
   * @param fetch whether to fetch this field or not
   */
  public void setOrderNumberFetch (boolean fetch) {
    this.OrderNumberFetch = fetch;
  }
  /** Retrieve Fetch value for field: OrderNumber (ORD_ORDER.order_number)
   * @return boolean the Fetch value for this field
   */
  public boolean getOrderNumberFetch () {
    return this.OrderNumberFetch;
  }
  /** Set the SortOrder for field: OrderNumber (ORD_ORDER.order_number)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve filter for field: OrderNumber (ORD_ORDER.order_number)
   * @return StringFilter[] array of field level filters
   */
   ...
   */
  public AccountXIDOrderObjectFilter (AccountObjectFilter other)
  {
    super (other);
  ...
  public String toString() {
    return AccountXIDOrderObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return AccountXIDOrderObjectHelper.toMap(this, null);
  }
}
