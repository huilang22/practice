 ...
 * Generated  File: SCObjectDataList.java
...
public class SCObjectDataList extends ArubaObjectList implements Serializable
{
  /** The array of objects */
  public SCObjectData[] array = null;
  
  public SCObjectDataList () {} 
  /** constructor
   * @param array      the array of objects
   * @param index      the Index offset for this result set
   * @param totalCount the total count of records the query resulted in
   */
  public SCObjectDataList (SCObjectData[] array, Integer index, Integer totalCount) {
    this.array = array;
   ...
   * @return SCObjectData[] the object array
   */
  public SCObjectData[] getArray () {
    return this.array;
  }

  /** Retrieve the Collection of objects.
   * @return SCObjectData[] the object collection
   */
  ...
  public String toString() {
    SCObjectData[] array = getArray();
    StringBuffer buff = new StringBuffer("Length = "+getLength());
    if (array != null) {
      SCObjectData data = null;
      for (int i = 0; i < array.length; i++) {
        buff.append("["+i+"]"+SCObjectHelper.toMap(data, null).toString());
      }
    }
