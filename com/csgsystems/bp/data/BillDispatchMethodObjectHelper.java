 ...
 * Generated  File: BillDispatchMethodObjectHelper.java
...
/** Helper class to convert BillDispatchMethodObject JavaBean objects to/from HashMaps.
 */
public class BillDispatchMethodObjectHelper implements ArubaObjectHelper
{
  /** convert BillDispatchMethodObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (BillDispatchMethodObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillDispatchMethodObjectData in, Map record, String rootName)
  {
  ...
  /** convert BillDispatchMethodObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BillDispatchMethodObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BillDispatchMethodObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillDispatchMethodObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BillDispatchMethodObject";
  ...
  /** convert Map to BillDispatchMethodObjectData.
   * @param record the Map containing the data to convert to the object
   * @return BillDispatchMethodObjectData the converted object
   */
  public static BillDispatchMethodObjectData fromMap (Map record)
  {
   ...
   * @return BillDispatchMethodObjectData the converted object
   */
  public static BillDispatchMethodObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BillDispatchMethodObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return BillDispatchMethodObjectFilter the converted object
   */
  public static BillDispatchMethodObjectFilter fromMapFilter (Map record) {
   ...
   * @return BillDispatchMethodObjectFilter the converted object
   */
  public static BillDispatchMethodObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BillDispatchMethodObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to BillDispatchMethodObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return BillDispatchMethodObjectDataList the converted object
   */
  public static BillDispatchMethodObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to BillDispatchMethodObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "BillDispatchMethodObjectList")
   * @return BillDispatchMethodObjectDataList the converted object
   */
  public static BillDispatchMethodObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "BillDispatchMethodObjectList";
    Object[] root = (Object[]) record.get (rootName);
    BillDispatchMethodObjectData[] array = null;
    if (root != null)
    {
      array = new BillDispatchMethodObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = BillDispatchMethodObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new BillDispatchMethodObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new BillDispatchMethodObjectDataList (array, index, total);
  }
  /** convert BillDispatchMethodObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BillDispatchMethodObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", BillDispatchMethodObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert BillDispatchMethodObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BillDispatchMethodObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return BillDispatchMethodObjectData the converted object
   */
  public static BillDispatchMethodObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillDispatchMethodObjectData out = new BillDispatchMethodObjectData ();

    out.Key = BillDispatchMethodObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return BillDispatchMethodObjectFilter the converted object
   */
  public static BillDispatchMethodObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillDispatchMethodObjectFilter out = new BillDispatchMethodObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = BillDispatchMethodObjectKeyHelper.getFilter ((Map) record.get ("Key"));
