 ...
 * Generated  File: CmfObjectHelper.java
...
/** Helper class to convert CmfObject JavaBean objects to/from HashMaps.
 */
public class CmfObjectHelper implements ArubaObjectHelper
{
  /** convert CmfObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (CmfObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (CmfObjectData in, Map record, String rootName)
  {
  ...
  /** convert CmfObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (CmfObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert CmfObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (CmfObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "CmfObject";
  ...
  /** convert Map to CmfObjectData.
   * @param record the Map containing the data to convert to the object
   * @return CmfObjectData the converted object
   */
  public static CmfObjectData fromMap (Map record)
  {
   ...
   * @return CmfObjectData the converted object
   */
  public static CmfObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to CmfObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return CmfObjectFilter the converted object
   */
  public static CmfObjectFilter fromMapFilter (Map record) {
   ...
   * @return CmfObjectFilter the converted object
   */
  public static CmfObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "CmfObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to CmfObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return CmfObjectDataList the converted object
   */
  public static CmfObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to CmfObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "CmfObjectList")
   * @return CmfObjectDataList the converted object
   */
  public static CmfObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "CmfObjectList";
    Object[] root = (Object[]) record.get (rootName);
    CmfObjectData[] array = null;
    if (root != null)
    {
      array = new CmfObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = CmfObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new CmfObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new CmfObjectDataList (array, index, total);
  }
  /** convert CmfObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (CmfObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", CmfObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert CmfObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (CmfObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return CmfObjectData the converted object
   */
  public static CmfObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    CmfObjectData out = new CmfObjectData ();

    out.Key = CmfObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return CmfObjectFilter the converted object
   */
  public static CmfObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    CmfObjectFilter out = new CmfObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = CmfObjectKeyHelper.getFilter ((Map) record.get ("Key"));
