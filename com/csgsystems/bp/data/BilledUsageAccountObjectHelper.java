 ...
 * Generated  File: BilledUsageAccountObjectHelper.java
...
/** Helper class to convert BilledUsageAccountObject JavaBean objects to/from HashMaps.
 */
public class BilledUsageAccountObjectHelper implements ArubaObjectHelper
{
  /** convert BilledUsageAccountObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (BilledUsageAccountObjectData in, Map record)
  {
   ...
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @param rootName use this name as the root name for the object (defaults to "BilledUsageAccountObject")
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageAccountObjectData in, Map record, String rootName)
  {
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BilledUsageAccountObject";
    Map map = getMap (in, (Map) record.get (rootName));
    map = BilledUsageObjectHelper.getMap (in, map);
    record.put (rootName, map);
    return record;
  }
  /** convert BilledUsageAccountObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageAccountObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BilledUsageAccountObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageAccountObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BilledUsageAccountObject";
  ...
  /** convert Map to BilledUsageAccountObjectData.
   * @param record the Map containing the data to convert to the object
   * @return BilledUsageAccountObjectData the converted object
   */
  public static BilledUsageAccountObjectData fromMap (Map record)
  {
    return fromMap (record, null);
  }
  /** convert Map to BilledUsageAccountObjectData.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the mape (defaults to "BilledUsageAccountObject")
   * @return BilledUsageAccountObjectData the converted object
   */
  public static BilledUsageAccountObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BilledUsageAccountObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return BilledUsageAccountObjectFilter the converted object
   */
  public static BilledUsageAccountObjectFilter fromMapFilter (Map record) {
    return fromMapFilter (record, null);
  }
  /** convert Map to BilledUsageAccountObjectFilter.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the map (defaults to "BilledUsageAccountObject")
   * @return BilledUsageAccountObjectFilter the converted object
   */
  public static BilledUsageAccountObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BilledUsageAccountObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to BilledUsageAccountObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return BilledUsageAccountObjectDataList the converted object
   */
  public static BilledUsageAccountObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to BilledUsageAccountObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "BilledUsageAccountObjectList")
   * @return BilledUsageAccountObjectDataList the converted object
   */
  public static BilledUsageAccountObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "BilledUsageAccountObjectList";
    Object[] root = (Object[]) record.get (rootName);
    BilledUsageAccountObjectData[] array = null;
    if (root != null)
    {
      array = new BilledUsageAccountObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = BilledUsageAccountObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new BilledUsageAccountObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new BilledUsageAccountObjectDataList (array, index, total);
  }
  /** convert BilledUsageAccountObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BilledUsageAccountObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
  ...
  /** convert BilledUsageAccountObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BilledUsageAccountObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return BilledUsageAccountObjectData the converted object
   */
  public static BilledUsageAccountObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BilledUsageAccountObjectData out = new BilledUsageAccountObjectData (BilledUsageObjectHelper.getObj (record));
   ...
   * @return BilledUsageAccountObjectFilter the converted object
   */
  public static BilledUsageAccountObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BilledUsageAccountObjectFilter out = new BilledUsageAccountObjectFilter (BilledUsageObjectHelper.getFilter (record));
