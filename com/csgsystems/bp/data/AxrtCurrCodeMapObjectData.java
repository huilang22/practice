 ...
 * Generated  File: AxrtCurrCodeMapObjectData.java
...
/** AxrtCurrCodeMapObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class AxrtCurrCodeMapObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public AxrtCurrCodeMapObjectKeyData Key = null;
  ...
  private String _objName = "AxrtCurrCodeMapObjectData";
  /** Default constructor */
  public AxrtCurrCodeMapObjectData ()
  {
    super ();
   ...
   */
  public AxrtCurrCodeMapObjectData (AxrtCurrCodeMapObjectData other)
  {

    if (other == null) return;
    this.Key = new AxrtCurrCodeMapObjectKeyData (other.Key);
   ...
   * @return AxrtCurrCodeMapObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public AxrtCurrCodeMapObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (AxrtCurrCodeMapObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setRateCurrencyCode (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new AxrtCurrCodeMapObjectKeyData ();
