 ...
 * Generated  File: PaymentTransObjectFilter.java
...
/** Filter object */
public class PaymentTransObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public PaymentTransObjectKeyFilter Key = null;
  ...
  private String _objName = "PaymentTransObjectFilter";
  /** default constructor */
  public PaymentTransObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public PaymentTransObjectFilter (PaymentTransObjectFilter other)
  {
    if (other == null) return;
    this.Key = new PaymentTransObjectKeyFilter (other.Key);
   ...
   * @return PaymentTransObjectKeyFilter
   */
  public PaymentTransObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (PaymentTransObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new PaymentTransObjectKeyFilter ();
  ...
  public Map toMap() {
    return PaymentTransObjectHelper.toMap(this, null);
  }
}
