 ...
 * Generated  File: BilledUsageQueryObjectFilter.java
...
/** Filter object */
public class BilledUsageQueryObjectFilter extends BilledUsageObjectFilter  implements Serializable
{
  /** raw field */
  ...
  private String _objName = "BilledUsageQueryObjectFilter";
  /** default constructor */
  public BilledUsageQueryObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public BilledUsageQueryObjectFilter (BilledUsageQueryObjectFilter other)
  {
    super (other);
   ...
   */
  public BilledUsageQueryObjectFilter (BilledUsageObjectFilter other)
  {
    super (other);
  ...
  public String toString() {
    return BilledUsageQueryObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return BilledUsageQueryObjectHelper.toMap(this, null);
  }
}
