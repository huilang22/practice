 ...
 * Generated  File: AccountLocateXIDObjectData.java
...
/** AccountLocateXIDObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class AccountLocateXIDObjectData extends AccountLocateObjectData  implements Serializable
{
  ...
  private String _objName = "AccountLocateXIDObjectData";
  /** Default constructor */
  public AccountLocateXIDObjectData ()
  {
    super ();
   ...
   */
  public AccountLocateXIDObjectData (AccountLocateXIDObjectData other)
  {
   ...
   * @param other the object to copy
   */
  public AccountLocateXIDObjectData (AccountLocateObjectData other)
  {
    super (other);
