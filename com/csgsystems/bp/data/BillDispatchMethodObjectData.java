 ...
 * Generated  File: BillDispatchMethodObjectData.java
...
/** BillDispatchMethodObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class BillDispatchMethodObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public BillDispatchMethodObjectKeyData Key = null;
  /** BILL_DISP_METH_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** BILL_DISP_METH_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** BILL_DISP_METH_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** BILL_DISP_METH_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** BILL_DISP_METH_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "BillDispatchMethodObjectData";
  /** Default constructor */
  public BillDispatchMethodObjectData ()
  {
    super ();
   ...
   */
  public BillDispatchMethodObjectData (BillDispatchMethodObjectData other)
  {

    if (other == null) return;
    this.Key = new BillDispatchMethodObjectKeyData (other.Key);
   ...
   * @return BillDispatchMethodObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public BillDispatchMethodObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (BillDispatchMethodObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setBillDispMeth (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new BillDispatchMethodObjectKeyData ();
    this.Key.BillDispMeth = value;
    this.Key._BillDispMethSet = true;
  }
  ...
  public void unsetBillDispMeth () {
    ...
    this.Key._BillDispMethSet = false;
  }
  ...
  public boolean issetBillDispMeth () {
    ...
    return this.Key._BillDispMethSet;
  }
  ...
  /** set the fields value: IsDefault (BILL_DISP_METH_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (BILL_DISP_METH_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (BILL_DISP_METH_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (BILL_DISP_METH_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (BILL_DISP_METH_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (BILL_DISP_METH_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (BILL_DISP_METH_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (BILL_DISP_METH_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: ConfigTagId (BILL_DISP_METH_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (BILL_DISP_METH_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (BILL_DISP_METH_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (BILL_DISP_METH_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (BILL_DISP_METH_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (BILL_DISP_METH_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (BILL_DISP_METH_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (BILL_DISP_METH_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (BILL_DISP_METH_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (BILL_DISP_METH_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (BILL_DISP_METH_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (BILL_DISP_METH_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
