 ...
 * Generated  File: AdjustmentReasonObjectFilter.java
...
/** Filter object */
public class AdjustmentReasonObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public AdjustmentReasonObjectKeyFilter Key = null;
  /** raw field for: ADJ_REASON_CODE_REF.journal_code) */
  public    IntegerFilter[] JournalCode  = null;
  protected boolean JournalCodeFetch = false;
  protected boolean JournalCodeSortAscending = true;
  protected Integer JournalCodeSort = null;
  /** raw field for: ADJ_REASON_CODE_REF.is_default) */
  ...
  /** raw field for: ADJ_REASON_CODE_REF.is_internal) */
  ...
  /** raw field for: ADJ_REASON_CODE_REF.config_tag_id) */
  ...
  /** raw field for: ADJ_REASON_CODE_VALUES.short_display) */
  ...
  /** raw field for: ADJ_REASON_CODE_VALUES.display_value) */
  ...
  private String _objName = "AdjustmentReasonObjectFilter";
  /** default constructor */
  public AdjustmentReasonObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AdjustmentReasonObjectFilter (AdjustmentReasonObjectFilter other)
  {
    if (other == null) return;
    this.Key = new AdjustmentReasonObjectKeyFilter (other.Key);
    this.JournalCode = other.JournalCode;
    this.JournalCodeFetch = other.JournalCodeFetch;
    this.JournalCodeSort = other.JournalCodeSort;
    this.JournalCodeSortAscending = other.JournalCodeSortAscending;
   ...
   * @return AdjustmentReasonObjectKeyFilter
   */
  public AdjustmentReasonObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (AdjustmentReasonObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new AdjustmentReasonObjectKeyFilter ();
    this.Key.AdjReasonCodeFetch = fetch;
  }
  ...
  public boolean getAdjReasonCodeFetch ()
  {
    ...
    return this.Key.AdjReasonCodeFetch;
  }
  ...
  {
    if (this.Key == null) this.Key = new AdjustmentReasonObjectKeyFilter ();
    this.Key.AdjReasonCodeSort = value;
  }
  ...
  public Integer getAdjReasonCodeSortOrder ()
  {
    ...
    return this.Key.AdjReasonCodeSort;
  }
  ...
  {
    if (this.Key == null) this.Key = new AdjustmentReasonObjectKeyFilter ();
    this.Key.AdjReasonCodeSortAscending = ascending;
  }
  ...
  {
    if (this.Key == null) return true;
    return this.Key.AdjReasonCodeSortAscending;
  }
  ...
  /** Set the field level Fetch value for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @param fetch whether to fetch this field or not
   */
  public void setJournalCodeFetch (boolean fetch) {
    this.JournalCodeFetch = fetch;
  }
  /** Retrieve Fetch value for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @return boolean the Fetch value for this field
   */
  public boolean getJournalCodeFetch () {
    return this.JournalCodeFetch;
  }
  /** Set the SortOrder for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setJournalCodeSortOrder (Integer value) {
    this.JournalCodeSort = value;
  }
  /** Retrieve SortOrder for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getJournalCodeSortOrder () {
    return this.JournalCodeSort;
  }
  /** Set the sort direction for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setJournalCodeSortDirection (boolean ascending) {
    this.JournalCodeSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getJournalCodeSortDirection () {
    return this.JournalCodeSortAscending;
  }
  /** Set the field level filters for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setJournalCodeFilter (IntegerFilter[] value) throws ServiceException {
    this.JournalCode = value;
  }
  /** Retrieve filter for field: JournalCode (ADJ_REASON_CODE_REF.journal_code)
   * @return IntegerFilter[] array of field level filters
   */
  public IntegerFilter[] getJournalCodeFilter () {
    return this.JournalCode;
  }

  /**
   * Retrieves the JournalCodeFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The JournalCodeFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the JournalCodeFilter field
   */
  public String[] getJournalCodeFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getJournalCodeFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getJournalCodeFilter(), _locale, false, false);
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getJournalCodeFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("JournalCodeFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getJournalCodeFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the JournalCodeFilter filter value from a formatted string
   *
   * @param _value the JournalCodeFilter filter value(s) in formatted form. If the requested
   ...
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the JournalCodeFilter filter field
   */
  public void setJournalCodeFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setJournalCodeFilterFromFormattedString");
    try {
      this.setJournalCodeFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("JournalCodeFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setJournalCodeFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setJournalCodeFilterFromFormattedString");
  }

  /** Set the field level Fetch value for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @param fetch whether to fetch this field or not
   */
  public void setIsDefaultFetch (boolean fetch) {
    this.IsDefaultFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsDefaultFetch () {
    return this.IsDefaultFetch;
  }
  /** Set the SortOrder for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsDefaultSortOrder () {
    return this.IsDefaultSort;
  }
  /** Set the sort direction for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsDefaultSortDirection (boolean ascending) {
    this.IsDefaultSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsDefaultSortDirection () {
    return this.IsDefaultSortAscending;
  }
  /** Set the field level filters for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsDefault (ADJ_REASON_CODE_REF.is_default)
  ...
  /** Set the field level Fetch value for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @param fetch whether to fetch this field or not
   */
  public void setIsInternalFetch (boolean fetch) {
    this.IsInternalFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsInternalFetch () {
    return this.IsInternalFetch;
  }
  /** Set the SortOrder for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsInternalSortOrder () {
    return this.IsInternalSort;
  }
  /** Set the sort direction for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsInternalSortDirection (boolean ascending) {
    this.IsInternalSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsInternalSortDirection () {
    return this.IsInternalSortAscending;
  }
  /** Set the field level filters for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsInternal (ADJ_REASON_CODE_REF.is_internal)
   * @return BooleanFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @param fetch whether to fetch this field or not
   */
  public void setConfigTagIdFetch (boolean fetch) {
    this.ConfigTagIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getConfigTagIdFetch () {
    return this.ConfigTagIdFetch;
  }
  /** Set the SortOrder for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getConfigTagIdSortOrder () {
    return this.ConfigTagIdSort;
  }
  /** Set the sort direction for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setConfigTagIdSortDirection (boolean ascending) {
    this.ConfigTagIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getConfigTagIdSortDirection () {
    return this.ConfigTagIdSortAscending;
  }
  /** Set the case insensitive for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setConfigTagIdCaseInsensitive (boolean ascending) {
    this.ConfigTagIdCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getConfigTagIdCaseInsensitive () {
    return this.ConfigTagIdCaseInsensitive;
  }
  /** Set the field level filters for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ConfigTagId (ADJ_REASON_CODE_REF.config_tag_id)
  ...
  /** Set the field level Fetch value for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @param fetch whether to fetch this field or not
   */
  public void setShortDisplayFetch (boolean fetch) {
    this.ShortDisplayFetch = fetch;
  }
  /** Retrieve Fetch value for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @return boolean the Fetch value for this field
   */
  public boolean getShortDisplayFetch () {
    return this.ShortDisplayFetch;
  }
  /** Set the SortOrder for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getShortDisplaySortOrder () {
    return this.ShortDisplaySort;
  }
  /** Set the sort direction for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setShortDisplaySortDirection (boolean ascending) {
    this.ShortDisplaySortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getShortDisplaySortDirection () {
    return this.ShortDisplaySortAscending;
  }
  /** Set the case insensitive for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setShortDisplayCaseInsensitive (boolean ascending) {
    this.ShortDisplayCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getShortDisplayCaseInsensitive () {
    return this.ShortDisplayCaseInsensitive;
  }
  /** Set the field level filters for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ShortDisplay (ADJ_REASON_CODE_VALUES.short_display)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @param fetch whether to fetch this field or not
   */
  public void setDisplayValueFetch (boolean fetch) {
    this.DisplayValueFetch = fetch;
  }
  /** Retrieve Fetch value for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @return boolean the Fetch value for this field
   */
  public boolean getDisplayValueFetch () {
    return this.DisplayValueFetch;
  }
  /** Set the SortOrder for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getDisplayValueSortOrder () {
    return this.DisplayValueSort;
  }
  /** Set the sort direction for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setDisplayValueSortDirection (boolean ascending) {
    this.DisplayValueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getDisplayValueSortDirection () {
    return this.DisplayValueSortAscending;
  }
  /** Set the case insensitive for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setDisplayValueCaseInsensitive (boolean ascending) {
    this.DisplayValueCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getDisplayValueCaseInsensitive () {
    return this.DisplayValueCaseInsensitive;
  }
  /** Set the field level filters for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: DisplayValue (ADJ_REASON_CODE_VALUES.display_value)
   * @return StringFilter[] array of field level filters
   */
  ...
  public String toString() {
    return AdjustmentReasonObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return AdjustmentReasonObjectHelper.toMap(this, null);
  }
}
