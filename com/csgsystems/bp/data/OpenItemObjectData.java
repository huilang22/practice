 ...
 * Generated  File: OpenItemObjectData.java
...
/** OpenItemObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class OpenItemObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public OpenItemObjectKeyData Key = null;
  /** OPEN_ITEM_ID_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** OPEN_ITEM_ID_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** OPEN_ITEM_ID_REF.open_item_id_type field */
  public    Integer OpenItemIdType  = null;
  protected boolean _OpenItemIdTypeSet = false;
  /** OPEN_ITEM_ID_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** OPEN_ITEM_ID_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** OPEN_ITEM_ID_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "OpenItemObjectData";
  /** Default constructor */
  public OpenItemObjectData ()
  {
    super ();
   ...
   */
  public OpenItemObjectData (OpenItemObjectData other)
  {

    if (other == null) return;
    this.Key = new OpenItemObjectKeyData (other.Key);
    ...
    this._OpenItemIdTypeSet = other._OpenItemIdTypeSet;
   ...
   * @return OpenItemObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public OpenItemObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (OpenItemObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setOpenItemId (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new OpenItemObjectKeyData ();
  ...
  /** set the fields value: IsDefault (OPEN_ITEM_ID_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (OPEN_ITEM_ID_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (OPEN_ITEM_ID_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (OPEN_ITEM_ID_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (OPEN_ITEM_ID_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (OPEN_ITEM_ID_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (OPEN_ITEM_ID_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (OPEN_ITEM_ID_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: OpenItemIdType (OPEN_ITEM_ID_REF.open_item_id_type)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("OpenItemIdType") 
  public void setOpenItemIdType (Integer value) throws ServiceException
  {
    if (value == null)
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_NULL_VALUE", "The field's value cannot be NULL", _objName, "OpenItemIdType", "setOpenItemIdType");
    }
    this.OpenItemIdType = value;
    this._OpenItemIdTypeSet = true;
  }

  /** Retrieves the OpenItemIdType field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The OpenItemIdType field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the OpenItemIdType field
   */
   public String getOpenItemIdTypeAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getOpenItemIdTypeAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getOpenItemIdTypeAsFormattedString");
       return fmtMgr.formatNumber(this.getOpenItemIdType(), _locale);
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("OpenItemIdType");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getOpenItemIdTypeAsFormattedString");
       throw x;
     }
   }
  /** Sets the OpenItemIdType field from a formatted string
   *
   * @param _value the OpenItemIdType field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the OpenItemIdType field
   */
   public void setOpenItemIdTypeFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getOpenItemIdTypeFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setOpenItemIdType(fmtMgr.parseNumber(_value, _locale));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("OpenItemIdType");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setOpenItemIdTypeFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setOpenItemIdTypeFromFormattedString");
   }

  /** get the value of the field: OpenItemIdType (OPEN_ITEM_ID_REF.open_item_id_type)
   * @return Integer the value
   */
  public Integer getOpenItemIdType () {
    return this.OpenItemIdType;
  }
  /** Change the field to not being actively set: OpenItemIdType (OPEN_ITEM_ID_REF.open_item_id_type)
   */
  public void unsetOpenItemIdType () {
    this._OpenItemIdTypeSet = false;
  }
  /** See if the field is actively set: OpenItemIdType (OPEN_ITEM_ID_REF.open_item_id_type)
   * @return boolean whether the field is actively set
   */
  public boolean issetOpenItemIdType () {
    return this._OpenItemIdTypeSet;
  }
  /** set the fields value: ConfigTagId (OPEN_ITEM_ID_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (OPEN_ITEM_ID_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (OPEN_ITEM_ID_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (OPEN_ITEM_ID_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (OPEN_ITEM_ID_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (OPEN_ITEM_ID_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (OPEN_ITEM_ID_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (OPEN_ITEM_ID_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (OPEN_ITEM_ID_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (OPEN_ITEM_ID_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (OPEN_ITEM_ID_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (OPEN_ITEM_ID_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
  ...
  /** OPEN_ITEM_ID_REF.open_item_id_type field */
    if(!nonNullOnly || (OpenItemIdType != null))  _OpenItemIdTypeSet = flag;
  /** OPEN_ITEM_ID_REF.config_tag_id field */
