 ...
 * Generated  File: PrivacyLevelObjectHelper.java
...
/** Helper class to convert PrivacyLevelObject JavaBean objects to/from HashMaps.
 */
public class PrivacyLevelObjectHelper implements ArubaObjectHelper
{
  /** convert PrivacyLevelObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (PrivacyLevelObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (PrivacyLevelObjectData in, Map record, String rootName)
  {
  ...
  /** convert PrivacyLevelObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (PrivacyLevelObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert PrivacyLevelObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (PrivacyLevelObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "PrivacyLevelObject";
  ...
  /** convert Map to PrivacyLevelObjectData.
   * @param record the Map containing the data to convert to the object
   * @return PrivacyLevelObjectData the converted object
   */
  public static PrivacyLevelObjectData fromMap (Map record)
  {
   ...
   * @return PrivacyLevelObjectData the converted object
   */
  public static PrivacyLevelObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to PrivacyLevelObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return PrivacyLevelObjectFilter the converted object
   */
  public static PrivacyLevelObjectFilter fromMapFilter (Map record) {
   ...
   * @return PrivacyLevelObjectFilter the converted object
   */
  public static PrivacyLevelObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "PrivacyLevelObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to PrivacyLevelObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return PrivacyLevelObjectDataList the converted object
   */
  public static PrivacyLevelObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to PrivacyLevelObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "PrivacyLevelObjectList")
   * @return PrivacyLevelObjectDataList the converted object
   */
  public static PrivacyLevelObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "PrivacyLevelObjectList";
    Object[] root = (Object[]) record.get (rootName);
    PrivacyLevelObjectData[] array = null;
    if (root != null)
    {
      array = new PrivacyLevelObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = PrivacyLevelObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new PrivacyLevelObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new PrivacyLevelObjectDataList (array, index, total);
  }
  /** convert PrivacyLevelObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (PrivacyLevelObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", PrivacyLevelObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert PrivacyLevelObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (PrivacyLevelObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return PrivacyLevelObjectData the converted object
   */
  public static PrivacyLevelObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    PrivacyLevelObjectData out = new PrivacyLevelObjectData ();

    out.Key = PrivacyLevelObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return PrivacyLevelObjectFilter the converted object
   */
  public static PrivacyLevelObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    PrivacyLevelObjectFilter out = new PrivacyLevelObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = PrivacyLevelObjectKeyHelper.getFilter ((Map) record.get ("Key"));
