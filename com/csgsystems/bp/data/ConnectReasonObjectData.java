 ...
 * Generated  File: ConnectReasonObjectData.java
...
/** ConnectReasonObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class ConnectReasonObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public ConnectReasonObjectKeyData Key = null;
  /** CONNECT_REASON_CODES_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** CONNECT_REASON_CODES_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** CONNECT_REASON_CODES_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** CONNECT_REASON_CODES_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** CONNECT_REASON_CODES_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "ConnectReasonObjectData";
  /** Default constructor */
  public ConnectReasonObjectData ()
  {
    super ();
   ...
   */
  public ConnectReasonObjectData (ConnectReasonObjectData other)
  {

    if (other == null) return;
    this.Key = new ConnectReasonObjectKeyData (other.Key);
   ...
   * @return ConnectReasonObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public ConnectReasonObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (ConnectReasonObjectKeyData Key)
  {
    this.Key = Key;
  }
  /** set the fields value: ConnectReason (CONNECT_REASON_CODES_VALUES.connect_reason)
  ...
  public void setConnectReason (Integer value) throws ServiceException
  {
    if (value == null)
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_NULL_VALUE", "The field's value cannot be NULL", _objName, "ConnectReason", "setConnectReason");
    }
    if (this.Key == null) this.Key = new ConnectReasonObjectKeyData ();
    this.Key.ConnectReason = value;
    this.Key._ConnectReasonSet = true;
  }
  /** get the value of the field: ConnectReason (CONNECT_REASON_CODES_VALUES.connect_reason)
  ...
  /** Change the field to not being actively set: ConnectReason (CONNECT_REASON_CODES_VALUES.connect_reason)
   */
  public void unsetConnectReason () {
    if (this.Key == null) return;
    this.Key._ConnectReasonSet = false;
  }
  /** See if the field is actively set: ConnectReason (CONNECT_REASON_CODES_VALUES.connect_reason)
   * @return boolean whether the field is actively set
   */
  public boolean issetConnectReason () {
    if (this.Key == null) return false;
    return this.Key._ConnectReasonSet;
  }
  ...
  /** set the fields value: LanguageCode (CONNECT_REASON_CODES_VALUES.language_code)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: LanguageCode (CONNECT_REASON_CODES_VALUES.language_code)
   * @return Integer the value
   */
  ...
  /** Change the field to not being actively set: LanguageCode (CONNECT_REASON_CODES_VALUES.language_code)
   */
  public void unsetLanguageCode () {
    if (this.Key == null) return;
    this.Key._LanguageCodeSet = false;
  }
  /** See if the field is actively set: LanguageCode (CONNECT_REASON_CODES_VALUES.language_code)
   * @return boolean whether the field is actively set
   */
  ...
  /** set the fields value: IsDefault (CONNECT_REASON_CODES_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (CONNECT_REASON_CODES_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (CONNECT_REASON_CODES_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (CONNECT_REASON_CODES_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (CONNECT_REASON_CODES_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (CONNECT_REASON_CODES_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (CONNECT_REASON_CODES_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (CONNECT_REASON_CODES_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: ConfigTagId (CONNECT_REASON_CODES_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (CONNECT_REASON_CODES_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (CONNECT_REASON_CODES_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (CONNECT_REASON_CODES_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (CONNECT_REASON_CODES_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (CONNECT_REASON_CODES_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (CONNECT_REASON_CODES_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (CONNECT_REASON_CODES_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (CONNECT_REASON_CODES_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (CONNECT_REASON_CODES_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (CONNECT_REASON_CODES_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (CONNECT_REASON_CODES_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
