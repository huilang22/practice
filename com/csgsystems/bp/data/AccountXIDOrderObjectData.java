 ...
 * Generated  File: AccountXIDOrderObjectData.java
...
/** AccountXIDOrderObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class AccountXIDOrderObjectData extends AccountObjectData  implements Serializable
{
  ...
  /** ORD_ORDER.order_number field */
  public    String OrderNumber  = null;
  protected boolean _OrderNumberSet = false;
  private String _objName = "AccountXIDOrderObjectData";
  /** Default constructor */
  public AccountXIDOrderObjectData ()
  {
    super ();
   ...
   */
  public AccountXIDOrderObjectData (AccountXIDOrderObjectData other)
  {
   ...
   * @param other the object to copy
   */
  public AccountXIDOrderObjectData (AccountObjectData other)
  {
    super (other);
  ...
  /** set the fields value: OrderNumber (ORD_ORDER.order_number)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: OrderNumber (ORD_ORDER.order_number)
   * @return String the value
   */
  public String getOrderNumber () {
    return this.OrderNumber;
  }
  /** Change the field to not being actively set: OrderNumber (ORD_ORDER.order_number)
   */
  public void unsetOrderNumber () {
    this._OrderNumberSet = false;
  }
  /** See if the field is actively set: OrderNumber (ORD_ORDER.order_number)
   * @return boolean whether the field is actively set
   */
