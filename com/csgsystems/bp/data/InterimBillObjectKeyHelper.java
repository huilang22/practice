 ...
 * Generated  File: InterimBillObjectKeyHelper.java
...
/** Helper class for InterimBillObject's Key objects. */
public class InterimBillObjectKeyHelper implements ArubaObjectHelper
{
  /** convert InterimBillObjectKeyData to a Map.
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (InterimBillObjectKeyData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (InterimBillObjectKeyData in, Map record, String rootName)
  {
  ...
  /** convert InterimBillObjectKeyFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (InterimBillObjectKeyFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert InterimBillObjectKeyFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (InterimBillObjectKeyFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "InterimBillObject";
  ...
  /** convert Map to InterimBillObjectKeyData.
   * @param record   the Map containing the data to convert to the object
   * @return InterimBillObjectKeyData the converted object
   */
  public static InterimBillObjectKeyData fromMap (Map record)
  {
   ...
   * @return InterimBillObjectKeyData the converted object
   */
  public static InterimBillObjectKeyData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to InterimBillObjectKeyFilter.
   * @param record   the Map containing the data to convert to the object
   * @return InterimBillObjectKeyFilter the converted object
   */
  public static InterimBillObjectKeyFilter fromMapFilter (Map record) {
   ...
   * @return InterimBillObjectKeyFilter the converted object
   */
  public static InterimBillObjectKeyFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "InterimBillObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert InterimBillObjectKeyData to a Map (not including the root).
  /** convert InterimBillObjectKeyData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  protected static Map getMap (InterimBillObjectKeyData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
  ...
  /** convert InterimBillObjectKeyFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  protected static Map getMap (InterimBillObjectKeyFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return InterimBillObjectKeyData the converted object
   */
  public static InterimBillObjectKeyData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    InterimBillObjectKeyData out = new InterimBillObjectKeyData ();
   ...
   * @return InterimBillObjectKeyFilter the converted object
   */
  public static InterimBillObjectKeyFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    InterimBillObjectKeyFilter out = new InterimBillObjectKeyFilter ();
