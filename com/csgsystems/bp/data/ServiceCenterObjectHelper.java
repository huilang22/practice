 ...
 * Generated  File: ServiceCenterObjectHelper.java
...
/** Helper class to convert ServiceCenterObject JavaBean objects to/from HashMaps.
 */
public class ServiceCenterObjectHelper implements ArubaObjectHelper
{
  /** convert ServiceCenterObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (ServiceCenterObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ServiceCenterObjectData in, Map record, String rootName)
  {
  ...
  /** convert ServiceCenterObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (ServiceCenterObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert ServiceCenterObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ServiceCenterObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "ServiceCenterObject";
  ...
  /** convert Map to ServiceCenterObjectData.
   * @param record the Map containing the data to convert to the object
   * @return ServiceCenterObjectData the converted object
   */
  public static ServiceCenterObjectData fromMap (Map record)
  {
   ...
   * @return ServiceCenterObjectData the converted object
   */
  public static ServiceCenterObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to ServiceCenterObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return ServiceCenterObjectFilter the converted object
   */
  public static ServiceCenterObjectFilter fromMapFilter (Map record) {
   ...
   * @return ServiceCenterObjectFilter the converted object
   */
  public static ServiceCenterObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "ServiceCenterObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to ServiceCenterObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return ServiceCenterObjectDataList the converted object
   */
  public static ServiceCenterObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to ServiceCenterObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "ServiceCenterObjectList")
   * @return ServiceCenterObjectDataList the converted object
   */
  public static ServiceCenterObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "ServiceCenterObjectList";
    Object[] root = (Object[]) record.get (rootName);
    ServiceCenterObjectData[] array = null;
    if (root != null)
    {
      array = new ServiceCenterObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = ServiceCenterObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new ServiceCenterObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new ServiceCenterObjectDataList (array, index, total);
  }
  /** convert ServiceCenterObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ServiceCenterObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", ServiceCenterObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert ServiceCenterObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ServiceCenterObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return ServiceCenterObjectData the converted object
   */
  public static ServiceCenterObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ServiceCenterObjectData out = new ServiceCenterObjectData ();

    out.Key = ServiceCenterObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return ServiceCenterObjectFilter the converted object
   */
  public static ServiceCenterObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ServiceCenterObjectFilter out = new ServiceCenterObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = ServiceCenterObjectKeyHelper.getFilter ((Map) record.get ("Key"));
