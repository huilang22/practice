 ...
 * Generated  File: ConnectReasonObjectHelper.java
...
/** Helper class to convert ConnectReasonObject JavaBean objects to/from HashMaps.
 */
public class ConnectReasonObjectHelper implements ArubaObjectHelper
{
  /** convert ConnectReasonObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (ConnectReasonObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ConnectReasonObjectData in, Map record, String rootName)
  {
  ...
  /** convert ConnectReasonObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (ConnectReasonObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert ConnectReasonObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (ConnectReasonObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "ConnectReasonObject";
  ...
  /** convert Map to ConnectReasonObjectData.
   * @param record the Map containing the data to convert to the object
   * @return ConnectReasonObjectData the converted object
   */
  public static ConnectReasonObjectData fromMap (Map record)
  {
   ...
   * @return ConnectReasonObjectData the converted object
   */
  public static ConnectReasonObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to ConnectReasonObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return ConnectReasonObjectFilter the converted object
   */
  public static ConnectReasonObjectFilter fromMapFilter (Map record) {
   ...
   * @return ConnectReasonObjectFilter the converted object
   */
  public static ConnectReasonObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "ConnectReasonObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to ConnectReasonObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return ConnectReasonObjectDataList the converted object
   */
  public static ConnectReasonObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to ConnectReasonObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "ConnectReasonObjectList")
   * @return ConnectReasonObjectDataList the converted object
   */
  public static ConnectReasonObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "ConnectReasonObjectList";
    Object[] root = (Object[]) record.get (rootName);
    ConnectReasonObjectData[] array = null;
    if (root != null)
    {
      array = new ConnectReasonObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = ConnectReasonObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new ConnectReasonObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new ConnectReasonObjectDataList (array, index, total);
  }
  /** convert ConnectReasonObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ConnectReasonObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", ConnectReasonObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert ConnectReasonObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (ConnectReasonObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return ConnectReasonObjectData the converted object
   */
  public static ConnectReasonObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ConnectReasonObjectData out = new ConnectReasonObjectData ();

    out.Key = ConnectReasonObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return ConnectReasonObjectFilter the converted object
   */
  public static ConnectReasonObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    ConnectReasonObjectFilter out = new ConnectReasonObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = ConnectReasonObjectKeyHelper.getFilter ((Map) record.get ("Key"));
