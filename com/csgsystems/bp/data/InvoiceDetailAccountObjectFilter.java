 ...
 * Generated  File: InvoiceDetailAccountObjectFilter.java
...
/** Filter object */
public class InvoiceDetailAccountObjectFilter extends InvoiceDetailObjectFilter  implements Serializable
{
  /** raw field for: CMF.currency_code) */
  public    IntegerFilter[] AccountCurrencyCode  = null;
  protected boolean AccountCurrencyCodeFetch = false;
  protected boolean AccountCurrencyCodeSortAscending = true;
  protected Integer AccountCurrencyCodeSort = null;
  ...
  private String _objName = "InvoiceDetailAccountObjectFilter";
  /** default constructor */
  public InvoiceDetailAccountObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public InvoiceDetailAccountObjectFilter (InvoiceDetailAccountObjectFilter other)
  {
    super (other);
    if (other == null) return;
    this.AccountCurrencyCode = other.AccountCurrencyCode;
    this.AccountCurrencyCodeFetch = other.AccountCurrencyCodeFetch;
    this.AccountCurrencyCodeSort = other.AccountCurrencyCodeSort;
    this.AccountCurrencyCodeSortAscending = other.AccountCurrencyCodeSortAscending;
  ...
  /** Set the field level Fetch value for field: AccountCurrencyCode (CMF.currency_code)
   * @param fetch whether to fetch this field or not
   */
  public void setAccountCurrencyCodeFetch (boolean fetch) {
    this.AccountCurrencyCodeFetch = fetch;
  }
  /** Retrieve Fetch value for field: AccountCurrencyCode (CMF.currency_code)
   * @return boolean the Fetch value for this field
   */
  public boolean getAccountCurrencyCodeFetch () {
    return this.AccountCurrencyCodeFetch;
  }
  /** Set the SortOrder for field: AccountCurrencyCode (CMF.currency_code)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setAccountCurrencyCodeSortOrder (Integer value) {
    this.AccountCurrencyCodeSort = value;
  }
  /** Retrieve SortOrder for field: AccountCurrencyCode (CMF.currency_code)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getAccountCurrencyCodeSortOrder () {
    return this.AccountCurrencyCodeSort;
  }
  /** Set the sort direction for field: AccountCurrencyCode (CMF.currency_code)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setAccountCurrencyCodeSortDirection (boolean ascending) {
    this.AccountCurrencyCodeSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: AccountCurrencyCode (CMF.currency_code)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getAccountCurrencyCodeSortDirection () {
    return this.AccountCurrencyCodeSortAscending;
  }
  /** Set the field level filters for field: AccountCurrencyCode (CMF.currency_code)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setAccountCurrencyCodeFilter (IntegerFilter[] value) throws ServiceException {
    this.AccountCurrencyCode = value;
  }
  /** Retrieve filter for field: AccountCurrencyCode (CMF.currency_code)
   * @return IntegerFilter[] array of field level filters
   */
  public IntegerFilter[] getAccountCurrencyCodeFilter () {
    return this.AccountCurrencyCode;
  }

  /**
   * Retrieves the AccountCurrencyCodeFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The AccountCurrencyCodeFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the AccountCurrencyCodeFilter field
   */
  public String[] getAccountCurrencyCodeFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getAccountCurrencyCodeFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getAccountCurrencyCodeFilter(), _locale, false, false);
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getAccountCurrencyCodeFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("AccountCurrencyCodeFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getAccountCurrencyCodeFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the AccountCurrencyCodeFilter filter value from a formatted string
   *
   * @param _value the AccountCurrencyCodeFilter filter value(s) in formatted form. If the requested
   ...
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the AccountCurrencyCodeFilter filter field
   */
  public void setAccountCurrencyCodeFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setAccountCurrencyCodeFilterFromFormattedString");
    try {
      this.setAccountCurrencyCodeFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("AccountCurrencyCodeFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setAccountCurrencyCodeFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setAccountCurrencyCodeFilterFromFormattedString");
  }

  /**
   * Retrieves the display value for the enumerated AccountCurrencyCodeFilter filter field
   *
   * @param _locale locale settings used to determine the language for text based display values
   * @return The display value for the AccountCurrencyCodeFilter filter field
   * @throws ServiceException thrown if an error occurs accessing the enumerated data for the AccountCurrencyCodeFilter filter field
   */
  public String[] getAccountCurrencyCodeFilterDisplayValue(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getAccountCurrencyCodeFilterDisplayValue");
    EnumerationFilter enumFilter = null;

    try {
      String[] displayValues = null;
      Object[] displayObjs = FilterConversionHelper.toDisplayValue(this.getAccountCurrencyCodeFilter(), "Currency", _locale, enumFilter, false);
      if (displayObjs != null) {
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getAccountCurrencyCodeFilterDisplayValue");
      return displayValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("AccountCurrencyCodeFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getAccountCurrencyCodeFilterDisplayValue");
      throw excp;
    }
  }

  /**
   * Sets a filter for the enumerated AccountCurrencyCodeFilter filter field based on a display value(s)
   *
   ...
   * @throws ServiceException thrown if invalid data is set in the AccountCurrencyCodeFilter filter field
   */
  public void setAccountCurrencyCodeFilterFromDisplayValue(Object[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setAccountCurrencyCodeFilterFromDisplayValue");
    EnumerationFilter enumFilter = null;

    try {
      this.setAccountCurrencyCodeFilter((IntegerFilter[])(FilterConversionHelper.toCodeFilter(_value, _filterType, "AccountCurrencyCode", _locale, enumFilter, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("AccountCurrencyCodeFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setAccountCurrencyCodeFilterFromDisplayValue");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setAccountCurrencyCodeFilterFromDisplayValue");
  }
  ...
  /** Set the field level Fetch value for field: NoBill (CMF.no_bill)
   * @param fetch whether to fetch this field or not
   */
  public void setNoBillFetch (boolean fetch) {
    this.NoBillFetch = fetch;
  }
  /** Retrieve Fetch value for field: NoBill (CMF.no_bill)
   * @return boolean the Fetch value for this field
   */
  public boolean getNoBillFetch () {
    return this.NoBillFetch;
  }
  /** Set the SortOrder for field: NoBill (CMF.no_bill)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve filter for field: NoBill (CMF.no_bill)
   ...
   */
  public InvoiceDetailAccountObjectFilter (InvoiceDetailObjectFilter other)
  {
    super (other);
  ...
  public Map toMap() {
    return InvoiceDetailAccountObjectHelper.toMap(this, null);
  }
}
