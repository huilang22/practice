 ...
 * Generated  File: SCObjectHelper.java
...
/** Helper class to convert SCObject JavaBean objects to/from HashMaps.
 */
public class SCObjectHelper implements ArubaObjectHelper
{
  /** convert SCObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (SCObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (SCObjectData in, Map record, String rootName)
  {
  ...
  /** convert SCObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (SCObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert SCObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (SCObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "SCObject";
  ...
  /** convert Map to SCObjectData.
   * @param record the Map containing the data to convert to the object
   * @return SCObjectData the converted object
   */
  public static SCObjectData fromMap (Map record)
  {
   ...
   * @return SCObjectData the converted object
   */
  public static SCObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to SCObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return SCObjectFilter the converted object
   */
  public static SCObjectFilter fromMapFilter (Map record) {
   ...
   * @return SCObjectFilter the converted object
   */
  public static SCObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "SCObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to SCObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return SCObjectDataList the converted object
   */
  public static SCObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to SCObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "SCObjectList")
   * @return SCObjectDataList the converted object
   */
  public static SCObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "SCObjectList";
    Object[] root = (Object[]) record.get (rootName);
    SCObjectData[] array = null;
    if (root != null)
    {
      array = new SCObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = SCObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new SCObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new SCObjectDataList (array, index, total);
  }
  /** convert SCObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (SCObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", SCObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert SCObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (SCObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return SCObjectData the converted object
   */
  public static SCObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    SCObjectData out = new SCObjectData ();

    out.Key = SCObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return SCObjectFilter the converted object
   */
  public static SCObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    SCObjectFilter out = new SCObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = SCObjectKeyHelper.getFilter ((Map) record.get ("Key"));
