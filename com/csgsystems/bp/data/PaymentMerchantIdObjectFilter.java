 ...
 * Generated  File: PaymentMerchantIdObjectFilter.java
...
/** Filter object */
public class PaymentMerchantIdObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public PaymentMerchantIdObjectKeyFilter Key = null;
  ...
  /** raw field for: PAYMENT_MERCHANT_ID_VALUES.short_display) */
  ...
  /** raw field for: PAYMENT_MERCHANT_ID_VALUES.display_value) */
  ...
  private String _objName = "PaymentMerchantIdObjectFilter";
  /** default constructor */
  public PaymentMerchantIdObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public PaymentMerchantIdObjectFilter (PaymentMerchantIdObjectFilter other)
  {
    if (other == null) return;
    this.Key = new PaymentMerchantIdObjectKeyFilter (other.Key);
   ...
   * @return PaymentMerchantIdObjectKeyFilter
   */
  public PaymentMerchantIdObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (PaymentMerchantIdObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new PaymentMerchantIdObjectKeyFilter ();
  ...
  /** Set the field level Fetch value for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @param fetch whether to fetch this field or not
   */
  public void setShortDisplayFetch (boolean fetch) {
    this.ShortDisplayFetch = fetch;
  }
  /** Retrieve Fetch value for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @return boolean the Fetch value for this field
   */
  public boolean getShortDisplayFetch () {
    return this.ShortDisplayFetch;
  }
  /** Set the SortOrder for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getShortDisplaySortOrder () {
    return this.ShortDisplaySort;
  }
  /** Set the sort direction for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setShortDisplaySortDirection (boolean ascending) {
    this.ShortDisplaySortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getShortDisplaySortDirection () {
    return this.ShortDisplaySortAscending;
  }
  /** Set the case insensitive for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setShortDisplayCaseInsensitive (boolean ascending) {
    this.ShortDisplayCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getShortDisplayCaseInsensitive () {
    return this.ShortDisplayCaseInsensitive;
  }
  /** Set the field level filters for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ShortDisplay (PAYMENT_MERCHANT_ID_VALUES.short_display)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @param fetch whether to fetch this field or not
   */
  public void setDisplayValueFetch (boolean fetch) {
    this.DisplayValueFetch = fetch;
  }
  /** Retrieve Fetch value for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @return boolean the Fetch value for this field
   */
  public boolean getDisplayValueFetch () {
    return this.DisplayValueFetch;
  }
  /** Set the SortOrder for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getDisplayValueSortOrder () {
    return this.DisplayValueSort;
  }
  /** Set the sort direction for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setDisplayValueSortDirection (boolean ascending) {
    this.DisplayValueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getDisplayValueSortDirection () {
    return this.DisplayValueSortAscending;
  }
  /** Set the case insensitive for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setDisplayValueCaseInsensitive (boolean ascending) {
    this.DisplayValueCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getDisplayValueCaseInsensitive () {
    return this.DisplayValueCaseInsensitive;
  }
  /** Set the field level filters for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: DisplayValue (PAYMENT_MERCHANT_ID_VALUES.display_value)
   * @return StringFilter[] array of field level filters
   */
  ...
  public Map toMap() {
    return PaymentMerchantIdObjectHelper.toMap(this, null);
  }
}
