 ...
 * Generated  File: ServiceCenterObjectFilter.java
...
/** Filter object */
public class ServiceCenterObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public ServiceCenterObjectKeyFilter Key = null;
  ...
  /** raw field for: SERVICE_CENTERS.config_tag_id) */
  ...
  private String _objName = "ServiceCenterObjectFilter";
  /** default constructor */
  public ServiceCenterObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public ServiceCenterObjectFilter (ServiceCenterObjectFilter other)
  {
    if (other == null) return;
    this.Key = new ServiceCenterObjectKeyFilter (other.Key);
   ...
   * @return ServiceCenterObjectKeyFilter
   */
  public ServiceCenterObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (ServiceCenterObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new ServiceCenterObjectKeyFilter ();
  ...
  /** Set the field level Fetch value for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @param fetch whether to fetch this field or not
   */
  public void setConfigTagIdFetch (boolean fetch) {
    this.ConfigTagIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getConfigTagIdFetch () {
    return this.ConfigTagIdFetch;
  }
  /** Set the SortOrder for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getConfigTagIdSortOrder () {
    return this.ConfigTagIdSort;
  }
  /** Set the sort direction for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setConfigTagIdSortDirection (boolean ascending) {
    this.ConfigTagIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getConfigTagIdSortDirection () {
    return this.ConfigTagIdSortAscending;
  }
  /** Set the case insensitive for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setConfigTagIdCaseInsensitive (boolean ascending) {
    this.ConfigTagIdCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getConfigTagIdCaseInsensitive () {
    return this.ConfigTagIdCaseInsensitive;
  }
  /** Set the field level filters for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @return StringFilter[] array of field level filters
   */
  ...
  public String toString() {
    return ServiceCenterObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return ServiceCenterObjectHelper.toMap(this, null);
  }
}
