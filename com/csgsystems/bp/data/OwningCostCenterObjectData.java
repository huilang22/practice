 ...
 * Generated  File: OwningCostCenterObjectData.java
...
/** OwningCostCenterObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class OwningCostCenterObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public OwningCostCenterObjectKeyData Key = null;
  /** OWNING_COST_CTR_REF.g_l_code field */
  public    String GLCode  = null;
  protected boolean _GLCodeSet = false;
  /** OWNING_COST_CTR_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** OWNING_COST_CTR_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** OWNING_COST_CTR_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** OWNING_COST_CTR_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** OWNING_COST_CTR_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "OwningCostCenterObjectData";
  /** Default constructor */
  public OwningCostCenterObjectData ()
  {
    super ();
   ...
   */
  public OwningCostCenterObjectData (OwningCostCenterObjectData other)
  {

    if (other == null) return;
    this.Key = new OwningCostCenterObjectKeyData (other.Key);
   ...
   * @return OwningCostCenterObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public OwningCostCenterObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (OwningCostCenterObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setValue (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new OwningCostCenterObjectKeyData ();
  ...
  /** set the fields value: GLCode (OWNING_COST_CTR_REF.g_l_code)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("GLCode") 
  ...
  /** get the value of the field: GLCode (OWNING_COST_CTR_REF.g_l_code)
   * @return String the value
   */
  public String getGLCode () {
    return this.GLCode;
  }
  /** Change the field to not being actively set: GLCode (OWNING_COST_CTR_REF.g_l_code)
   */
  public void unsetGLCode () {
    this._GLCodeSet = false;
  }
  /** See if the field is actively set: GLCode (OWNING_COST_CTR_REF.g_l_code)
   * @return boolean whether the field is actively set
   */
  public boolean issetGLCode () {
    return this._GLCodeSet;
  }
  /** set the fields value: IsDefault (OWNING_COST_CTR_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (OWNING_COST_CTR_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (OWNING_COST_CTR_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (OWNING_COST_CTR_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (OWNING_COST_CTR_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (OWNING_COST_CTR_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (OWNING_COST_CTR_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (OWNING_COST_CTR_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: ConfigTagId (OWNING_COST_CTR_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (OWNING_COST_CTR_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (OWNING_COST_CTR_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (OWNING_COST_CTR_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (OWNING_COST_CTR_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (OWNING_COST_CTR_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (OWNING_COST_CTR_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (OWNING_COST_CTR_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (OWNING_COST_CTR_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (OWNING_COST_CTR_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (OWNING_COST_CTR_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (OWNING_COST_CTR_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
