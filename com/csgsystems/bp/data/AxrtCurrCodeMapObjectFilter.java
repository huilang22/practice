 ...
 * Generated  File: AxrtCurrCodeMapObjectFilter.java
...
/** Filter object */
public class AxrtCurrCodeMapObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public AxrtCurrCodeMapObjectKeyFilter Key = null;
  ...
  private String _objName = "AxrtCurrCodeMapObjectFilter";
  /** default constructor */
  public AxrtCurrCodeMapObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AxrtCurrCodeMapObjectFilter (AxrtCurrCodeMapObjectFilter other)
  {
    if (other == null) return;
    this.Key = new AxrtCurrCodeMapObjectKeyFilter (other.Key);
   ...
   * @return AxrtCurrCodeMapObjectKeyFilter
   */
  public AxrtCurrCodeMapObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (AxrtCurrCodeMapObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new AxrtCurrCodeMapObjectKeyFilter ();
  ...
  public String toString() {
    return AxrtCurrCodeMapObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return AxrtCurrCodeMapObjectHelper.toMap(this, null);
  }
}
