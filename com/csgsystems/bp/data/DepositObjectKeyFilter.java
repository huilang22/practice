 ...
 * Generated  File: DepositObjectKeyFilter.java
...
/** Key Filter for DepositObject object. */
public class DepositObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: DEPOSIT.tracking_id) */
  ...
  /** raw field for: DEPOSIT.tracking_id_serv) */
  ...
  private String _objName = "DepositObjectKeyFilter";
  /** default constructor */
  public DepositObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public DepositObjectKeyFilter (DepositObjectKeyFilter other)
  {
  ...
  public String toString() {
    return DepositObjectKeyHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return DepositObjectKeyHelper.toMap(this, null);
  }
}
