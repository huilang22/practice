 ...
 * Generated  File: BilledUsageObjectHelper.java
...
/** Helper class to convert BilledUsageObject JavaBean objects to/from HashMaps.
 */
public class BilledUsageObjectHelper implements ArubaObjectHelper
{
  /** convert BilledUsageObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (BilledUsageObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageObjectData in, Map record, String rootName)
  {
  ...
  /** convert BilledUsageObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BilledUsageObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BilledUsageObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BilledUsageObject";
  ...
  /** convert Map to BilledUsageObjectData.
   * @param record the Map containing the data to convert to the object
   * @return BilledUsageObjectData the converted object
   */
  public static BilledUsageObjectData fromMap (Map record)
  {
   ...
   * @return BilledUsageObjectData the converted object
   */
  public static BilledUsageObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BilledUsageObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return BilledUsageObjectFilter the converted object
   */
  public static BilledUsageObjectFilter fromMapFilter (Map record) {
   ...
   * @return BilledUsageObjectFilter the converted object
   */
  public static BilledUsageObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BilledUsageObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to BilledUsageObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return BilledUsageObjectDataList the converted object
   */
  public static BilledUsageObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to BilledUsageObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "BilledUsageObjectList")
   * @return BilledUsageObjectDataList the converted object
   */
  public static BilledUsageObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "BilledUsageObjectList";
    Object[] root = (Object[]) record.get (rootName);
    BilledUsageObjectData[] array = null;
    if (root != null)
    {
      array = new BilledUsageObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = BilledUsageObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new BilledUsageObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new BilledUsageObjectDataList (array, index, total);
  }
  /** convert BilledUsageObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BilledUsageObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", BilledUsageObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
    ...
    if (in._ThresholdProrationFactorSet) record.put ("ThresholdProrationFactor", in.ThresholdProrationFactor);
  
    if (in._RefundProrationFactorSet) record.put ("RefundProrationFactor", in.RefundProrationFactor);
    ...
    if (in._RatedAmountReductionSet) record.put ("RatedAmountReduction", in.RatedAmountReduction);
  ...
  /** convert BilledUsageObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BilledUsageObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
    ...
    if (in.Key != null) record.put ("Key", BilledUsageObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
      ...
      map = DataHelper.filterToMap (in.ThresholdProrationFactor, in.ThresholdProrationFactorSort, in.ThresholdProrationFactorSortAscending, in.ThresholdProrationFactorFetch);
      if (map != null) record.put ("ThresholdProrationFactor", map);
      map = DataHelper.filterToMap (in.RefundProrationFactor, in.RefundProrationFactorSort, in.RefundProrationFactorSortAscending, in.RefundProrationFactorFetch);
      if (map != null) record.put ("RefundProrationFactor", map);
      ...
      map = DataHelper.filterToMap (in.RatedAmountReduction, in.RatedAmountReductionSort, in.RatedAmountReductionSortAscending, in.RatedAmountReductionFetch);
      if (map != null) record.put ("RatedAmountReduction", map);
   ...
   * @return BilledUsageObjectData the converted object
   */
  public static BilledUsageObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BilledUsageObjectData out = new BilledUsageObjectData ();

    out.Key = BilledUsageObjectKeyHelper.getObj ((Map) record.get ("Key"));
    ...
    if ((obj = record.get ("ThresholdProrationFactor")) != null)
    {
      out.ThresholdProrationFactor = (Integer) obj;
    }
  
    if ((obj = record.get ("RefundProrationFactor")) != null)
    {
      out.RefundProrationFactor = (Integer) obj;
    }
    ...
    if ((obj = record.get ("RatedAmountReduction")) != null)
    {
      out.RatedAmountReduction = (BigInteger) obj;
    }
   ...
   * @return BilledUsageObjectFilter the converted object
   */
  public static BilledUsageObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BilledUsageObjectFilter out = new BilledUsageObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = BilledUsageObjectKeyHelper.getFilter ((Map) record.get ("Key"));
    ...
    Map UnitsCreditedMap = (Map)record.get("UnitsCredited");
    Boolean UnitsCreditedFetch = DataHelper.getFetch(UnitsCreditedMap);
    Boolean UnitsCreditedSortDir = DataHelper.getSortDirection(UnitsCreditedMap);
    Integer UnitsCreditedSortOrder = DataHelper.getSortOrder(UnitsCreditedMap);
    if (UnitsCreditedFetch != null) out.setUnitsCreditedFetch(UnitsCreditedFetch);
    if (UnitsCreditedSortDir != null) out.setUnitsCreditedSortDirection(UnitsCreditedSortDir);
    if (UnitsCreditedSortOrder != null) out.setUnitsCreditedSortOrder(UnitsCreditedSortOrder);

    Filter[] UnitsCreditedFilter = DataHelper.mapToFilterArray(UnitsCreditedMap, BigInteger.class);
    if (UnitsCreditedFilter != null) {
      BigIntegerFilter[] UnitsCreditedFilters = new BigIntegerFilter[UnitsCreditedFilter.length];
      for (int i = 0; i < UnitsCreditedFilters.length; i++) {
        UnitsCreditedFilters[i] = (BigIntegerFilter)UnitsCreditedFilter[i];
      }
      try {
        out.setUnitsCreditedFilter(UnitsCreditedFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
  
    Map AmountCreditedMap = (Map)record.get("AmountCredited");
    Boolean AmountCreditedFetch = DataHelper.getFetch(AmountCreditedMap);
    Boolean AmountCreditedSortDir = DataHelper.getSortDirection(AmountCreditedMap);
    Integer AmountCreditedSortOrder = DataHelper.getSortOrder(AmountCreditedMap);
    if (AmountCreditedFetch != null) out.setAmountCreditedFetch(AmountCreditedFetch);
    if (AmountCreditedSortDir != null) out.setAmountCreditedSortDirection(AmountCreditedSortDir);
    if (AmountCreditedSortOrder != null) out.setAmountCreditedSortOrder(AmountCreditedSortOrder);

    Filter[] AmountCreditedFilter = DataHelper.mapToFilterArray(AmountCreditedMap, BigInteger.class);
    if (AmountCreditedFilter != null) {
      BigIntegerFilter[] AmountCreditedFilters = new BigIntegerFilter[AmountCreditedFilter.length];
      for (int i = 0; i < AmountCreditedFilters.length; i++) {
        AmountCreditedFilters[i] = (BigIntegerFilter)AmountCreditedFilter[i];
      }
      try {
        out.setAmountCreditedFilter(AmountCreditedFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
    ...
    Map ThresholdProrationFactorMap = (Map)record.get("ThresholdProrationFactor");
    Boolean ThresholdProrationFactorFetch = DataHelper.getFetch(ThresholdProrationFactorMap);
    Boolean ThresholdProrationFactorSortDir = DataHelper.getSortDirection(ThresholdProrationFactorMap);
    Integer ThresholdProrationFactorSortOrder = DataHelper.getSortOrder(ThresholdProrationFactorMap);
    if (ThresholdProrationFactorFetch != null) out.setThresholdProrationFactorFetch(ThresholdProrationFactorFetch);
    if (ThresholdProrationFactorSortDir != null) out.setThresholdProrationFactorSortDirection(ThresholdProrationFactorSortDir);
    if (ThresholdProrationFactorSortOrder != null) out.setThresholdProrationFactorSortOrder(ThresholdProrationFactorSortOrder);

    Filter[] ThresholdProrationFactorFilter = DataHelper.mapToFilterArray(ThresholdProrationFactorMap, Integer.class);
    if (ThresholdProrationFactorFilter != null) {
      IntegerFilter[] ThresholdProrationFactorFilters = new IntegerFilter[ThresholdProrationFactorFilter.length];
      for (int i = 0; i < ThresholdProrationFactorFilters.length; i++) {
        ThresholdProrationFactorFilters[i] = (IntegerFilter)ThresholdProrationFactorFilter[i];
      }
      try {
        out.setThresholdProrationFactorFilter(ThresholdProrationFactorFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
  
    Map RefundProrationFactorMap = (Map)record.get("RefundProrationFactor");
    Boolean RefundProrationFactorFetch = DataHelper.getFetch(RefundProrationFactorMap);
    Boolean RefundProrationFactorSortDir = DataHelper.getSortDirection(RefundProrationFactorMap);
    Integer RefundProrationFactorSortOrder = DataHelper.getSortOrder(RefundProrationFactorMap);
    if (RefundProrationFactorFetch != null) out.setRefundProrationFactorFetch(RefundProrationFactorFetch);
    if (RefundProrationFactorSortDir != null) out.setRefundProrationFactorSortDirection(RefundProrationFactorSortDir);
    if (RefundProrationFactorSortOrder != null) out.setRefundProrationFactorSortOrder(RefundProrationFactorSortOrder);

    Filter[] RefundProrationFactorFilter = DataHelper.mapToFilterArray(RefundProrationFactorMap, Integer.class);
    if (RefundProrationFactorFilter != null) {
      IntegerFilter[] RefundProrationFactorFilters = new IntegerFilter[RefundProrationFactorFilter.length];
      for (int i = 0; i < RefundProrationFactorFilters.length; i++) {
        RefundProrationFactorFilters[i] = (IntegerFilter)RefundProrationFactorFilter[i];
      }
      try {
        out.setRefundProrationFactorFilter(RefundProrationFactorFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
    ...
    Map AccountNoMap = (Map)record.get("AccountNo");
    Boolean AccountNoFetch = DataHelper.getFetch(AccountNoMap);
    Boolean AccountNoSortDir = DataHelper.getSortDirection(AccountNoMap);
    Integer AccountNoSortOrder = DataHelper.getSortOrder(AccountNoMap);
    if (AccountNoFetch != null) out.setAccountNoFetch(AccountNoFetch);
    if (AccountNoSortDir != null) out.setAccountNoSortDirection(AccountNoSortDir);
    if (AccountNoSortOrder != null) out.setAccountNoSortOrder(AccountNoSortOrder);

    Filter[] AccountNoFilter = DataHelper.mapToFilterArray(AccountNoMap, Integer.class);
    if (AccountNoFilter != null) {
      IntegerFilter[] AccountNoFilters = new IntegerFilter[AccountNoFilter.length];
      for (int i = 0; i < AccountNoFilters.length; i++) {
        AccountNoFilters[i] = (IntegerFilter)AccountNoFilter[i];
      }
      try {
        out.setAccountNoFilter(AccountNoFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
    ...
    Map RatedAmountReductionMap = (Map)record.get("RatedAmountReduction");
    Boolean RatedAmountReductionFetch = DataHelper.getFetch(RatedAmountReductionMap);
    Boolean RatedAmountReductionSortDir = DataHelper.getSortDirection(RatedAmountReductionMap);
    Integer RatedAmountReductionSortOrder = DataHelper.getSortOrder(RatedAmountReductionMap);
    if (RatedAmountReductionFetch != null) out.setRatedAmountReductionFetch(RatedAmountReductionFetch);
    if (RatedAmountReductionSortDir != null) out.setRatedAmountReductionSortDirection(RatedAmountReductionSortDir);
    if (RatedAmountReductionSortOrder != null) out.setRatedAmountReductionSortOrder(RatedAmountReductionSortOrder);

    Filter[] RatedAmountReductionFilter = DataHelper.mapToFilterArray(RatedAmountReductionMap, BigInteger.class);
    if (RatedAmountReductionFilter != null) {
      BigIntegerFilter[] RatedAmountReductionFilters = new BigIntegerFilter[RatedAmountReductionFilter.length];
      for (int i = 0; i < RatedAmountReductionFilters.length; i++) {
        RatedAmountReductionFilters[i] = (BigIntegerFilter)RatedAmountReductionFilter[i];
      }
      try {
        out.setRatedAmountReductionFilter(RatedAmountReductionFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
