 ...
 * Generated  File: CmfBonusPointObjectHelper.java
...
/** Helper class to convert CmfBonusPointObject JavaBean objects to/from HashMaps.
 */
public class CmfBonusPointObjectHelper implements ArubaObjectHelper
{
  /** convert CmfBonusPointObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (CmfBonusPointObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (CmfBonusPointObjectData in, Map record, String rootName)
  {
  ...
  /** convert CmfBonusPointObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (CmfBonusPointObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert CmfBonusPointObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (CmfBonusPointObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "CmfBonusPointObject";
  ...
  /** convert Map to CmfBonusPointObjectData.
   * @param record the Map containing the data to convert to the object
   * @return CmfBonusPointObjectData the converted object
   */
  public static CmfBonusPointObjectData fromMap (Map record)
  {
   ...
   * @return CmfBonusPointObjectData the converted object
   */
  public static CmfBonusPointObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to CmfBonusPointObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return CmfBonusPointObjectFilter the converted object
   */
  public static CmfBonusPointObjectFilter fromMapFilter (Map record) {
   ...
   * @return CmfBonusPointObjectFilter the converted object
   */
  public static CmfBonusPointObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "CmfBonusPointObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to CmfBonusPointObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return CmfBonusPointObjectDataList the converted object
   */
  public static CmfBonusPointObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to CmfBonusPointObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "CmfBonusPointObjectList")
   * @return CmfBonusPointObjectDataList the converted object
   */
  public static CmfBonusPointObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "CmfBonusPointObjectList";
    Object[] root = (Object[]) record.get (rootName);
    CmfBonusPointObjectData[] array = null;
    if (root != null)
    {
      array = new CmfBonusPointObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = CmfBonusPointObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new CmfBonusPointObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new CmfBonusPointObjectDataList (array, index, total);
  }
  /** convert CmfBonusPointObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (CmfBonusPointObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", CmfBonusPointObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert CmfBonusPointObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (CmfBonusPointObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return CmfBonusPointObjectData the converted object
   */
  public static CmfBonusPointObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    CmfBonusPointObjectData out = new CmfBonusPointObjectData ();

    out.Key = CmfBonusPointObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return CmfBonusPointObjectFilter the converted object
   */
  public static CmfBonusPointObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    CmfBonusPointObjectFilter out = new CmfBonusPointObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = CmfBonusPointObjectKeyHelper.getFilter ((Map) record.get ("Key"));
