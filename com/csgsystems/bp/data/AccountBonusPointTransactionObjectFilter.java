 ...
 * Generated  File: AccountBonusPointTransactionObjectFilter.java
...
/** Filter object */
public class AccountBonusPointTransactionObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public AccountBonusPointTransactionObjectKeyFilter Key = null;
  ...
  private String _objName = "AccountBonusPointTransactionObjectFilter";
  /** default constructor */
  public AccountBonusPointTransactionObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AccountBonusPointTransactionObjectFilter (AccountBonusPointTransactionObjectFilter other)
  {
    if (other == null) return;
    this.Key = new AccountBonusPointTransactionObjectKeyFilter (other.Key);
   ...
   * @return AccountBonusPointTransactionObjectKeyFilter
   */
  public AccountBonusPointTransactionObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (AccountBonusPointTransactionObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new AccountBonusPointTransactionObjectKeyFilter ();
  ...
  public Map toMap() {
    return AccountBonusPointTransactionObjectHelper.toMap(this, null);
  }
}
