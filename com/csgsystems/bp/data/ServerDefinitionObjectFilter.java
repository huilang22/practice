 ...
 * Generated  File: ServerDefinitionObjectFilter.java
...
/** Filter object */
public class ServerDefinitionObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public ServerDefinitionObjectKeyFilter Key = null;
  ...
  private String _objName = "ServerDefinitionObjectFilter";
  /** default constructor */
  public ServerDefinitionObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public ServerDefinitionObjectFilter (ServerDefinitionObjectFilter other)
  {
    if (other == null) return;
    this.Key = new ServerDefinitionObjectKeyFilter (other.Key);
   ...
   * @return ServerDefinitionObjectKeyFilter
   */
  public ServerDefinitionObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (ServerDefinitionObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new ServerDefinitionObjectKeyFilter ();
  ...
  public String toString() {
    return ServerDefinitionObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return ServerDefinitionObjectHelper.toMap(this, null);
  }
}
