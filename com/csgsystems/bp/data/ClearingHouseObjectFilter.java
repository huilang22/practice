 ...
 * Generated  File: ClearingHouseObjectFilter.java
...
/** Filter object */
public class ClearingHouseObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public ClearingHouseObjectKeyFilter Key = null;
  ...
  private String _objName = "ClearingHouseObjectFilter";
  /** default constructor */
  public ClearingHouseObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public ClearingHouseObjectFilter (ClearingHouseObjectFilter other)
  {
    if (other == null) return;
    this.Key = new ClearingHouseObjectKeyFilter (other.Key);
   ...
   * @return ClearingHouseObjectKeyFilter
   */
  public ClearingHouseObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (ClearingHouseObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new ClearingHouseObjectKeyFilter ();
  ...
  public String toString() {
    return ClearingHouseObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return ClearingHouseObjectHelper.toMap(this, null);
  }
}
