 ...
 * Generated  File: PaymentProfileObjectFilter.java
...
/** Filter object */
public class PaymentProfileObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public PaymentProfileObjectKeyFilter Key = null;
  ...
  private String _objName = "PaymentProfileObjectFilter";
  /** default constructor */
  public PaymentProfileObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public PaymentProfileObjectFilter (PaymentProfileObjectFilter other)
  {
    if (other == null) return;
    this.Key = new PaymentProfileObjectKeyFilter (other.Key);
   ...
   * @return PaymentProfileObjectKeyFilter
   */
  public PaymentProfileObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (PaymentProfileObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new PaymentProfileObjectKeyFilter ();
  ...
  public Map toMap() {
    return PaymentProfileObjectHelper.toMap(this, null);
  }
}
