 ...
 * Generated  File: AxrtPaymentTransObjectKeyFilter.java
...
/** Key Filter for AxrtPaymentTransObject object. */
public class AxrtPaymentTransObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: PAYMENT_TRANS.tracking_id) */
  ...
  /** raw field for: PAYMENT_TRANS.tracking_id_serv) */
  ...
  private String _objName = "AxrtPaymentTransObjectKeyFilter";
  /** default constructor */
  public AxrtPaymentTransObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public AxrtPaymentTransObjectKeyFilter (AxrtPaymentTransObjectKeyFilter other)
  {
  ...
  public String toString() {
    return AxrtPaymentTransObjectKeyHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return AxrtPaymentTransObjectKeyHelper.toMap(this, null);
  }
}
