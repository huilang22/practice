 ...
 * Generated  File: FranchiseCodeObjectFilter.java
...
/** Filter object */
public class FranchiseCodeObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public FranchiseCodeObjectKeyFilter Key = null;
  /** raw field for: FRANCHISE_CODE_REF.is_default) */
  ...
  /** raw field for: FRANCHISE_CODE_REF.is_internal) */
  ...
  /** raw field for: FRANCHISE_CODE_REF.tax_exception) */
  public    IntegerFilter[] TaxException  = null;
  protected boolean TaxExceptionFetch = false;
  protected boolean TaxExceptionSortAscending = true;
  protected Integer TaxExceptionSort = null;
  /** raw field for: FRANCHISE_CODE_REF.config_tag_id) */
  ...
  /** raw field for: FRANCHISE_CODE_VALUES.short_display) */
  ...
  /** raw field for: FRANCHISE_CODE_VALUES.display_value) */
  ...
  private String _objName = "FranchiseCodeObjectFilter";
  /** default constructor */
  public FranchiseCodeObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public FranchiseCodeObjectFilter (FranchiseCodeObjectFilter other)
  {
    if (other == null) return;
    this.Key = new FranchiseCodeObjectKeyFilter (other.Key);
    ...
    this.TaxExceptionFetch = other.TaxExceptionFetch;
    this.TaxExceptionSort = other.TaxExceptionSort;
    this.TaxExceptionSortAscending = other.TaxExceptionSortAscending;
   ...
   * @return FranchiseCodeObjectKeyFilter
   */
  public FranchiseCodeObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (FranchiseCodeObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  /** Set the field level Fetch value for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
   * @param fetch whether to fetch this field or not
   */
  public void setValueFetch (boolean fetch)
  {
    if (this.Key == null) this.Key = new FranchiseCodeObjectKeyFilter ();
    this.Key.ValueFetch = fetch;
  }
  /** Retrieve Fetch value for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
  ...
  /** Set the SortOrder for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
  ...
  /** Retrieve SortOrder for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
  ...
  /** Set the sort direction for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
  ...
  /** Retrieve SortDirection for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
  ...
  /** Set the field level filters for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
  ...
  /** Retrieve filter for field: Value (FRANCHISE_CODE_VALUES.franchise_code)
  ...
  /** Set the field level Fetch value for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * @param fetch whether to fetch this field or not
   */
  ...
  /** Retrieve Fetch value for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * @return boolean the Fetch value for this field
   */
  ...
  /** Set the SortOrder for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * @return Integer the sort order, if set, for the field
   */
  ...
  /** Set the sort direction for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  ...
  /** Retrieve SortDirection for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * @return boolean whether the SortDirection is Ascending
   */
  ...
  /** Set the field level filters for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: LanguageCode (FRANCHISE_CODE_VALUES.language_code)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: IsDefault (FRANCHISE_CODE_REF.is_default)
   * @param fetch whether to fetch this field or not
   */
  public void setIsDefaultFetch (boolean fetch) {
    this.IsDefaultFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsDefault (FRANCHISE_CODE_REF.is_default)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsDefaultFetch () {
    return this.IsDefaultFetch;
  }
  /** Set the SortOrder for field: IsDefault (FRANCHISE_CODE_REF.is_default)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsDefault (FRANCHISE_CODE_REF.is_default)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsDefaultSortOrder () {
    return this.IsDefaultSort;
  }
  /** Set the sort direction for field: IsDefault (FRANCHISE_CODE_REF.is_default)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsDefaultSortDirection (boolean ascending) {
    this.IsDefaultSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsDefault (FRANCHISE_CODE_REF.is_default)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsDefaultSortDirection () {
    return this.IsDefaultSortAscending;
  }
  /** Set the field level filters for field: IsDefault (FRANCHISE_CODE_REF.is_default)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsDefault (FRANCHISE_CODE_REF.is_default)
  ...
  /** Set the field level Fetch value for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * @param fetch whether to fetch this field or not
   */
  public void setIsInternalFetch (boolean fetch) {
    this.IsInternalFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsInternalFetch () {
    return this.IsInternalFetch;
  }
  /** Set the SortOrder for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsInternalSortOrder () {
    return this.IsInternalSort;
  }
  /** Set the sort direction for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsInternalSortDirection (boolean ascending) {
    this.IsInternalSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsInternalSortDirection () {
    return this.IsInternalSortAscending;
  }
  /** Set the field level filters for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsInternal (FRANCHISE_CODE_REF.is_internal)
   * @return BooleanFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * @param fetch whether to fetch this field or not
   */
  public void setTaxExceptionFetch (boolean fetch) {
    this.TaxExceptionFetch = fetch;
  }
  /** Retrieve Fetch value for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * @return boolean the Fetch value for this field
   */
  public boolean getTaxExceptionFetch () {
    return this.TaxExceptionFetch;
  }
  /** Set the SortOrder for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setTaxExceptionSortOrder (Integer value) {
    this.TaxExceptionSort = value;
  }
  /** Retrieve SortOrder for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getTaxExceptionSortOrder () {
    return this.TaxExceptionSort;
  }
  /** Set the sort direction for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setTaxExceptionSortDirection (boolean ascending) {
    this.TaxExceptionSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getTaxExceptionSortDirection () {
    return this.TaxExceptionSortAscending;
  }
  /** Set the field level filters for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setTaxExceptionFilter (IntegerFilter[] value) throws ServiceException {
    this.TaxException = value;
  }
  /** Retrieve filter for field: TaxException (FRANCHISE_CODE_REF.tax_exception)
   * @return IntegerFilter[] array of field level filters
   */
  public IntegerFilter[] getTaxExceptionFilter () {
    return this.TaxException;
  }

  /**
   * Retrieves the TaxExceptionFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The TaxExceptionFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the TaxExceptionFilter field
   */
  public String[] getTaxExceptionFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getTaxExceptionFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getTaxExceptionFilter(), _locale, false, false);
      if (formattedObjs != null) {
        formattedValues = new String[formattedObjs.length];
        for (int i=0; i<formattedObjs.length; i++) {
          formattedValues[i] = formattedObjs[i].toString();
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getTaxExceptionFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("TaxExceptionFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getTaxExceptionFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the TaxExceptionFilter filter value from a formatted string
   *
   * @param _value the TaxExceptionFilter filter value(s) in formatted form. If the requested
   *          output filter type is a type that contains a single data item, then a single
   *          String display value object must be specified. If the requested output filter type
   *          is a type that contains more than one data item (e.g. a Between Filter), then a
   *          Collection of String display value objects must be provided.
   * @param _filterType output filter type (see {@link FilterConversionHelper} fields for a list of valid values)
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the TaxExceptionFilter filter field
   */
  public void setTaxExceptionFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setTaxExceptionFilterFromFormattedString");
    try {
      this.setTaxExceptionFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("TaxExceptionFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setTaxExceptionFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setTaxExceptionFilterFromFormattedString");
  }

  /** Set the field level Fetch value for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * @param fetch whether to fetch this field or not
   */
  public void setConfigTagIdFetch (boolean fetch) {
    this.ConfigTagIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getConfigTagIdFetch () {
    return this.ConfigTagIdFetch;
  }
  /** Set the SortOrder for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getConfigTagIdSortOrder () {
    return this.ConfigTagIdSort;
  }
  /** Set the sort direction for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setConfigTagIdSortDirection (boolean ascending) {
    this.ConfigTagIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getConfigTagIdSortDirection () {
    return this.ConfigTagIdSortAscending;
  }
  /** Set the case insensitive for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setConfigTagIdCaseInsensitive (boolean ascending) {
    this.ConfigTagIdCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getConfigTagIdCaseInsensitive () {
    return this.ConfigTagIdCaseInsensitive;
  }
  /** Set the field level filters for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ConfigTagId (FRANCHISE_CODE_REF.config_tag_id)
  ...
  /** Set the field level Fetch value for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @param fetch whether to fetch this field or not
   */
  public void setShortDisplayFetch (boolean fetch) {
    this.ShortDisplayFetch = fetch;
  }
  /** Retrieve Fetch value for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @return boolean the Fetch value for this field
   */
  public boolean getShortDisplayFetch () {
    return this.ShortDisplayFetch;
  }
  /** Set the SortOrder for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getShortDisplaySortOrder () {
    return this.ShortDisplaySort;
  }
  /** Set the sort direction for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setShortDisplaySortDirection (boolean ascending) {
    this.ShortDisplaySortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getShortDisplaySortDirection () {
    return this.ShortDisplaySortAscending;
  }
  /** Set the case insensitive for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setShortDisplayCaseInsensitive (boolean ascending) {
    this.ShortDisplayCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getShortDisplayCaseInsensitive () {
    return this.ShortDisplayCaseInsensitive;
  }
  /** Set the field level filters for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ShortDisplay (FRANCHISE_CODE_VALUES.short_display)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @param fetch whether to fetch this field or not
   */
  public void setDisplayValueFetch (boolean fetch) {
    this.DisplayValueFetch = fetch;
  }
  /** Retrieve Fetch value for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @return boolean the Fetch value for this field
   */
  public boolean getDisplayValueFetch () {
    return this.DisplayValueFetch;
  }
  /** Set the SortOrder for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getDisplayValueSortOrder () {
    return this.DisplayValueSort;
  }
  /** Set the sort direction for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setDisplayValueSortDirection (boolean ascending) {
    this.DisplayValueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getDisplayValueSortDirection () {
    return this.DisplayValueSortAscending;
  }
  /** Set the case insensitive for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setDisplayValueCaseInsensitive (boolean ascending) {
    this.DisplayValueCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getDisplayValueCaseInsensitive () {
    return this.DisplayValueCaseInsensitive;
  }
  /** Set the field level filters for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: DisplayValue (FRANCHISE_CODE_VALUES.display_value)
   * @return StringFilter[] array of field level filters
   */
  ...
  public Map toMap() {
    return FranchiseCodeObjectHelper.toMap(this, null);
  }
}
