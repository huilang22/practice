 ...
 * Generated  File: BillMessageGroupObjectHelper.java
...
/** Helper class to convert BillMessageGroupObject JavaBean objects to/from HashMaps.
 */
public class BillMessageGroupObjectHelper implements ArubaObjectHelper
{
  /** convert BillMessageGroupObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (BillMessageGroupObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillMessageGroupObjectData in, Map record, String rootName)
  {
  ...
  /** convert BillMessageGroupObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BillMessageGroupObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BillMessageGroupObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillMessageGroupObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BillMessageGroupObject";
  ...
  /** convert Map to BillMessageGroupObjectData.
   * @param record the Map containing the data to convert to the object
   * @return BillMessageGroupObjectData the converted object
   */
  public static BillMessageGroupObjectData fromMap (Map record)
  {
   ...
   * @return BillMessageGroupObjectData the converted object
   */
  public static BillMessageGroupObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BillMessageGroupObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return BillMessageGroupObjectFilter the converted object
   */
  public static BillMessageGroupObjectFilter fromMapFilter (Map record) {
   ...
   * @return BillMessageGroupObjectFilter the converted object
   */
  public static BillMessageGroupObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BillMessageGroupObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to BillMessageGroupObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return BillMessageGroupObjectDataList the converted object
   */
  public static BillMessageGroupObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to BillMessageGroupObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "BillMessageGroupObjectList")
   * @return BillMessageGroupObjectDataList the converted object
   */
  public static BillMessageGroupObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "BillMessageGroupObjectList";
    Object[] root = (Object[]) record.get (rootName);
    BillMessageGroupObjectData[] array = null;
    if (root != null)
    {
      array = new BillMessageGroupObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = BillMessageGroupObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new BillMessageGroupObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new BillMessageGroupObjectDataList (array, index, total);
  }
  /** convert BillMessageGroupObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BillMessageGroupObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", BillMessageGroupObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert BillMessageGroupObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BillMessageGroupObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return BillMessageGroupObjectData the converted object
   */
  public static BillMessageGroupObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillMessageGroupObjectData out = new BillMessageGroupObjectData ();

    out.Key = BillMessageGroupObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return BillMessageGroupObjectFilter the converted object
   */
  public static BillMessageGroupObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillMessageGroupObjectFilter out = new BillMessageGroupObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = BillMessageGroupObjectKeyHelper.getFilter ((Map) record.get ("Key"));
