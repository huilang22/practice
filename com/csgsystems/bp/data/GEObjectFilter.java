 ...
 * Generated  File: GEObjectFilter.java
...
/** Filter object */
public class GEObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public GEObjectKeyFilter Key = null;
  /** raw field for: GENERIC_ENUMERATION_REF.is_default) */
  ...
  /** raw field for: GENERIC_ENUMERATION_REF.is_internal) */
  ...
  /** raw field for: GENERIC_ENUMERATION_REF.sort_index) */
  public    IntegerFilter[] SortIndex  = null;
  protected boolean SortIndexFetch = false;
  protected boolean SortIndexSortAscending = true;
  protected Integer SortIndexSort = null;
  /** raw field for: GENERIC_ENUMERATION_REF.config_tag_id) */
  ...
  /** raw field for: GENERIC_ENUMERATION_VALUES.short_display) */
  ...
  /** raw field for: GENERIC_ENUMERATION_VALUES.display_value) */
  ...
  private String _objName = "GEObjectFilter";
  /** default constructor */
  public GEObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public GEObjectFilter (GEObjectFilter other)
  {
    if (other == null) return;
    this.Key = new GEObjectKeyFilter (other.Key);
    ...
    this.SortIndexFetch = other.SortIndexFetch;
    this.SortIndexSort = other.SortIndexSort;
    this.SortIndexSortAscending = other.SortIndexSortAscending;
   ...
   * @return GEObjectKeyFilter
   */
  public GEObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (GEObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new GEObjectKeyFilter ();
    this.Key.EnumerationKeyFetch = fetch;
  }
  ...
  public boolean getEnumerationKeyFetch ()
  {
    ...
    return this.Key.EnumerationKeyFetch;
  }
  ...
  {
    if (this.Key == null) this.Key = new GEObjectKeyFilter ();
    this.Key.EnumerationKeySort = value;
  }
  ...
  public Integer getEnumerationKeySortOrder ()
  {
    ...
    return this.Key.EnumerationKeySort;
  }
  ...
  {
    if (this.Key == null) this.Key = new GEObjectKeyFilter ();
    this.Key.EnumerationKeySortAscending = ascending;
  }
  ...
  {
    if (this.Key == null) return true;
    return this.Key.EnumerationKeySortAscending;
  }
  ...
  {
    if (this.Key == null) this.Key = new GEObjectKeyFilter ();
    this.Key.EnumerationKeyCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsentive for field: EnumerationKey (GENERIC_ENUMERATION_VALUES.enumeration_key)
   * @return boolean whether the field is case insensitive
   */
  public boolean getEnumerationKeyCaseInsensitive ()
  {
    if (this.Key == null) return false;
    return this.Key.EnumerationKeyCaseInsensitive;
  }
  ...
  {
    if (this.Key == null) this.Key = new GEObjectKeyFilter ();
    this.Key.ValueCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsentive for field: Value (GENERIC_ENUMERATION_VALUES.value)
   * @return boolean whether the field is case insensitive
   */
  public boolean getValueCaseInsensitive ()
  {
    if (this.Key == null) return false;
    return this.Key.ValueCaseInsensitive;
  }
  ...
  /** Set the field level Fetch value for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
   * @param fetch whether to fetch this field or not
   */
  public void setIsDefaultFetch (boolean fetch) {
    this.IsDefaultFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsDefaultFetch () {
    return this.IsDefaultFetch;
  }
  /** Set the SortOrder for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsDefaultSortOrder () {
    return this.IsDefaultSort;
  }
  /** Set the sort direction for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsDefaultSortDirection (boolean ascending) {
    this.IsDefaultSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsDefaultSortDirection () {
    return this.IsDefaultSortAscending;
  }
  /** Set the field level filters for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsDefault (GENERIC_ENUMERATION_REF.is_default)
  ...
  /** Set the field level Fetch value for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * @param fetch whether to fetch this field or not
   */
  public void setIsInternalFetch (boolean fetch) {
    this.IsInternalFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsInternalFetch () {
    return this.IsInternalFetch;
  }
  /** Set the SortOrder for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsInternalSortOrder () {
    return this.IsInternalSort;
  }
  /** Set the sort direction for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsInternalSortDirection (boolean ascending) {
    this.IsInternalSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsInternalSortDirection () {
    return this.IsInternalSortAscending;
  }
  /** Set the field level filters for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsInternal (GENERIC_ENUMERATION_REF.is_internal)
   * @return BooleanFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * @param fetch whether to fetch this field or not
   */
  public void setSortIndexFetch (boolean fetch) {
    this.SortIndexFetch = fetch;
  }
  /** Retrieve Fetch value for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * @return boolean the Fetch value for this field
   */
  public boolean getSortIndexFetch () {
    return this.SortIndexFetch;
  }
  /** Set the SortOrder for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setSortIndexSortOrder (Integer value) {
    this.SortIndexSort = value;
  }
  /** Retrieve SortOrder for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getSortIndexSortOrder () {
    return this.SortIndexSort;
  }
  /** Set the sort direction for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setSortIndexSortDirection (boolean ascending) {
    this.SortIndexSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getSortIndexSortDirection () {
    return this.SortIndexSortAscending;
  }
  /** Set the field level filters for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setSortIndexFilter (IntegerFilter[] value) throws ServiceException {
    this.SortIndex = value;
  }
  /** Retrieve filter for field: SortIndex (GENERIC_ENUMERATION_REF.sort_index)
   * @return IntegerFilter[] array of field level filters
   */
  public IntegerFilter[] getSortIndexFilter () {
    return this.SortIndex;
  }

  /**
   * Retrieves the SortIndexFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The SortIndexFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the SortIndexFilter field
   */
  public String[] getSortIndexFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getSortIndexFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getSortIndexFilter(), _locale, false, false);
      if (formattedObjs != null) {
        formattedValues = new String[formattedObjs.length];
        for (int i=0; i<formattedObjs.length; i++) {
          formattedValues[i] = formattedObjs[i].toString();
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getSortIndexFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("SortIndexFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getSortIndexFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the SortIndexFilter filter value from a formatted string
   *
   * @param _value the SortIndexFilter filter value(s) in formatted form. If the requested
   *          output filter type is a type that contains a single data item, then a single
   *          String display value object must be specified. If the requested output filter type
   *          is a type that contains more than one data item (e.g. a Between Filter), then a
   *          Collection of String display value objects must be provided.
   * @param _filterType output filter type (see {@link FilterConversionHelper} fields for a list of valid values)
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the SortIndexFilter filter field
   */
  public void setSortIndexFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setSortIndexFilterFromFormattedString");
    try {
      this.setSortIndexFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("SortIndexFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setSortIndexFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setSortIndexFilterFromFormattedString");
  }

  /** Set the field level Fetch value for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @param fetch whether to fetch this field or not
   */
  public void setConfigTagIdFetch (boolean fetch) {
    this.ConfigTagIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getConfigTagIdFetch () {
    return this.ConfigTagIdFetch;
  }
  /** Set the SortOrder for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getConfigTagIdSortOrder () {
    return this.ConfigTagIdSort;
  }
  /** Set the sort direction for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setConfigTagIdSortDirection (boolean ascending) {
    this.ConfigTagIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getConfigTagIdSortDirection () {
    return this.ConfigTagIdSortAscending;
  }
  /** Set the case insensitive for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setConfigTagIdCaseInsensitive (boolean ascending) {
    this.ConfigTagIdCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getConfigTagIdCaseInsensitive () {
    return this.ConfigTagIdCaseInsensitive;
  }
  /** Set the field level filters for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ConfigTagId (GENERIC_ENUMERATION_REF.config_tag_id)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @param fetch whether to fetch this field or not
   */
  public void setShortDisplayFetch (boolean fetch) {
    this.ShortDisplayFetch = fetch;
  }
  /** Retrieve Fetch value for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @return boolean the Fetch value for this field
   */
  public boolean getShortDisplayFetch () {
    return this.ShortDisplayFetch;
  }
  /** Set the SortOrder for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getShortDisplaySortOrder () {
    return this.ShortDisplaySort;
  }
  /** Set the sort direction for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setShortDisplaySortDirection (boolean ascending) {
    this.ShortDisplaySortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getShortDisplaySortDirection () {
    return this.ShortDisplaySortAscending;
  }
  /** Set the case insensitive for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setShortDisplayCaseInsensitive (boolean ascending) {
    this.ShortDisplayCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getShortDisplayCaseInsensitive () {
    return this.ShortDisplayCaseInsensitive;
  }
  /** Set the field level filters for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ShortDisplay (GENERIC_ENUMERATION_VALUES.short_display)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @param fetch whether to fetch this field or not
   */
  public void setDisplayValueFetch (boolean fetch) {
    this.DisplayValueFetch = fetch;
  }
  /** Retrieve Fetch value for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @return boolean the Fetch value for this field
   */
  public boolean getDisplayValueFetch () {
    return this.DisplayValueFetch;
  }
  /** Set the SortOrder for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getDisplayValueSortOrder () {
    return this.DisplayValueSort;
  }
  /** Set the sort direction for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setDisplayValueSortDirection (boolean ascending) {
    this.DisplayValueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getDisplayValueSortDirection () {
    return this.DisplayValueSortAscending;
  }
  /** Set the case insensitive for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setDisplayValueCaseInsensitive (boolean ascending) {
    this.DisplayValueCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getDisplayValueCaseInsensitive () {
    return this.DisplayValueCaseInsensitive;
  }
  /** Set the field level filters for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: DisplayValue (GENERIC_ENUMERATION_VALUES.display_value)
   * @return StringFilter[] array of field level filters
   */
  ...
  public Map toMap() {
    return GEObjectHelper.toMap(this, null);
  }
}
