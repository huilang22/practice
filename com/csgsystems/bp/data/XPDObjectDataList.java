 ...
 * Generated  File: XPDObjectDataList.java
...
public class XPDObjectDataList extends ArubaObjectList implements Serializable
{
  /** The array of objects */
  public XPDObjectData[] array = null;
  
  public XPDObjectDataList () {} 
  /** constructor
   * @param array      the array of objects
   * @param index      the Index offset for this result set
   * @param totalCount the total count of records the query resulted in
   */
  public XPDObjectDataList (XPDObjectData[] array, Integer index, Integer totalCount) {
    this.array = array;
   ...
   * @return XPDObjectData[] the object array
   */
  public XPDObjectData[] getArray () {
    return this.array;
  }

  /** Retrieve the Collection of objects.
   * @return XPDObjectData[] the object collection
   */
  ...
  public String toString() {
    XPDObjectData[] array = getArray();
    StringBuffer buff = new StringBuffer("Length = "+getLength());
    if (array != null) {
      XPDObjectData data = null;
      for (int i = 0; i < array.length; i++) {
        buff.append("["+i+"]"+XPDObjectHelper.toMap(data, null).toString());
      }
    }
