 ...
 * Generated  File: AxrtPaymentTransObjectFilter.java
...
/** Filter object */
public class AxrtPaymentTransObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public AxrtPaymentTransObjectKeyFilter Key = null;
  ...
  private String _objName = "AxrtPaymentTransObjectFilter";
  /** default constructor */
  public AxrtPaymentTransObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AxrtPaymentTransObjectFilter (AxrtPaymentTransObjectFilter other)
  {
    if (other == null) return;
    this.Key = new AxrtPaymentTransObjectKeyFilter (other.Key);
   ...
   * @return AxrtPaymentTransObjectKeyFilter
   */
  public AxrtPaymentTransObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (AxrtPaymentTransObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new AxrtPaymentTransObjectKeyFilter ();
  ...
  public String toString() {
    return AxrtPaymentTransObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return AxrtPaymentTransObjectHelper.toMap(this, null);
  }
}
