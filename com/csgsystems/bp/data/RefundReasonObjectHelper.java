 ...
 * Generated  File: RefundReasonObjectHelper.java
...
/** Helper class to convert RefundReasonObject JavaBean objects to/from HashMaps.
 */
public class RefundReasonObjectHelper implements ArubaObjectHelper
{
  /** convert RefundReasonObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (RefundReasonObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (RefundReasonObjectData in, Map record, String rootName)
  {
  ...
  /** convert RefundReasonObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (RefundReasonObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert RefundReasonObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (RefundReasonObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "RefundReasonObject";
  ...
  /** convert Map to RefundReasonObjectData.
   * @param record the Map containing the data to convert to the object
   * @return RefundReasonObjectData the converted object
   */
  public static RefundReasonObjectData fromMap (Map record)
  {
   ...
   * @return RefundReasonObjectData the converted object
   */
  public static RefundReasonObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to RefundReasonObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return RefundReasonObjectFilter the converted object
   */
  public static RefundReasonObjectFilter fromMapFilter (Map record) {
   ...
   * @return RefundReasonObjectFilter the converted object
   */
  public static RefundReasonObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "RefundReasonObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to RefundReasonObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return RefundReasonObjectDataList the converted object
   */
  public static RefundReasonObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to RefundReasonObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "RefundReasonObjectList")
   * @return RefundReasonObjectDataList the converted object
   */
  public static RefundReasonObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "RefundReasonObjectList";
    Object[] root = (Object[]) record.get (rootName);
    RefundReasonObjectData[] array = null;
    if (root != null)
    {
      array = new RefundReasonObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = RefundReasonObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new RefundReasonObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new RefundReasonObjectDataList (array, index, total);
  }
  /** convert RefundReasonObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (RefundReasonObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", RefundReasonObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert RefundReasonObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (RefundReasonObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return RefundReasonObjectData the converted object
   */
  public static RefundReasonObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    RefundReasonObjectData out = new RefundReasonObjectData ();

    out.Key = RefundReasonObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return RefundReasonObjectFilter the converted object
   */
  public static RefundReasonObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    RefundReasonObjectFilter out = new RefundReasonObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = RefundReasonObjectKeyHelper.getFilter ((Map) record.get ("Key"));
