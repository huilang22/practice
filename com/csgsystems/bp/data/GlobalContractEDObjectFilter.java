 ...
 * Generated  File: GlobalContractEDObjectFilter.java
...
/** Filter object */
public class GlobalContractEDObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public GlobalContractEDObjectKeyFilter Key = null;
  ...
  /** raw field for: CUSTOMER_CONTRACT_EXT_DATA.param_value) */
  ...
  /** raw field for: CUSTOMER_CONTRACT_EXT_DATA.param_datatype) */
  ...
  private String _objName = "GlobalContractEDObjectFilter";
  /** default constructor */
  public GlobalContractEDObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public GlobalContractEDObjectFilter (GlobalContractEDObjectFilter other)
  {
    if (other == null) return;
    this.Key = new GlobalContractEDObjectKeyFilter (other.Key);
   ...
   * @return GlobalContractEDObjectKeyFilter
   */
  public GlobalContractEDObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (GlobalContractEDObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new GlobalContractEDObjectKeyFilter ();
  ...
  /** Set the field level Fetch value for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @param fetch whether to fetch this field or not
   */
  public void setParamValueFetch (boolean fetch) {
    this.ParamValueFetch = fetch;
  }
  /** Retrieve Fetch value for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @return boolean the Fetch value for this field
   */
  public boolean getParamValueFetch () {
    return this.ParamValueFetch;
  }
  /** Set the SortOrder for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getParamValueSortOrder () {
    return this.ParamValueSort;
  }
  /** Set the sort direction for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setParamValueSortDirection (boolean ascending) {
    this.ParamValueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getParamValueSortDirection () {
    return this.ParamValueSortAscending;
  }
  /** Set the case insensitive for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setParamValueCaseInsensitive (boolean ascending) {
    this.ParamValueCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getParamValueCaseInsensitive () {
    return this.ParamValueCaseInsensitive;
  }
  /** Set the field level filters for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ParamValue (CUSTOMER_CONTRACT_EXT_DATA.param_value)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * @param fetch whether to fetch this field or not
   */
  public void setParamDatatypeFetch (boolean fetch) {
    this.ParamDatatypeFetch = fetch;
  }
  /** Retrieve Fetch value for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * @return boolean the Fetch value for this field
   */
  public boolean getParamDatatypeFetch () {
    return this.ParamDatatypeFetch;
  }
  /** Set the SortOrder for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getParamDatatypeSortOrder () {
    return this.ParamDatatypeSort;
  }
  /** Set the sort direction for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setParamDatatypeSortDirection (boolean ascending) {
    this.ParamDatatypeSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getParamDatatypeSortDirection () {
    return this.ParamDatatypeSortAscending;
  }
  /** Set the field level filters for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ParamDatatype (CUSTOMER_CONTRACT_EXT_DATA.param_datatype)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  public Map toMap() {
    return GlobalContractEDObjectHelper.toMap(this, null);
  }
}
