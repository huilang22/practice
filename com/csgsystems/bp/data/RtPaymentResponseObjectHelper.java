 ...
 * Generated  File: RtPaymentResponseObjectHelper.java
...
/** Helper class to convert RtPaymentResponseObject JavaBean objects to/from HashMaps.
 */
public class RtPaymentResponseObjectHelper implements ArubaObjectHelper
{
  /** convert RtPaymentResponseObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (RtPaymentResponseObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (RtPaymentResponseObjectData in, Map record, String rootName)
  {
  ...
  /** convert RtPaymentResponseObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (RtPaymentResponseObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert RtPaymentResponseObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (RtPaymentResponseObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "RtPaymentResponseObject";
  ...
  /** convert Map to RtPaymentResponseObjectData.
   * @param record the Map containing the data to convert to the object
   * @return RtPaymentResponseObjectData the converted object
   */
  public static RtPaymentResponseObjectData fromMap (Map record)
  {
   ...
   * @return RtPaymentResponseObjectData the converted object
   */
  public static RtPaymentResponseObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to RtPaymentResponseObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return RtPaymentResponseObjectFilter the converted object
   */
  public static RtPaymentResponseObjectFilter fromMapFilter (Map record) {
   ...
   * @return RtPaymentResponseObjectFilter the converted object
   */
  public static RtPaymentResponseObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "RtPaymentResponseObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to RtPaymentResponseObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return RtPaymentResponseObjectDataList the converted object
   */
  public static RtPaymentResponseObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to RtPaymentResponseObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "RtPaymentResponseObjectList")
   * @return RtPaymentResponseObjectDataList the converted object
   */
  public static RtPaymentResponseObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "RtPaymentResponseObjectList";
    Object[] root = (Object[]) record.get (rootName);
    RtPaymentResponseObjectData[] array = null;
    if (root != null)
    {
      array = new RtPaymentResponseObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = RtPaymentResponseObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new RtPaymentResponseObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new RtPaymentResponseObjectDataList (array, index, total);
  }
  /** convert RtPaymentResponseObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (RtPaymentResponseObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", RtPaymentResponseObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert RtPaymentResponseObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (RtPaymentResponseObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return RtPaymentResponseObjectData the converted object
   */
  public static RtPaymentResponseObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    RtPaymentResponseObjectData out = new RtPaymentResponseObjectData ();

    out.Key = RtPaymentResponseObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return RtPaymentResponseObjectFilter the converted object
   */
  public static RtPaymentResponseObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    RtPaymentResponseObjectFilter out = new RtPaymentResponseObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = RtPaymentResponseObjectKeyHelper.getFilter ((Map) record.get ("Key"));
