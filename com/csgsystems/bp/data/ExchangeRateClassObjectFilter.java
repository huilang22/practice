 ...
 * Generated  File: ExchangeRateClassObjectFilter.java
...
/** Filter object */
public class ExchangeRateClassObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public ExchangeRateClassObjectKeyFilter Key = null;
  /** raw field for: EXRATE_CLASS_REF.conversion_date) */
  public    IntegerFilter[] ConversionDate  = null;
  protected boolean ConversionDateFetch = false;
  protected boolean ConversionDateSortAscending = true;
  protected Integer ConversionDateSort = null;
  /** raw field for: EXRATE_CLASS_REF.is_default) */
  ...
  /** raw field for: EXRATE_CLASS_REF.is_internal) */
  ...
  /** raw field for: EXRATE_CLASS_REF.config_tag_id) */
  ...
  /** raw field for: EXRATE_CLASS_VALUES.short_display) */
  ...
  /** raw field for: EXRATE_CLASS_VALUES.display_value) */
  ...
  private String _objName = "ExchangeRateClassObjectFilter";
  /** default constructor */
  public ExchangeRateClassObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public ExchangeRateClassObjectFilter (ExchangeRateClassObjectFilter other)
  {
    if (other == null) return;
    this.Key = new ExchangeRateClassObjectKeyFilter (other.Key);
    this.ConversionDate = other.ConversionDate;
    this.ConversionDateFetch = other.ConversionDateFetch;
    this.ConversionDateSort = other.ConversionDateSort;
    this.ConversionDateSortAscending = other.ConversionDateSortAscending;
   ...
   * @return ExchangeRateClassObjectKeyFilter
   */
  public ExchangeRateClassObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (ExchangeRateClassObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new ExchangeRateClassObjectKeyFilter ();
    this.Key.EClassFetch = fetch;
  }
  ...
  {
    if (this.Key == null) this.Key = new ExchangeRateClassObjectKeyFilter ();
    this.Key.EClassSortAscending = ascending;
  }
  ...
  {
    if (this.Key == null) return true;
    return this.Key.EClassSortAscending;
  }
  ...
  /** Set the field level Fetch value for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * @param fetch whether to fetch this field or not
   */
  public void setConversionDateFetch (boolean fetch) {
    this.ConversionDateFetch = fetch;
  }
  /** Retrieve Fetch value for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * @return boolean the Fetch value for this field
   */
  public boolean getConversionDateFetch () {
    return this.ConversionDateFetch;
  }
  /** Set the SortOrder for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setConversionDateSortOrder (Integer value) {
    this.ConversionDateSort = value;
  }
  /** Retrieve SortOrder for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getConversionDateSortOrder () {
    return this.ConversionDateSort;
  }
  /** Set the sort direction for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setConversionDateSortDirection (boolean ascending) {
    this.ConversionDateSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getConversionDateSortDirection () {
    return this.ConversionDateSortAscending;
  }
  /** Set the field level filters for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setConversionDateFilter (IntegerFilter[] value) throws ServiceException {
    this.ConversionDate = value;
  }
  /** Retrieve filter for field: ConversionDate (EXRATE_CLASS_REF.conversion_date)
   * @return IntegerFilter[] array of field level filters
   */
  public IntegerFilter[] getConversionDateFilter () {
    return this.ConversionDate;
  }

  /**
   * Retrieves the ConversionDateFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The ConversionDateFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the ConversionDateFilter field
   */
  public String[] getConversionDateFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getConversionDateFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getConversionDateFilter(), _locale, false, false);
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getConversionDateFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("ConversionDateFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getConversionDateFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the ConversionDateFilter filter value from a formatted string
   *
   * @param _value the ConversionDateFilter filter value(s) in formatted form. If the requested
   ...
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the ConversionDateFilter filter field
   */
  public void setConversionDateFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setConversionDateFilterFromFormattedString");
    try {
      this.setConversionDateFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("ConversionDateFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setConversionDateFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setConversionDateFilterFromFormattedString");
  }

  /** Set the field level Fetch value for field: IsDefault (EXRATE_CLASS_REF.is_default)
   * @param fetch whether to fetch this field or not
   */
  public void setIsDefaultFetch (boolean fetch) {
    this.IsDefaultFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsDefault (EXRATE_CLASS_REF.is_default)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsDefaultFetch () {
    return this.IsDefaultFetch;
  }
  /** Set the SortOrder for field: IsDefault (EXRATE_CLASS_REF.is_default)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsDefault (EXRATE_CLASS_REF.is_default)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsDefaultSortOrder () {
    return this.IsDefaultSort;
  }
  /** Set the sort direction for field: IsDefault (EXRATE_CLASS_REF.is_default)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsDefaultSortDirection (boolean ascending) {
    this.IsDefaultSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsDefault (EXRATE_CLASS_REF.is_default)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsDefaultSortDirection () {
    return this.IsDefaultSortAscending;
  }
  /** Set the field level filters for field: IsDefault (EXRATE_CLASS_REF.is_default)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsDefault (EXRATE_CLASS_REF.is_default)
  ...
  /** Set the field level Fetch value for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * @param fetch whether to fetch this field or not
   */
  public void setIsInternalFetch (boolean fetch) {
    this.IsInternalFetch = fetch;
  }
  /** Retrieve Fetch value for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * @return boolean the Fetch value for this field
   */
  public boolean getIsInternalFetch () {
    return this.IsInternalFetch;
  }
  /** Set the SortOrder for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getIsInternalSortOrder () {
    return this.IsInternalSort;
  }
  /** Set the sort direction for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setIsInternalSortDirection (boolean ascending) {
    this.IsInternalSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getIsInternalSortDirection () {
    return this.IsInternalSortAscending;
  }
  /** Set the field level filters for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: IsInternal (EXRATE_CLASS_REF.is_internal)
   * @return BooleanFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * @param fetch whether to fetch this field or not
   */
  public void setConfigTagIdFetch (boolean fetch) {
    this.ConfigTagIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getConfigTagIdFetch () {
    return this.ConfigTagIdFetch;
  }
  /** Set the SortOrder for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getConfigTagIdSortOrder () {
    return this.ConfigTagIdSort;
  }
  /** Set the sort direction for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setConfigTagIdSortDirection (boolean ascending) {
    this.ConfigTagIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getConfigTagIdSortDirection () {
    return this.ConfigTagIdSortAscending;
  }
  /** Set the case insensitive for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setConfigTagIdCaseInsensitive (boolean ascending) {
    this.ConfigTagIdCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getConfigTagIdCaseInsensitive () {
    return this.ConfigTagIdCaseInsensitive;
  }
  /** Set the field level filters for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ConfigTagId (EXRATE_CLASS_REF.config_tag_id)
  ...
  /** Set the field level Fetch value for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @param fetch whether to fetch this field or not
   */
  public void setShortDisplayFetch (boolean fetch) {
    this.ShortDisplayFetch = fetch;
  }
  /** Retrieve Fetch value for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @return boolean the Fetch value for this field
   */
  public boolean getShortDisplayFetch () {
    return this.ShortDisplayFetch;
  }
  /** Set the SortOrder for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getShortDisplaySortOrder () {
    return this.ShortDisplaySort;
  }
  /** Set the sort direction for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setShortDisplaySortDirection (boolean ascending) {
    this.ShortDisplaySortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getShortDisplaySortDirection () {
    return this.ShortDisplaySortAscending;
  }
  /** Set the case insensitive for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setShortDisplayCaseInsensitive (boolean ascending) {
    this.ShortDisplayCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getShortDisplayCaseInsensitive () {
    return this.ShortDisplayCaseInsensitive;
  }
  /** Set the field level filters for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ShortDisplay (EXRATE_CLASS_VALUES.short_display)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @param fetch whether to fetch this field or not
   */
  public void setDisplayValueFetch (boolean fetch) {
    this.DisplayValueFetch = fetch;
  }
  /** Retrieve Fetch value for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @return boolean the Fetch value for this field
   */
  public boolean getDisplayValueFetch () {
    return this.DisplayValueFetch;
  }
  /** Set the SortOrder for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getDisplayValueSortOrder () {
    return this.DisplayValueSort;
  }
  /** Set the sort direction for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setDisplayValueSortDirection (boolean ascending) {
    this.DisplayValueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getDisplayValueSortDirection () {
    return this.DisplayValueSortAscending;
  }
  /** Set the case insensitive for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setDisplayValueCaseInsensitive (boolean ascending) {
    this.DisplayValueCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getDisplayValueCaseInsensitive () {
    return this.DisplayValueCaseInsensitive;
  }
  /** Set the field level filters for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: DisplayValue (EXRATE_CLASS_VALUES.display_value)
   * @return StringFilter[] array of field level filters
   */
  ...
  public Map toMap() {
    return ExchangeRateClassObjectHelper.toMap(this, null);
  }
}
