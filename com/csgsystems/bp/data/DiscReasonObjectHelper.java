 ...
 * Generated  File: DiscReasonObjectHelper.java
...
/** Helper class to convert DiscReasonObject JavaBean objects to/from HashMaps.
 */
public class DiscReasonObjectHelper implements ArubaObjectHelper
{
  /** convert DiscReasonObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (DiscReasonObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (DiscReasonObjectData in, Map record, String rootName)
  {
  ...
  /** convert DiscReasonObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (DiscReasonObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert DiscReasonObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (DiscReasonObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "DiscReasonObject";
  ...
  /** convert Map to DiscReasonObjectData.
   * @param record the Map containing the data to convert to the object
   * @return DiscReasonObjectData the converted object
   */
  public static DiscReasonObjectData fromMap (Map record)
  {
   ...
   * @return DiscReasonObjectData the converted object
   */
  public static DiscReasonObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to DiscReasonObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return DiscReasonObjectFilter the converted object
   */
  public static DiscReasonObjectFilter fromMapFilter (Map record) {
   ...
   * @return DiscReasonObjectFilter the converted object
   */
  public static DiscReasonObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "DiscReasonObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to DiscReasonObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return DiscReasonObjectDataList the converted object
   */
  public static DiscReasonObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to DiscReasonObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "DiscReasonObjectList")
   * @return DiscReasonObjectDataList the converted object
   */
  public static DiscReasonObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "DiscReasonObjectList";
    Object[] root = (Object[]) record.get (rootName);
    DiscReasonObjectData[] array = null;
    if (root != null)
    {
      array = new DiscReasonObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = DiscReasonObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new DiscReasonObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new DiscReasonObjectDataList (array, index, total);
  }
  /** convert DiscReasonObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (DiscReasonObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", DiscReasonObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert DiscReasonObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (DiscReasonObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return DiscReasonObjectData the converted object
   */
  public static DiscReasonObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    DiscReasonObjectData out = new DiscReasonObjectData ();

    out.Key = DiscReasonObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return DiscReasonObjectFilter the converted object
   */
  public static DiscReasonObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    DiscReasonObjectFilter out = new DiscReasonObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = DiscReasonObjectKeyHelper.getFilter ((Map) record.get ("Key"));
