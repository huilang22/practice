 ...
 * Generated  File: AccountXIDServiceObjectHelper.java
...
/** Helper class to convert AccountXIDServiceObject JavaBean objects to/from HashMaps.
 */
public class AccountXIDServiceObjectHelper implements ArubaObjectHelper
{
  /** convert AccountXIDServiceObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (AccountXIDServiceObjectData in, Map record)
  {
   ...
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @param rootName use this name as the root name for the object (defaults to "AccountXIDServiceObject")
   * @return Map     the output Map
   */
  public static Map toMap (AccountXIDServiceObjectData in, Map record, String rootName)
  {
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "AccountXIDServiceObject";
    Map map = getMap (in, (Map) record.get (rootName));
    map = AccountObjectHelper.getMap (in, map);
    record.put (rootName, map);
    return record;
  }
  /** convert AccountXIDServiceObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (AccountXIDServiceObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert AccountXIDServiceObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AccountXIDServiceObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "AccountXIDServiceObject";
  ...
  /** convert Map to AccountXIDServiceObjectData.
   * @param record the Map containing the data to convert to the object
   * @return AccountXIDServiceObjectData the converted object
   */
  public static AccountXIDServiceObjectData fromMap (Map record)
  {
    return fromMap (record, null);
  }
  /** convert Map to AccountXIDServiceObjectData.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the mape (defaults to "AccountXIDServiceObject")
   * @return AccountXIDServiceObjectData the converted object
   */
  public static AccountXIDServiceObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to AccountXIDServiceObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return AccountXIDServiceObjectFilter the converted object
   */
  public static AccountXIDServiceObjectFilter fromMapFilter (Map record) {
    return fromMapFilter (record, null);
  }
  /** convert Map to AccountXIDServiceObjectFilter.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the map (defaults to "AccountXIDServiceObject")
   * @return AccountXIDServiceObjectFilter the converted object
   */
  public static AccountXIDServiceObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "AccountXIDServiceObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to AccountXIDServiceObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return AccountXIDServiceObjectDataList the converted object
   */
  public static AccountXIDServiceObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to AccountXIDServiceObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "AccountXIDServiceObjectList")
   * @return AccountXIDServiceObjectDataList the converted object
   */
  public static AccountXIDServiceObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "AccountXIDServiceObjectList";
    Object[] root = (Object[]) record.get (rootName);
    AccountXIDServiceObjectData[] array = null;
    if (root != null)
    {
      array = new AccountXIDServiceObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = AccountXIDServiceObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new AccountXIDServiceObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new AccountXIDServiceObjectDataList (array, index, total);
  }
  /** convert AccountXIDServiceObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AccountXIDServiceObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
  ...
  /** convert AccountXIDServiceObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AccountXIDServiceObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return AccountXIDServiceObjectData the converted object
   */
  public static AccountXIDServiceObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AccountXIDServiceObjectData out = new AccountXIDServiceObjectData (AccountObjectHelper.getObj (record));
   ...
   * @return AccountXIDServiceObjectFilter the converted object
   */
  public static AccountXIDServiceObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AccountXIDServiceObjectFilter out = new AccountXIDServiceObjectFilter (AccountObjectHelper.getFilter (record));
