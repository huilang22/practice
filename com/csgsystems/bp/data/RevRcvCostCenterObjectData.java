 ...
 * Generated  File: RevRcvCostCenterObjectData.java
...
/** RevRcvCostCenterObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class RevRcvCostCenterObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public RevRcvCostCenterObjectKeyData Key = null;
  /** REV_RCV_COST_CENTER_REF.g_l_code field */
  public    String GLCode  = null;
  protected boolean _GLCodeSet = false;
  /** REV_RCV_COST_CENTER_REF.is_default field */
  public    Boolean IsDefault  = null;
  protected boolean _IsDefaultSet = false;
  /** REV_RCV_COST_CENTER_REF.is_internal field */
  public    Boolean IsInternal  = null;
  protected boolean _IsInternalSet = false;
  /** REV_RCV_COST_CENTER_REF.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  /** REV_RCV_COST_CENTER_VALUES.short_display field */
  public    String ShortDisplay  = null;
  protected boolean _ShortDisplaySet = false;
  /** REV_RCV_COST_CENTER_VALUES.display_value field */
  public    String DisplayValue  = null;
  protected boolean _DisplayValueSet = false;
  private String _objName = "RevRcvCostCenterObjectData";
  /** Default constructor */
  public RevRcvCostCenterObjectData ()
  {
    super ();
   ...
   */
  public RevRcvCostCenterObjectData (RevRcvCostCenterObjectData other)
  {

    if (other == null) return;
    this.Key = new RevRcvCostCenterObjectKeyData (other.Key);
    this.GLCode = other.GLCode;
    this._GLCodeSet = other._GLCodeSet;
   ...
   * @return RevRcvCostCenterObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public RevRcvCostCenterObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (RevRcvCostCenterObjectKeyData Key)
  {
    this.Key = Key;
  }
  /** set the fields value: Value (REV_RCV_COST_CENTER_VALUES.rev_rcv_cost_ctr)
  ...
  public void setValue (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new RevRcvCostCenterObjectKeyData ();
    this.Key.Value = value;
    this.Key._ValueSet = true;
  }
  /** get the value of the field: Value (REV_RCV_COST_CENTER_VALUES.rev_rcv_cost_ctr)
  ...
  /** Change the field to not being actively set: Value (REV_RCV_COST_CENTER_VALUES.rev_rcv_cost_ctr)
   */
  public void unsetValue () {
    if (this.Key == null) return;
    this.Key._ValueSet = false;
  }
  /** See if the field is actively set: Value (REV_RCV_COST_CENTER_VALUES.rev_rcv_cost_ctr)
  ...
  /** set the fields value: LanguageCode (REV_RCV_COST_CENTER_VALUES.language_code)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: LanguageCode (REV_RCV_COST_CENTER_VALUES.language_code)
   * @return Integer the value
   */
  ...
  /** Change the field to not being actively set: LanguageCode (REV_RCV_COST_CENTER_VALUES.language_code)
   */
  public void unsetLanguageCode () {
    if (this.Key == null) return;
    this.Key._LanguageCodeSet = false;
  }
  /** See if the field is actively set: LanguageCode (REV_RCV_COST_CENTER_VALUES.language_code)
   * @return boolean whether the field is actively set
   */
  ...
  /** set the fields value: GLCode (REV_RCV_COST_CENTER_REF.g_l_code)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("GLCode") 
  public void setGLCode (String value) throws ServiceException
  {
    if (value == null)
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_NULL_VALUE", "The field's value cannot be NULL", _objName, "GLCode", "setGLCode");
    }
    if (value != null && !DataHelper.validLength (value, 19))
    {
      throw new ServiceException ("ArubaClient", "ck_INVALID_LENGTH", "The field's value is too long", _objName, "GLCode", "setGLCode");
    }
    this.GLCode = value;
    this._GLCodeSet = true;
  }

  /** Retrieves the GLCode field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The GLCode field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the GLCode field
   */
   public String getGLCodeAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getGLCodeAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getGLCodeAsFormattedString");
       return fmtMgr.formatString(this.getGLCode());
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("GLCode");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getGLCodeAsFormattedString");
       throw x;
     }
   }
  /** Sets the GLCode field from a formatted string
   *
   * @param _value the GLCode field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the GLCode field
   */
   public void setGLCodeFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getGLCodeFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setGLCode(fmtMgr.parseString(_value));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("GLCode");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setGLCodeFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setGLCodeFromFormattedString");
   }

  /** get the value of the field: GLCode (REV_RCV_COST_CENTER_REF.g_l_code)
   * @return String the value
   */
  public String getGLCode () {
    return this.GLCode;
  }
  /** Change the field to not being actively set: GLCode (REV_RCV_COST_CENTER_REF.g_l_code)
   */
  public void unsetGLCode () {
    this._GLCodeSet = false;
  }
  /** See if the field is actively set: GLCode (REV_RCV_COST_CENTER_REF.g_l_code)
   * @return boolean whether the field is actively set
   */
  public boolean issetGLCode () {
    return this._GLCodeSet;
  }
  /** set the fields value: IsDefault (REV_RCV_COST_CENTER_REF.is_default)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsDefault (REV_RCV_COST_CENTER_REF.is_default)
   * @return Boolean the value
   */
  public Boolean getIsDefault () {
    return this.IsDefault;
  }
  /** Change the field to not being actively set: IsDefault (REV_RCV_COST_CENTER_REF.is_default)
   */
  public void unsetIsDefault () {
    this._IsDefaultSet = false;
  }
  /** See if the field is actively set: IsDefault (REV_RCV_COST_CENTER_REF.is_default)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsDefault () {
    return this._IsDefaultSet;
  }
  /** set the fields value: IsInternal (REV_RCV_COST_CENTER_REF.is_internal)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: IsInternal (REV_RCV_COST_CENTER_REF.is_internal)
   * @return Boolean the value
   */
  public Boolean getIsInternal () {
    return this.IsInternal;
  }
  /** Change the field to not being actively set: IsInternal (REV_RCV_COST_CENTER_REF.is_internal)
   */
  public void unsetIsInternal () {
    this._IsInternalSet = false;
  }
  /** See if the field is actively set: IsInternal (REV_RCV_COST_CENTER_REF.is_internal)
   * @return boolean whether the field is actively set
   */
  public boolean issetIsInternal () {
    return this._IsInternalSet;
  }
  /** set the fields value: ConfigTagId (REV_RCV_COST_CENTER_REF.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (REV_RCV_COST_CENTER_REF.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (REV_RCV_COST_CENTER_REF.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (REV_RCV_COST_CENTER_REF.config_tag_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetConfigTagId () {
    return this._ConfigTagIdSet;
  }
  /** set the fields value: ShortDisplay (REV_RCV_COST_CENTER_VALUES.short_display)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ShortDisplay (REV_RCV_COST_CENTER_VALUES.short_display)
   * @return String the value
   */
  public String getShortDisplay () {
    return this.ShortDisplay;
  }
  /** Change the field to not being actively set: ShortDisplay (REV_RCV_COST_CENTER_VALUES.short_display)
   */
  public void unsetShortDisplay () {
    this._ShortDisplaySet = false;
  }
  /** See if the field is actively set: ShortDisplay (REV_RCV_COST_CENTER_VALUES.short_display)
   * @return boolean whether the field is actively set
   */
  public boolean issetShortDisplay () {
    return this._ShortDisplaySet;
  }
  /** set the fields value: DisplayValue (REV_RCV_COST_CENTER_VALUES.display_value)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisplayValue (REV_RCV_COST_CENTER_VALUES.display_value)
   * @return String the value
   */
  public String getDisplayValue () {
    return this.DisplayValue;
  }
  /** Change the field to not being actively set: DisplayValue (REV_RCV_COST_CENTER_VALUES.display_value)
   */
  public void unsetDisplayValue () {
    this._DisplayValueSet = false;
  }
  /** See if the field is actively set: DisplayValue (REV_RCV_COST_CENTER_VALUES.display_value)
   * @return boolean whether the field is actively set
   */
  ...
  /** REV_RCV_COST_CENTER_REF.g_l_code field */
    if(!nonNullOnly || (GLCode != null))  _GLCodeSet = flag;
  /** REV_RCV_COST_CENTER_REF.is_default field */
