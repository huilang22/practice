 ...
 * Generated  File: BalanceLineItemObjectFilter.java
...
/** Filter object */
public class BalanceLineItemObjectFilter  extends BaseFilter  implements Serializable
{
  /** the key filter */
  public BalanceLineItemObjectKeyFilter Key = null;
  ...
  /** raw field for: CMF_BALANCE_DETAIL.currency_code) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.ppdd_date) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.orig_ppdd_date) */
  public    DateFilter[] OrigPpddDate  = null;
  protected boolean OrigPpddDateFetch = false;
  protected boolean OrigPpddDateSortAscending = true;
  protected Integer OrigPpddDateSort = null;
  /** raw field for: CMF_BALANCE_DETAIL.closed_date) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.new_charges) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.net_new_charges) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.total_due) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.total_adj) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.total_paid) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.balance_due) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.dispute_amt) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.late_exempt_charges) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.collection_indicator) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.chg_date) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.chg_who) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.gl_amount) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.refinance_tracking_id) */
  public    IntegerFilter[] RefinanceTrackingId  = null;
  protected boolean RefinanceTrackingIdFetch = false;
  protected boolean RefinanceTrackingIdSortAscending = true;
  protected Integer RefinanceTrackingIdSort = null;
  /** raw field for: CMF_BALANCE_DETAIL.refinance_tracking_id_serv) */
  public    IntegerFilter[] RefinanceTrackingIdServ  = null;
  protected boolean RefinanceTrackingIdServFetch = false;
  protected boolean RefinanceTrackingIdServSortAscending = true;
  protected Integer RefinanceTrackingIdServSort = null;
  /** raw field for: CMF_BALANCE_DETAIL.external_id) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.converted) */
  ...
  /** raw field for: CMF_BALANCE_DETAIL.new_charge_credits) */
  ...
  private String _objName = "BalanceLineItemObjectFilter";
  /** default constructor */
  public BalanceLineItemObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public BalanceLineItemObjectFilter (BalanceLineItemObjectFilter other)
  {
    if (other == null) return;
    this.Key = new BalanceLineItemObjectKeyFilter (other.Key);
    ...
    this.OrigPpddDate = other.OrigPpddDate;
    this.OrigPpddDateFetch = other.OrigPpddDateFetch;
    this.OrigPpddDateSort = other.OrigPpddDateSort;
    this.OrigPpddDateSortAscending = other.OrigPpddDateSortAscending;
    ...
    this.RefinanceTrackingId = other.RefinanceTrackingId;
    this.RefinanceTrackingIdFetch = other.RefinanceTrackingIdFetch;
    this.RefinanceTrackingIdSort = other.RefinanceTrackingIdSort;
    this.RefinanceTrackingIdSortAscending = other.RefinanceTrackingIdSortAscending;
    this.RefinanceTrackingIdServ = other.RefinanceTrackingIdServ;
    this.RefinanceTrackingIdServFetch = other.RefinanceTrackingIdServFetch;
    this.RefinanceTrackingIdServSort = other.RefinanceTrackingIdServSort;
    this.RefinanceTrackingIdServSortAscending = other.RefinanceTrackingIdServSortAscending;
   ...
   * @return BalanceLineItemObjectKeyFilter
   */
  public BalanceLineItemObjectKeyFilter getKeyFilter ()
  {
    return this.Key;
  }
   ...
   */
  public void setKeyFilter (BalanceLineItemObjectKeyFilter Key)
  {
    this.Key = Key;
  }
  ...
  {
    if (this.Key == null) this.Key = new BalanceLineItemObjectKeyFilter ();
  ...
  /** Set the field level Fetch value for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * @param fetch whether to fetch this field or not
   */
  ...
  /** Retrieve Fetch value for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * @return boolean the Fetch value for this field
   */
  ...
  /** Set the SortOrder for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * @return Integer the sort order, if set, for the field
   */
  ...
  /** Set the sort direction for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  ...
  /** Retrieve SortDirection for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * @return boolean whether the SortDirection is Ascending
   */
  ...
  /** Set the field level filters for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: OpenItemId (CMF_BALANCE_DETAIL.open_item_id)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @param fetch whether to fetch this field or not
   */
  public void setCurrencyCodeFetch (boolean fetch) {
    this.CurrencyCodeFetch = fetch;
  }
  /** Retrieve Fetch value for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @return boolean the Fetch value for this field
   */
  public boolean getCurrencyCodeFetch () {
    return this.CurrencyCodeFetch;
  }
  /** Set the SortOrder for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getCurrencyCodeSortOrder () {
    return this.CurrencyCodeSort;
  }
  /** Set the sort direction for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setCurrencyCodeSortDirection (boolean ascending) {
    this.CurrencyCodeSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getCurrencyCodeSortDirection () {
    return this.CurrencyCodeSortAscending;
  }
  /** Set the field level filters for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @param fetch whether to fetch this field or not
   */
  public void setPpddDateFetch (boolean fetch) {
    this.PpddDateFetch = fetch;
  }
  /** Retrieve Fetch value for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @return boolean the Fetch value for this field
   */
  public boolean getPpddDateFetch () {
    return this.PpddDateFetch;
  }
  /** Set the SortOrder for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getPpddDateSortOrder () {
    return this.PpddDateSort;
  }
  /** Set the sort direction for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setPpddDateSortDirection (boolean ascending) {
    this.PpddDateSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getPpddDateSortDirection () {
    return this.PpddDateSortAscending;
  }
  /** Set the field level filters for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
  ...
  /** Set the field level Fetch value for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @param fetch whether to fetch this field or not
   */
  public void setOrigPpddDateFetch (boolean fetch) {
    this.OrigPpddDateFetch = fetch;
  }
  /** Retrieve Fetch value for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @return boolean the Fetch value for this field
   */
  public boolean getOrigPpddDateFetch () {
    return this.OrigPpddDateFetch;
  }
  /** Set the SortOrder for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setOrigPpddDateSortOrder (Integer value) {
    this.OrigPpddDateSort = value;
  }
  /** Retrieve SortOrder for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getOrigPpddDateSortOrder () {
    return this.OrigPpddDateSort;
  }
  /** Set the sort direction for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setOrigPpddDateSortDirection (boolean ascending) {
    this.OrigPpddDateSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getOrigPpddDateSortDirection () {
    return this.OrigPpddDateSortAscending;
  }
  /** Set the field level filters for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setOrigPpddDateFilter (DateFilter[] value) throws ServiceException {
    this.OrigPpddDate = value;
  }
  /** Retrieve filter for field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @return DateFilter[] array of field level filters
   */
  public DateFilter[] getOrigPpddDateFilter () {
    return this.OrigPpddDate;
  }

  /**
   * Retrieves the OrigPpddDateFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The OrigPpddDateFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the OrigPpddDateFilter field
   */
  public String[] getOrigPpddDateFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getOrigPpddDateFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getOrigPpddDateFilter(), _locale, false, false);
      if (formattedObjs != null) {
        formattedValues = new String[formattedObjs.length];
        for (int i=0; i<formattedObjs.length; i++) {
          formattedValues[i] = formattedObjs[i].toString();
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getOrigPpddDateFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("OrigPpddDateFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getOrigPpddDateFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the OrigPpddDateFilter filter value from a formatted string
   *
   * @param _value the OrigPpddDateFilter filter value(s) in formatted form. If the requested
   *          output filter type is a type that contains a single data item, then a single
   *          String display value object must be specified. If the requested output filter type
   *          is a type that contains more than one data item (e.g. a Between Filter), then a
   *          Collection of String display value objects must be provided.
   * @param _filterType output filter type (see {@link FilterConversionHelper} fields for a list of valid values)
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the OrigPpddDateFilter filter field
   */
  public void setOrigPpddDateFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setOrigPpddDateFilterFromFormattedString");
    try {
      this.setOrigPpddDateFilter((DateFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("OrigPpddDateFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setOrigPpddDateFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setOrigPpddDateFilterFromFormattedString");
  }

  /**
   * Retrieves the OrigPpddDateFilter filter value as a formatted date/time string
   *
   * @param _locale locale settings used to format text based display values
   * @return The OrigPpddDateFilter filter value in formatted date/time form
   * @throws ServiceException thrown if an error occurs formatting the data for the OrigPpddDateFilter field
   */
  public String[] getOrigPpddDateFilterAsFormattedDateTimeString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getOrigPpddDateFilterAsFormattedDateTimeString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getOrigPpddDateFilter(), _locale, true, false);
      if (formattedObjs != null) {
        formattedValues = new String[formattedObjs.length];
        for (int i=0; i<formattedObjs.length; i++) {
          formattedValues[i] = formattedObjs[i].toString();
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getOrigPpddDateFilterAsFormattedDateTimeString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("OrigPpddDateFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getOrigPpddDateFilterAsFormattedDateTimeString");
      throw excp;
    }
  }
  /**
   * Sets the OrigPpddDateFilter filter value from a formatted string
   *
   * @param _value the OrigPpddDateFilter filter value(s) in formatted date/time form. If the requested
   *          output filter type is a type that contains a single data item, then a single
   *          String display value object must be specified. If the requested output filter type
   *          is a type that contains more than one data item (e.g. a Between Filter), then a
   *          Collection of String display value objects must be provided.
   ...
   * @throws ServiceException thrown if invalid data is set in the OrigPpddDateFilter filter field
   */
  public void setOrigPpddDateFilterFromFormattedDateTimeString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setOrigPpddDateFilterFromFormattedDateTimeString");
    try {
      this.setOrigPpddDateFilter((DateFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, true, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("OrigPpddDateFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setOrigPpddDateFilterFromFormattedDateTimeString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setOrigPpddDateFilterFromFormattedDateTimeString");
  }


  /** Set the field level Fetch value for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @param fetch whether to fetch this field or not
   */
  public void setClosedDateFetch (boolean fetch) {
    this.ClosedDateFetch = fetch;
  }
  /** Retrieve Fetch value for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @return boolean the Fetch value for this field
   */
  public boolean getClosedDateFetch () {
    return this.ClosedDateFetch;
  }
  /** Set the SortOrder for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getClosedDateSortOrder () {
    return this.ClosedDateSort;
  }
  /** Set the sort direction for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setClosedDateSortDirection (boolean ascending) {
    this.ClosedDateSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getClosedDateSortDirection () {
    return this.ClosedDateSortAscending;
  }
  /** Set the field level filters for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @return DateFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @param fetch whether to fetch this field or not
   */
  public void setNewChargesFetch (boolean fetch) {
    this.NewChargesFetch = fetch;
  }
  /** Retrieve Fetch value for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @return boolean the Fetch value for this field
   */
  public boolean getNewChargesFetch () {
    return this.NewChargesFetch;
  }
  /** Set the SortOrder for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getNewChargesSortOrder () {
    return this.NewChargesSort;
  }
  /** Set the sort direction for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setNewChargesSortDirection (boolean ascending) {
    this.NewChargesSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getNewChargesSortDirection () {
    return this.NewChargesSortAscending;
  }
  /** Set the field level filters for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
  ...
  /** Set the field level Fetch value for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @param fetch whether to fetch this field or not
   */
  public void setNetNewChargesFetch (boolean fetch) {
    this.NetNewChargesFetch = fetch;
  }
  /** Retrieve Fetch value for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @return boolean the Fetch value for this field
   */
  public boolean getNetNewChargesFetch () {
    return this.NetNewChargesFetch;
  }
  /** Set the SortOrder for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getNetNewChargesSortOrder () {
    return this.NetNewChargesSort;
  }
  /** Set the sort direction for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setNetNewChargesSortDirection (boolean ascending) {
    this.NetNewChargesSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getNetNewChargesSortDirection () {
    return this.NetNewChargesSortAscending;
  }
  /** Set the field level filters for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @param fetch whether to fetch this field or not
   */
  public void setTotalDueFetch (boolean fetch) {
    this.TotalDueFetch = fetch;
  }
  /** Retrieve Fetch value for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @return boolean the Fetch value for this field
   */
  public boolean getTotalDueFetch () {
    return this.TotalDueFetch;
  }
  /** Set the SortOrder for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getTotalDueSortOrder () {
    return this.TotalDueSort;
  }
  /** Set the sort direction for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setTotalDueSortDirection (boolean ascending) {
    this.TotalDueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getTotalDueSortDirection () {
    return this.TotalDueSortAscending;
  }
  /** Set the field level filters for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @param fetch whether to fetch this field or not
   */
  public void setTotalAdjFetch (boolean fetch) {
    this.TotalAdjFetch = fetch;
  }
  /** Retrieve Fetch value for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @return boolean the Fetch value for this field
   */
  public boolean getTotalAdjFetch () {
    return this.TotalAdjFetch;
  }
  /** Set the SortOrder for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getTotalAdjSortOrder () {
    return this.TotalAdjSort;
  }
  /** Set the sort direction for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setTotalAdjSortDirection (boolean ascending) {
    this.TotalAdjSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getTotalAdjSortDirection () {
    return this.TotalAdjSortAscending;
  }
  /** Set the field level filters for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @param fetch whether to fetch this field or not
   */
  public void setTotalPaidFetch (boolean fetch) {
    this.TotalPaidFetch = fetch;
  }
  /** Retrieve Fetch value for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @return boolean the Fetch value for this field
   */
  public boolean getTotalPaidFetch () {
    return this.TotalPaidFetch;
  }
  /** Set the SortOrder for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getTotalPaidSortOrder () {
    return this.TotalPaidSort;
  }
  /** Set the sort direction for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setTotalPaidSortDirection (boolean ascending) {
    this.TotalPaidSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getTotalPaidSortDirection () {
    return this.TotalPaidSortAscending;
  }
  /** Set the field level filters for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @param fetch whether to fetch this field or not
   */
  public void setBalanceDueFetch (boolean fetch) {
    this.BalanceDueFetch = fetch;
  }
  /** Retrieve Fetch value for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @return boolean the Fetch value for this field
   */
  public boolean getBalanceDueFetch () {
    return this.BalanceDueFetch;
  }
  /** Set the SortOrder for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getBalanceDueSortOrder () {
    return this.BalanceDueSort;
  }
  /** Set the sort direction for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setBalanceDueSortDirection (boolean ascending) {
    this.BalanceDueSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getBalanceDueSortDirection () {
    return this.BalanceDueSortAscending;
  }
  /** Set the field level filters for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @param fetch whether to fetch this field or not
   */
  public void setDisputeAmtFetch (boolean fetch) {
    this.DisputeAmtFetch = fetch;
  }
  /** Retrieve Fetch value for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @return boolean the Fetch value for this field
   */
  public boolean getDisputeAmtFetch () {
    return this.DisputeAmtFetch;
  }
  /** Set the SortOrder for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getDisputeAmtSortOrder () {
    return this.DisputeAmtSort;
  }
  /** Set the sort direction for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setDisputeAmtSortDirection (boolean ascending) {
    this.DisputeAmtSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getDisputeAmtSortDirection () {
    return this.DisputeAmtSortAscending;
  }
  /** Set the field level filters for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @param fetch whether to fetch this field or not
   */
  public void setLateExemptChargesFetch (boolean fetch) {
    this.LateExemptChargesFetch = fetch;
  }
  /** Retrieve Fetch value for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @return boolean the Fetch value for this field
   */
  public boolean getLateExemptChargesFetch () {
    return this.LateExemptChargesFetch;
  }
  /** Set the SortOrder for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getLateExemptChargesSortOrder () {
    return this.LateExemptChargesSort;
  }
  /** Set the sort direction for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setLateExemptChargesSortDirection (boolean ascending) {
    this.LateExemptChargesSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getLateExemptChargesSortDirection () {
    return this.LateExemptChargesSortAscending;
  }
  /** Set the field level filters for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @param fetch whether to fetch this field or not
   */
  public void setCollectionIndicatorFetch (boolean fetch) {
    this.CollectionIndicatorFetch = fetch;
  }
  /** Retrieve Fetch value for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @return boolean the Fetch value for this field
   */
  public boolean getCollectionIndicatorFetch () {
    return this.CollectionIndicatorFetch;
  }
  /** Set the SortOrder for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getCollectionIndicatorSortOrder () {
    return this.CollectionIndicatorSort;
  }
  /** Set the sort direction for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setCollectionIndicatorSortDirection (boolean ascending) {
    this.CollectionIndicatorSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getCollectionIndicatorSortDirection () {
    return this.CollectionIndicatorSortAscending;
  }
  /** Set the field level filters for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @param fetch whether to fetch this field or not
   */
  public void setChgDateFetch (boolean fetch) {
    this.ChgDateFetch = fetch;
  }
  /** Retrieve Fetch value for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @return boolean the Fetch value for this field
   */
  public boolean getChgDateFetch () {
    return this.ChgDateFetch;
  }
  /** Set the SortOrder for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getChgDateSortOrder () {
    return this.ChgDateSort;
  }
  /** Set the sort direction for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setChgDateSortDirection (boolean ascending) {
    this.ChgDateSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getChgDateSortDirection () {
    return this.ChgDateSortAscending;
  }
  /** Set the field level filters for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @return DateFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @param fetch whether to fetch this field or not
   */
  public void setChgWhoFetch (boolean fetch) {
    this.ChgWhoFetch = fetch;
  }
  /** Retrieve Fetch value for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @return boolean the Fetch value for this field
   */
  public boolean getChgWhoFetch () {
    return this.ChgWhoFetch;
  }
  /** Set the SortOrder for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getChgWhoSortOrder () {
    return this.ChgWhoSort;
  }
  /** Set the sort direction for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setChgWhoSortDirection (boolean ascending) {
    this.ChgWhoSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getChgWhoSortDirection () {
    return this.ChgWhoSortAscending;
  }
  /** Set the case insensitive for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setChgWhoCaseInsensitive (boolean ascending) {
    this.ChgWhoCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getChgWhoCaseInsensitive () {
    return this.ChgWhoCaseInsensitive;
  }
  /** Set the field level filters for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @param fetch whether to fetch this field or not
   */
  public void setGlAmountFetch (boolean fetch) {
    this.GlAmountFetch = fetch;
  }
  /** Retrieve Fetch value for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @return boolean the Fetch value for this field
   */
  public boolean getGlAmountFetch () {
    return this.GlAmountFetch;
  }
  /** Set the SortOrder for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getGlAmountSortOrder () {
    return this.GlAmountSort;
  }
  /** Set the sort direction for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setGlAmountSortDirection (boolean ascending) {
    this.GlAmountSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getGlAmountSortDirection () {
    return this.GlAmountSortAscending;
  }
  /** Set the field level filters for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @param fetch whether to fetch this field or not
   */
  public void setRefinanceTrackingIdFetch (boolean fetch) {
    this.RefinanceTrackingIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getRefinanceTrackingIdFetch () {
    return this.RefinanceTrackingIdFetch;
  }
  /** Set the SortOrder for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setRefinanceTrackingIdSortOrder (Integer value) {
    this.RefinanceTrackingIdSort = value;
  }
  /** Retrieve SortOrder for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getRefinanceTrackingIdSortOrder () {
    return this.RefinanceTrackingIdSort;
  }
  /** Set the sort direction for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setRefinanceTrackingIdSortDirection (boolean ascending) {
    this.RefinanceTrackingIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getRefinanceTrackingIdSortDirection () {
    return this.RefinanceTrackingIdSortAscending;
  }
  /** Set the field level filters for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setRefinanceTrackingIdFilter (IntegerFilter[] value) throws ServiceException {
    this.RefinanceTrackingId = value;
  }
  /** Retrieve filter for field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @return IntegerFilter[] array of field level filters
   */
  public IntegerFilter[] getRefinanceTrackingIdFilter () {
    return this.RefinanceTrackingId;
  }

  /**
   * Retrieves the RefinanceTrackingIdFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The RefinanceTrackingIdFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the RefinanceTrackingIdFilter field
   */
  public String[] getRefinanceTrackingIdFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getRefinanceTrackingIdFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getRefinanceTrackingIdFilter(), _locale, false, false);
      if (formattedObjs != null) {
        formattedValues = new String[formattedObjs.length];
        for (int i=0; i<formattedObjs.length; i++) {
          formattedValues[i] = formattedObjs[i].toString();
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getRefinanceTrackingIdFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("RefinanceTrackingIdFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getRefinanceTrackingIdFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the RefinanceTrackingIdFilter filter value from a formatted string
   *
   * @param _value the RefinanceTrackingIdFilter filter value(s) in formatted form. If the requested
   *          output filter type is a type that contains a single data item, then a single
   *          String display value object must be specified. If the requested output filter type
   *          is a type that contains more than one data item (e.g. a Between Filter), then a
   *          Collection of String display value objects must be provided.
   * @param _filterType output filter type (see {@link FilterConversionHelper} fields for a list of valid values)
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the RefinanceTrackingIdFilter filter field
   */
  public void setRefinanceTrackingIdFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setRefinanceTrackingIdFilterFromFormattedString");
    try {
      this.setRefinanceTrackingIdFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("RefinanceTrackingIdFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setRefinanceTrackingIdFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setRefinanceTrackingIdFilterFromFormattedString");
  }

  /** Set the field level Fetch value for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @param fetch whether to fetch this field or not
   */
  public void setRefinanceTrackingIdServFetch (boolean fetch) {
    this.RefinanceTrackingIdServFetch = fetch;
  }
  /** Retrieve Fetch value for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @return boolean the Fetch value for this field
   */
  public boolean getRefinanceTrackingIdServFetch () {
    return this.RefinanceTrackingIdServFetch;
  }
  /** Set the SortOrder for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  public void setRefinanceTrackingIdServSortOrder (Integer value) {
    this.RefinanceTrackingIdServSort = value;
  }
  /** Retrieve SortOrder for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getRefinanceTrackingIdServSortOrder () {
    return this.RefinanceTrackingIdServSort;
  }
  /** Set the sort direction for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setRefinanceTrackingIdServSortDirection (boolean ascending) {
    this.RefinanceTrackingIdServSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getRefinanceTrackingIdServSortDirection () {
    return this.RefinanceTrackingIdServSortAscending;
  }
  /** Set the field level filters for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  public void setRefinanceTrackingIdServFilter (IntegerFilter[] value) throws ServiceException {
    this.RefinanceTrackingIdServ = value;
  }
  /** Retrieve filter for field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @return IntegerFilter[] array of field level filters
   */
  public IntegerFilter[] getRefinanceTrackingIdServFilter () {
    return this.RefinanceTrackingIdServ;
  }

  /**
   * Retrieves the RefinanceTrackingIdServFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The RefinanceTrackingIdServFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the RefinanceTrackingIdServFilter field
   */
  public String[] getRefinanceTrackingIdServFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getRefinanceTrackingIdServFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getRefinanceTrackingIdServFilter(), _locale, false, false);
      if (formattedObjs != null) {
        formattedValues = new String[formattedObjs.length];
        for (int i=0; i<formattedObjs.length; i++) {
          formattedValues[i] = formattedObjs[i].toString();
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getRefinanceTrackingIdServFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("RefinanceTrackingIdServFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getRefinanceTrackingIdServFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the RefinanceTrackingIdServFilter filter value from a formatted string
   *
   * @param _value the RefinanceTrackingIdServFilter filter value(s) in formatted form. If the requested
   *          output filter type is a type that contains a single data item, then a single
   *          String display value object must be specified. If the requested output filter type
   *          is a type that contains more than one data item (e.g. a Between Filter), then a
   *          Collection of String display value objects must be provided.
   * @param _filterType output filter type (see {@link FilterConversionHelper} fields for a list of valid values)
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the RefinanceTrackingIdServFilter filter field
   */
  public void setRefinanceTrackingIdServFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setRefinanceTrackingIdServFilterFromFormattedString");
    try {
      this.setRefinanceTrackingIdServFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("RefinanceTrackingIdServFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setRefinanceTrackingIdServFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setRefinanceTrackingIdServFilterFromFormattedString");
  }

  /** Set the field level Fetch value for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @param fetch whether to fetch this field or not
   */
  public void setExternalIdFetch (boolean fetch) {
    this.ExternalIdFetch = fetch;
  }
  /** Retrieve Fetch value for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @return boolean the Fetch value for this field
   */
  public boolean getExternalIdFetch () {
    return this.ExternalIdFetch;
  }
  /** Set the SortOrder for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getExternalIdSortOrder () {
    return this.ExternalIdSort;
  }
  /** Set the sort direction for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setExternalIdSortDirection (boolean ascending) {
    this.ExternalIdSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getExternalIdSortDirection () {
    return this.ExternalIdSortAscending;
  }
  /** Set the case insensitive for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @param ascending whether the sort for this field is case insensitive
   */
  public void setExternalIdCaseInsensitive (boolean ascending) {
    this.ExternalIdCaseInsensitive = ascending;
  }
  /** Retrieve CaseInsensitive for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @return boolean whether the field is CaseInsensitive
   */
  public boolean getExternalIdCaseInsensitive () {
    return this.ExternalIdCaseInsensitive;
  }
  /** Set the field level filters for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @return StringFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: Converted (CMF_BALANCE_DETAIL.converted)
   * @param fetch whether to fetch this field or not
   */
  public void setConvertedFetch (boolean fetch) {
    this.ConvertedFetch = fetch;
  }
  /** Retrieve Fetch value for field: Converted (CMF_BALANCE_DETAIL.converted)
   * @return boolean the Fetch value for this field
   */
  public boolean getConvertedFetch () {
    return this.ConvertedFetch;
  }
  /** Set the SortOrder for field: Converted (CMF_BALANCE_DETAIL.converted)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: Converted (CMF_BALANCE_DETAIL.converted)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getConvertedSortOrder () {
    return this.ConvertedSort;
  }
  /** Set the sort direction for field: Converted (CMF_BALANCE_DETAIL.converted)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setConvertedSortDirection (boolean ascending) {
    this.ConvertedSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: Converted (CMF_BALANCE_DETAIL.converted)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getConvertedSortDirection () {
    return this.ConvertedSortAscending;
  }
  /** Set the field level filters for field: Converted (CMF_BALANCE_DETAIL.converted)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: Converted (CMF_BALANCE_DETAIL.converted)
   * @return IntegerFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @param fetch whether to fetch this field or not
   */
  public void setNewChargeCreditsFetch (boolean fetch) {
    this.NewChargeCreditsFetch = fetch;
  }
  /** Retrieve Fetch value for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @return boolean the Fetch value for this field
   */
  public boolean getNewChargeCreditsFetch () {
    return this.NewChargeCreditsFetch;
  }
  /** Set the SortOrder for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getNewChargeCreditsSortOrder () {
    return this.NewChargeCreditsSort;
  }
  /** Set the sort direction for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setNewChargeCreditsSortDirection (boolean ascending) {
    this.NewChargeCreditsSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getNewChargeCreditsSortDirection () {
    return this.NewChargeCreditsSortAscending;
  }
  /** Set the field level filters for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @return BigIntegerFilter[] array of field level filters
   */
  ...
  public String toString() {
    return BalanceLineItemObjectHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return BalanceLineItemObjectHelper.toMap(this, null);
  }
}
