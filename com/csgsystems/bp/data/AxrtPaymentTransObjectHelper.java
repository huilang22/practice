 ...
 * Generated  File: AxrtPaymentTransObjectHelper.java
...
/** Helper class to convert AxrtPaymentTransObject JavaBean objects to/from HashMaps.
 */
public class AxrtPaymentTransObjectHelper implements ArubaObjectHelper
{
  /** convert AxrtPaymentTransObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (AxrtPaymentTransObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AxrtPaymentTransObjectData in, Map record, String rootName)
  {
  ...
  /** convert AxrtPaymentTransObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (AxrtPaymentTransObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert AxrtPaymentTransObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AxrtPaymentTransObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "AxrtPaymentTransObject";
  ...
  /** convert Map to AxrtPaymentTransObjectData.
   * @param record the Map containing the data to convert to the object
   * @return AxrtPaymentTransObjectData the converted object
   */
  public static AxrtPaymentTransObjectData fromMap (Map record)
  {
   ...
   * @return AxrtPaymentTransObjectData the converted object
   */
  public static AxrtPaymentTransObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to AxrtPaymentTransObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return AxrtPaymentTransObjectFilter the converted object
   */
  public static AxrtPaymentTransObjectFilter fromMapFilter (Map record) {
   ...
   * @return AxrtPaymentTransObjectFilter the converted object
   */
  public static AxrtPaymentTransObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "AxrtPaymentTransObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to AxrtPaymentTransObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return AxrtPaymentTransObjectDataList the converted object
   */
  public static AxrtPaymentTransObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to AxrtPaymentTransObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "AxrtPaymentTransObjectList")
   * @return AxrtPaymentTransObjectDataList the converted object
   */
  public static AxrtPaymentTransObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "AxrtPaymentTransObjectList";
    Object[] root = (Object[]) record.get (rootName);
    AxrtPaymentTransObjectData[] array = null;
    if (root != null)
    {
      array = new AxrtPaymentTransObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = AxrtPaymentTransObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new AxrtPaymentTransObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new AxrtPaymentTransObjectDataList (array, index, total);
  }
  /** convert AxrtPaymentTransObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AxrtPaymentTransObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", AxrtPaymentTransObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert AxrtPaymentTransObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AxrtPaymentTransObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return AxrtPaymentTransObjectData the converted object
   */
  public static AxrtPaymentTransObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AxrtPaymentTransObjectData out = new AxrtPaymentTransObjectData ();

    out.Key = AxrtPaymentTransObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return AxrtPaymentTransObjectFilter the converted object
   */
  public static AxrtPaymentTransObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AxrtPaymentTransObjectFilter out = new AxrtPaymentTransObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = AxrtPaymentTransObjectKeyHelper.getFilter ((Map) record.get ("Key"));
