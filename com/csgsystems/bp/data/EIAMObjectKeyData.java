 ...
 * Generated  File: EIAMObjectKeyData.java
...
/** EIAMObject's Key Data class. */
public class EIAMObjectKeyData  extends BaseObjectData
{
  /** EXTERNAL_ID_ACCT_MAP.account_no field */
  ...
  private String _objName = "EIAMObjectKeyData";
  /** default constructor */
  public EIAMObjectKeyData ()
  {
  }
  /** copy constructor
   * @param other the object to copy
   */
  public EIAMObjectKeyData (EIAMObjectKeyData other)
  {
  ...
  /** set the fields value: AccountInternalId (EXTERNAL_ID_ACCT_MAP.account_no)
  ...
  /** get the value of the field: AccountInternalId (EXTERNAL_ID_ACCT_MAP.account_no)
   * @return Integer the value
   */
  public Integer getAccountInternalId () {
    return this.AccountInternalId;
  }
  /** Change the field to not being actively set: AccountInternalId (EXTERNAL_ID_ACCT_MAP.account_no)
   */
  public void unsetAccountInternalId () {
    this._AccountInternalIdSet = false;
  }
  /** See if the field is actively set: AccountInternalId (EXTERNAL_ID_ACCT_MAP.account_no)
  ...
  public String toString() {
    return EIAMObjectKeyHelper.toMap(this, null).toString();
  }
  public Map toMap() {
