 ...
 * Generated  File: BalanceLineItemObjectHelper.java
...
/** Helper class to convert BalanceLineItemObject JavaBean objects to/from HashMaps.
 */
public class BalanceLineItemObjectHelper implements ArubaObjectHelper
{
  /** convert BalanceLineItemObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (BalanceLineItemObjectData in, Map record)
  {
   ...
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @param rootName use this name as the root name for the object (defaults to "BalanceLineItemObject")
   * @return Map     the output Map
   */
  public static Map toMap (BalanceLineItemObjectData in, Map record, String rootName)
  {
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BalanceLineItemObject";
    Map map = getMap (in, (Map) record.get (rootName));
    record.put (rootName, map);
    return record;
  }
  /** convert BalanceLineItemObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BalanceLineItemObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BalanceLineItemObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BalanceLineItemObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BalanceLineItemObject";
  ...
  /** convert Map to BalanceLineItemObjectData.
   * @param record the Map containing the data to convert to the object
   * @return BalanceLineItemObjectData the converted object
   */
  public static BalanceLineItemObjectData fromMap (Map record)
  {
    return fromMap (record, null);
  }
  /** convert Map to BalanceLineItemObjectData.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the mape (defaults to "BalanceLineItemObject")
   * @return BalanceLineItemObjectData the converted object
   */
  public static BalanceLineItemObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BalanceLineItemObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return BalanceLineItemObjectFilter the converted object
   */
  public static BalanceLineItemObjectFilter fromMapFilter (Map record) {
    return fromMapFilter (record, null);
  }
  /** convert Map to BalanceLineItemObjectFilter.
   * @param record   the Map containing the data to convert to the object
   * @param rootName the root name of the object in the map (defaults to "BalanceLineItemObject")
   * @return BalanceLineItemObjectFilter the converted object
   */
  public static BalanceLineItemObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BalanceLineItemObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to BalanceLineItemObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return BalanceLineItemObjectDataList the converted object
   */
  public static BalanceLineItemObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to BalanceLineItemObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "BalanceLineItemObjectList")
   * @return BalanceLineItemObjectDataList the converted object
   */
  public static BalanceLineItemObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "BalanceLineItemObjectList";
    Object[] root = (Object[]) record.get (rootName);
    BalanceLineItemObjectData[] array = null;
    if (root != null)
    {
      array = new BalanceLineItemObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = BalanceLineItemObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new BalanceLineItemObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new BalanceLineItemObjectDataList (array, index, total);
  }
  /** convert BalanceLineItemObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BalanceLineItemObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", BalanceLineItemObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
    ...
    if (in._OrigPpddDateSet) record.put ("OrigPpddDate", in.OrigPpddDate);
    ...
    if (in._RefinanceTrackingIdSet) record.put ("RefinanceTrackingId", in.RefinanceTrackingId);
  
    if (in._RefinanceTrackingIdServSet) record.put ("RefinanceTrackingIdServ", in.RefinanceTrackingIdServ);
  ...
  /** convert BalanceLineItemObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (BalanceLineItemObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
    ...
    if (in.Key != null) record.put ("Key", BalanceLineItemObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
      ...
      map = DataHelper.filterToMap (in.OrigPpddDate, in.OrigPpddDateSort, in.OrigPpddDateSortAscending, in.OrigPpddDateFetch);
      if (map != null) record.put ("OrigPpddDate", map);
      ...
      map = DataHelper.filterToMap (in.RefinanceTrackingId, in.RefinanceTrackingIdSort, in.RefinanceTrackingIdSortAscending, in.RefinanceTrackingIdFetch);
      if (map != null) record.put ("RefinanceTrackingId", map);
      map = DataHelper.filterToMap (in.RefinanceTrackingIdServ, in.RefinanceTrackingIdServSort, in.RefinanceTrackingIdServSortAscending, in.RefinanceTrackingIdServFetch);
      if (map != null) record.put ("RefinanceTrackingIdServ", map);
   ...
   * @return BalanceLineItemObjectData the converted object
   */
  public static BalanceLineItemObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BalanceLineItemObjectData out = new BalanceLineItemObjectData ();

    out.Key = BalanceLineItemObjectKeyHelper.getObj ((Map) record.get ("Key"));
    ...
    if ((obj = record.get ("OrigPpddDate")) != null)
    {
      out.OrigPpddDate = (Date) obj;
    }
    ...
    if ((obj = record.get ("RefinanceTrackingId")) != null)
    {
      out.RefinanceTrackingId = (Integer) obj;
    }
  
    if ((obj = record.get ("RefinanceTrackingIdServ")) != null)
    {
      out.RefinanceTrackingIdServ = (Integer) obj;
    }
   ...
   * @return BalanceLineItemObjectFilter the converted object
   */
  public static BalanceLineItemObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BalanceLineItemObjectFilter out = new BalanceLineItemObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = BalanceLineItemObjectKeyHelper.getFilter ((Map) record.get ("Key"));
    ...
    Map OrigPpddDateMap = (Map)record.get("OrigPpddDate");
    Boolean OrigPpddDateFetch = DataHelper.getFetch(OrigPpddDateMap);
    Boolean OrigPpddDateSortDir = DataHelper.getSortDirection(OrigPpddDateMap);
    Integer OrigPpddDateSortOrder = DataHelper.getSortOrder(OrigPpddDateMap);
    if (OrigPpddDateFetch != null) out.setOrigPpddDateFetch(OrigPpddDateFetch);
    if (OrigPpddDateSortDir != null) out.setOrigPpddDateSortDirection(OrigPpddDateSortDir);
    if (OrigPpddDateSortOrder != null) out.setOrigPpddDateSortOrder(OrigPpddDateSortOrder);

    Filter[] OrigPpddDateFilter = DataHelper.mapToFilterArray(OrigPpddDateMap, Date.class);
    if (OrigPpddDateFilter != null) {
      DateFilter[] OrigPpddDateFilters = new DateFilter[OrigPpddDateFilter.length];
      for (int i = 0; i < OrigPpddDateFilters.length; i++) {
        OrigPpddDateFilters[i] = (DateFilter)OrigPpddDateFilter[i];
      }
      try {
        out.setOrigPpddDateFilter(OrigPpddDateFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
    ...
    Map RefinanceTrackingIdMap = (Map)record.get("RefinanceTrackingId");
    Boolean RefinanceTrackingIdFetch = DataHelper.getFetch(RefinanceTrackingIdMap);
    Boolean RefinanceTrackingIdSortDir = DataHelper.getSortDirection(RefinanceTrackingIdMap);
    Integer RefinanceTrackingIdSortOrder = DataHelper.getSortOrder(RefinanceTrackingIdMap);
    if (RefinanceTrackingIdFetch != null) out.setRefinanceTrackingIdFetch(RefinanceTrackingIdFetch);
    if (RefinanceTrackingIdSortDir != null) out.setRefinanceTrackingIdSortDirection(RefinanceTrackingIdSortDir);
    if (RefinanceTrackingIdSortOrder != null) out.setRefinanceTrackingIdSortOrder(RefinanceTrackingIdSortOrder);

    Filter[] RefinanceTrackingIdFilter = DataHelper.mapToFilterArray(RefinanceTrackingIdMap, Integer.class);
    if (RefinanceTrackingIdFilter != null) {
      IntegerFilter[] RefinanceTrackingIdFilters = new IntegerFilter[RefinanceTrackingIdFilter.length];
      for (int i = 0; i < RefinanceTrackingIdFilters.length; i++) {
        RefinanceTrackingIdFilters[i] = (IntegerFilter)RefinanceTrackingIdFilter[i];
      }
      try {
        out.setRefinanceTrackingIdFilter(RefinanceTrackingIdFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
  
    Map RefinanceTrackingIdServMap = (Map)record.get("RefinanceTrackingIdServ");
    Boolean RefinanceTrackingIdServFetch = DataHelper.getFetch(RefinanceTrackingIdServMap);
    Boolean RefinanceTrackingIdServSortDir = DataHelper.getSortDirection(RefinanceTrackingIdServMap);
    Integer RefinanceTrackingIdServSortOrder = DataHelper.getSortOrder(RefinanceTrackingIdServMap);
    if (RefinanceTrackingIdServFetch != null) out.setRefinanceTrackingIdServFetch(RefinanceTrackingIdServFetch);
    if (RefinanceTrackingIdServSortDir != null) out.setRefinanceTrackingIdServSortDirection(RefinanceTrackingIdServSortDir);
    if (RefinanceTrackingIdServSortOrder != null) out.setRefinanceTrackingIdServSortOrder(RefinanceTrackingIdServSortOrder);

    Filter[] RefinanceTrackingIdServFilter = DataHelper.mapToFilterArray(RefinanceTrackingIdServMap, Integer.class);
    if (RefinanceTrackingIdServFilter != null) {
      IntegerFilter[] RefinanceTrackingIdServFilters = new IntegerFilter[RefinanceTrackingIdServFilter.length];
      for (int i = 0; i < RefinanceTrackingIdServFilters.length; i++) {
        RefinanceTrackingIdServFilters[i] = (IntegerFilter)RefinanceTrackingIdServFilter[i];
      }
      try {
        out.setRefinanceTrackingIdServFilter(RefinanceTrackingIdServFilters);
      } catch (Exception x) {
        x.printStackTrace();
      }
    }
