 ...
 * Generated  File: TransferReasonObjectKeyFilter.java
...
/** Key Filter for TransferReasonObject object. */
public class TransferReasonObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: XFER_REASON_CODES_VALUES.xfer_reason) */
  public    IntegerFilter[] XferReason  = null;
  protected boolean XferReasonFetch = false;
  protected boolean XferReasonSortAscending = true;
  protected Integer XferReasonSort = null;
  /** raw field for: XFER_REASON_CODES_VALUES.language_code) */
  ...
  private String _objName = "TransferReasonObjectKeyFilter";
  /** default constructor */
  public TransferReasonObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public TransferReasonObjectKeyFilter (TransferReasonObjectKeyFilter other)
  {
    if (other == null) return;
    this.XferReason = other.XferReason;
    this.XferReasonFetch = other.XferReasonFetch;
    this.XferReasonSort = other.XferReasonSort;
    this.XferReasonSortAscending = other.XferReasonSortAscending;
  ...
  public void setXferReasonSortDirection (boolean ascending) {
    this.XferReasonSortAscending = ascending;
  }
  ...
  public boolean getXferReasonSortDirection () {
    return this.XferReasonSortAscending;
  }
  ...
  /**
   * Retrieves the XferReasonFilter filter value as a formatted string
   *
   * @param _locale locale settings used to format text based display values
   * @return The XferReasonFilter filter value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the XferReasonFilter field
   */
  public String[] getXferReasonFilterAsFormattedString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getXferReasonFilterAsFormattedString");
    try {
      String[] formattedValues = null;
      Object[] formattedObjs = FilterConversionHelper.format(this.getXferReasonFilter(), _locale, false, false);
      ...
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getXferReasonFilterAsFormattedString");
      return formattedValues;
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("XferReasonFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getXferReasonFilterAsFormattedString");
      throw excp;
    }
  }
  /**
   * Sets the XferReasonFilter filter value from a formatted string
   *
   * @param _value the XferReasonFilter filter value(s) in formatted form. If the requested
   ...
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if invalid data is set in the XferReasonFilter filter field
   */
  public void setXferReasonFilterFromFormattedString(String[] _value, String[] _filterType, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setXferReasonFilterFromFormattedString");
    try {
      this.setXferReasonFilter((IntegerFilter[])(FilterConversionHelper.parse(_value, _filterType, _locale, false, false)));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("XferReasonFilter");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setXferReasonFilterFromFormattedString");
      throw excp;
    }
    if (Logger.TRACE) Logger.traceExit(this.getClass(), "setXferReasonFilterFromFormattedString");
  }
  ...
  public Map toMap() {
    return TransferReasonObjectKeyHelper.toMap(this, null);
  }
}
