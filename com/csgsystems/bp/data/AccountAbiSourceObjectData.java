 ...
 * Generated  File: AccountAbiSourceObjectData.java
...
/** AccountAbiSourceObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class AccountAbiSourceObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public AccountAbiSourceObjectKeyData Key = null;
  ...
  /** CMF_ABI_SOURCES.inactive_dt field */
  public    Date InactiveDt  = null;
  protected boolean _InactiveDtSet = false;
  private String _objName = "AccountAbiSourceObjectData";
  /** Default constructor */
  public AccountAbiSourceObjectData ()
  {
    super ();
   ...
   */
  public AccountAbiSourceObjectData (AccountAbiSourceObjectData other)
  {

    if (other == null) return;
    this.Key = new AccountAbiSourceObjectKeyData (other.Key);
   ...
   * @return AccountAbiSourceObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public AccountAbiSourceObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (AccountAbiSourceObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setSourceId (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new AccountAbiSourceObjectKeyData ();
  ...
  /** set the fields value: InactiveDt (CMF_ABI_SOURCES.inactive_dt)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: InactiveDt (CMF_ABI_SOURCES.inactive_dt)
   * @return Date the value
   */
  public Date getInactiveDt () {
    return this.InactiveDt;
  }
  /** Change the field to not being actively set: InactiveDt (CMF_ABI_SOURCES.inactive_dt)
   */
  public void unsetInactiveDt () {
    this._InactiveDtSet = false;
  }
  /** See if the field is actively set: InactiveDt (CMF_ABI_SOURCES.inactive_dt)
   * @return boolean whether the field is actively set
   */
