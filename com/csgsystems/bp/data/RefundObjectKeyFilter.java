 ...
 * Generated  File: RefundObjectKeyFilter.java
...
/** Key Filter for RefundObject object. */
public class RefundObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: REFUND.tracking_id) */
  ...
  /** raw field for: REFUND.tracking_id_serv) */
  ...
  private String _objName = "RefundObjectKeyFilter";
  /** default constructor */
  public RefundObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public RefundObjectKeyFilter (RefundObjectKeyFilter other)
  {
  ...
  public String toString() {
    return RefundObjectKeyHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return RefundObjectKeyHelper.toMap(this, null);
  }
}
