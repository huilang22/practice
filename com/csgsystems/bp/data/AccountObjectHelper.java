 ...
 * Generated  File: AccountObjectHelper.java
...
/** Helper class to convert AccountObject JavaBean objects to/from HashMaps.
 */
public class AccountObjectHelper implements ArubaObjectHelper
{
  /** convert AccountObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (AccountObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AccountObjectData in, Map record, String rootName)
  {
  ...
  /** convert AccountObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (AccountObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert AccountObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (AccountObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "AccountObject";
  ...
  /** convert Map to AccountObjectData.
   * @param record the Map containing the data to convert to the object
   * @return AccountObjectData the converted object
   */
  public static AccountObjectData fromMap (Map record)
  {
   ...
   * @return AccountObjectData the converted object
   */
  public static AccountObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to AccountObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return AccountObjectFilter the converted object
   */
  public static AccountObjectFilter fromMapFilter (Map record) {
   ...
   * @return AccountObjectFilter the converted object
   */
  public static AccountObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "AccountObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to AccountObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return AccountObjectDataList the converted object
   */
  public static AccountObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to AccountObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "AccountObjectList")
   * @return AccountObjectDataList the converted object
   */
  public static AccountObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "AccountObjectList";
    Object[] root = (Object[]) record.get (rootName);
    AccountObjectData[] array = null;
    if (root != null)
    {
      array = new AccountObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = AccountObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new AccountObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new AccountObjectDataList (array, index, total);
  }
  /** convert AccountObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AccountObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", AccountObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert AccountObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (AccountObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
    ...
    if (in.Key != null) record.put ("Key", AccountObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
      ...
      if (map != null) record.put ("AutoWriteoffStatus", map);    if (in.extendedDataFilter != null && in.extendedDataFilter.size () > 0)
    {
   ...
   * @return AccountObjectData the converted object
   */
  public static AccountObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AccountObjectData out = new AccountObjectData ();

    out.Key = AccountObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return AccountObjectFilter the converted object
   */
  public static AccountObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    AccountObjectFilter out = new AccountObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = AccountObjectKeyHelper.getFilter ((Map) record.get ("Key"));
