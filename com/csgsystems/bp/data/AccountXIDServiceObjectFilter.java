 ...
 * Generated  File: AccountXIDServiceObjectFilter.java
...
/** Filter object */
public class AccountXIDServiceObjectFilter extends AccountObjectFilter  implements Serializable
{
  ...
  /** raw field for: CUSTOMER_ID_EQUIP_MAP_VIEW.active_date) */
  ...
  /** raw field for: CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date) */
  ...
  private String _objName = "AccountXIDServiceObjectFilter";
  /** default constructor */
  public AccountXIDServiceObjectFilter ()
  {
    super ();
  }
  /** copy constructor
   ...
   */
  public AccountXIDServiceObjectFilter (AccountXIDServiceObjectFilter other)
  {
    super (other);
  ...
  /** Set the field level Fetch value for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * @param fetch whether to fetch this field or not
   */
  public void setServiceIdActiveDateFetch (boolean fetch) {
    this.ServiceIdActiveDateFetch = fetch;
  }
  /** Retrieve Fetch value for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * @return boolean the Fetch value for this field
   */
  public boolean getServiceIdActiveDateFetch () {
    return this.ServiceIdActiveDateFetch;
  }
  /** Set the SortOrder for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getServiceIdActiveDateSortOrder () {
    return this.ServiceIdActiveDateSort;
  }
  /** Set the sort direction for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setServiceIdActiveDateSortDirection (boolean ascending) {
    this.ServiceIdActiveDateSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getServiceIdActiveDateSortDirection () {
    return this.ServiceIdActiveDateSortAscending;
  }
  /** Set the field level filters for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ServiceIdActiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.active_date)
   * @return DateFilter[] array of field level filters
   */
  ...
  /** Set the field level Fetch value for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * @param fetch whether to fetch this field or not
   */
  public void setServiceIdInactiveDateFetch (boolean fetch) {
    this.ServiceIdInactiveDateFetch = fetch;
  }
  /** Retrieve Fetch value for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * @return boolean the Fetch value for this field
   */
  public boolean getServiceIdInactiveDateFetch () {
    return this.ServiceIdInactiveDateFetch;
  }
  /** Set the SortOrder for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * Sort Orders must be all represented for a filter, and start at 0 (ie: all values from 0-MAX(SortOrder) must be set).
   * @param value integer precedent of this field's sort order
   */
  ...
  /** Retrieve SortOrder for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * @return Integer the sort order, if set, for the field
   */
  public Integer getServiceIdInactiveDateSortOrder () {
    return this.ServiceIdInactiveDateSort;
  }
  /** Set the sort direction for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * @param ascending whether the sort for this field is ascending (false is descending)
   */
  public void setServiceIdInactiveDateSortDirection (boolean ascending) {
    this.ServiceIdInactiveDateSortAscending = ascending;
  }
  /** Retrieve SortDirection for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * @return boolean whether the SortDirection is Ascending
   */
  public boolean getServiceIdInactiveDateSortDirection () {
    return this.ServiceIdInactiveDateSortAscending;
  }
  /** Set the field level filters for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * If there is more than one entry in the array, they will all be OR'ed together.
   * It is not valid to have more than one of any type of filter in the array (ie: may only have one EqualsFilter, or one InFilter, but may have both).
   * @param value array of filters for this field.
   */
  ...
  /** Retrieve filter for field: ServiceIdInactiveDate (CUSTOMER_ID_EQUIP_MAP_VIEW.inactive_date)
   * @return DateFilter[] array of field level filters
   */
   ...
   */
  public AccountXIDServiceObjectFilter (AccountObjectFilter other)
  {
    super (other);
  ...
  public Map toMap() {
    return AccountXIDServiceObjectHelper.toMap(this, null);
  }
}
