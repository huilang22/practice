 ...
 * Generated  File: BillImagePageObjectKeyHelper.java
...
/** Helper class for BillImagePageObject's Key objects. */
public class BillImagePageObjectKeyHelper implements ArubaObjectHelper
{
  /** convert BillImagePageObjectKeyData to a Map.
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BillImagePageObjectKeyData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillImagePageObjectKeyData in, Map record, String rootName)
  {
  ...
  /** convert BillImagePageObjectKeyFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (BillImagePageObjectKeyFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert BillImagePageObjectKeyFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (BillImagePageObjectKeyFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "BillImagePageObject";
  ...
  /** convert Map to BillImagePageObjectKeyData.
   * @param record   the Map containing the data to convert to the object
   * @return BillImagePageObjectKeyData the converted object
   */
  public static BillImagePageObjectKeyData fromMap (Map record)
  {
   ...
   * @return BillImagePageObjectKeyData the converted object
   */
  public static BillImagePageObjectKeyData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to BillImagePageObjectKeyFilter.
   * @param record   the Map containing the data to convert to the object
   * @return BillImagePageObjectKeyFilter the converted object
   */
  public static BillImagePageObjectKeyFilter fromMapFilter (Map record) {
   ...
   * @return BillImagePageObjectKeyFilter the converted object
   */
  public static BillImagePageObjectKeyFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "BillImagePageObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert BillImagePageObjectKeyData to a Map (not including the root).
  /** convert BillImagePageObjectKeyData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  protected static Map getMap (BillImagePageObjectKeyData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
  ...
  /** convert BillImagePageObjectKeyFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  protected static Map getMap (BillImagePageObjectKeyFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return BillImagePageObjectKeyData the converted object
   */
  public static BillImagePageObjectKeyData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillImagePageObjectKeyData out = new BillImagePageObjectKeyData ();
   ...
   * @return BillImagePageObjectKeyFilter the converted object
   */
  public static BillImagePageObjectKeyFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    BillImagePageObjectKeyFilter out = new BillImagePageObjectKeyFilter ();
