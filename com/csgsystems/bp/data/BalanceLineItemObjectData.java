 ...
 * Generated  File: BalanceLineItemObjectData.java
...
/** BalanceLineItemObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class BalanceLineItemObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public BalanceLineItemObjectKeyData Key = null;
  ...
  private String _objName = "BalanceLineItemObjectData";
  /** Default constructor */
  public BalanceLineItemObjectData ()
  {
    super ();
   ...
   */
  public BalanceLineItemObjectData (BalanceLineItemObjectData other)
  {

    if (other == null) return;
    this.Key = new BalanceLineItemObjectKeyData (other.Key);
    ...
    this._OrigPpddDateSet = other._OrigPpddDateSet;
    ...
    this._RefinanceTrackingIdSet = other._RefinanceTrackingIdSet;
    this.RefinanceTrackingIdServ = other.RefinanceTrackingIdServ;
    this._RefinanceTrackingIdServSet = other._RefinanceTrackingIdServSet;
   ...
   * @return BalanceLineItemObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public BalanceLineItemObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (BalanceLineItemObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setAccountInternalId (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new BalanceLineItemObjectKeyData ();
  ...
  public Enumeration getOpenItemIdEnumeration(Locale _locale) throws ServiceException {
    ...
    try {
      ...
      Enumeration enumeration = enumMgr.getEnumeration("OpenItem", _locale, null, false);
  ...
  /** set the fields value: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @return Integer the value
   */
  public Integer getCurrencyCode () {
    return this.CurrencyCode;
  }
  /** Change the field to not being actively set: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   */
  public void unsetCurrencyCode () {
    this._CurrencyCodeSet = false;
  }
  /** See if the field is actively set: CurrencyCode (CMF_BALANCE_DETAIL.currency_code)
   * @return boolean whether the field is actively set
   */
  public boolean issetCurrencyCode () {
    return this._CurrencyCodeSet;
  }
  /** set the fields value: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("PpddDate") 
  ...
  /** get the value of the field: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @return Date the value
   */
  public Date getPpddDate () {
    return this.PpddDate;
  }
  /** Change the field to not being actively set: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   */
  public void unsetPpddDate () {
    this._PpddDateSet = false;
  }
  /** See if the field is actively set: PpddDate (CMF_BALANCE_DETAIL.ppdd_date)
   * @return boolean whether the field is actively set
   */
  public boolean issetPpddDate () {
    return this._PpddDateSet;
  }
  /** set the fields value: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("OrigPpddDate") 
  public void setOrigPpddDate (Date value) throws ServiceException
  {
    this.OrigPpddDate = value;
    this._OrigPpddDateSet = true;
  }

  /** Retrieves the OrigPpddDate field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The OrigPpddDate field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the OrigPpddDate field
   */
   public String getOrigPpddDateAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getOrigPpddDateAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getOrigPpddDateAsFormattedString");
       return fmtMgr.formatDate(this.getOrigPpddDate(), _locale);
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("OrigPpddDate");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getOrigPpddDateAsFormattedString");
       throw x;
     }
   }
  /** Sets the OrigPpddDate field from a formatted string
   *
   * @param _value the OrigPpddDate field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the OrigPpddDate field
   */
   public void setOrigPpddDateFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getOrigPpddDateFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setOrigPpddDate(fmtMgr.parseDate(_value, _locale));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("OrigPpddDate");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setOrigPpddDateFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setOrigPpddDateFromFormattedString");
   }

  /**
   * Retrieves the OrigPpddDate field value as a formatted date/time string
   *
   * @param _locale locale settings used to format text based display values
   * @return The OrigPpddDate field value in formatted date/time form
   * @throws ServiceException thrown if an error occurs formatting the data for the OrigPpddDate field
   */
  public String getOrigPpddDateAsFormattedDateTimeString(Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getOrigPpddDateAsFormattedDateTimeString");
    try {
      FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
      if (Logger.TRACE) Logger.traceExit(this.getClass(), "getOrigPpddDateAsFormattedDateTimeString");
      return fmtMgr.formatDateTime(this.getOrigPpddDate(), _locale);
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("OrigPpddDate");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "getOrigPpddDateAsFormattedDateTimeString");
      throw excp;
    }
  }
  /**
   * Sets the OrigPpddDate field value from a formatted date/time string
   *
   * @param _value the OrigPpddDate field value in formatted date/time form
   * @param _locale locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the OrigPpddDate field
   */
  public void setOrigPpddDateFromFormattedDateTimeString(String _value, Locale _locale) throws ServiceException {
    if (Logger.TRACE) Logger.traceEntry(this.getClass(), "setOrigPpddDateFromFormattedDateTimeString");
    try {
      FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
      this.setOrigPpddDate(fmtMgr.parseDateTime(_value, _locale));
    } catch (ServiceException excp) {
      excp.setErrorObjectName(this.getClass().getName());
      excp.setErrorObjectFieldName("OrigPpddDate");
      if (Logger.TRACE) Logger.traceError(this.getClass(), "setOrigPpddDateFromFormattedDateTimeString");
      throw excp;
    }
  }

  /** get the value of the field: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @return Date the value
   */
  public Date getOrigPpddDate () {
    return this.OrigPpddDate;
  }
  /** Change the field to not being actively set: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   */
  public void unsetOrigPpddDate () {
    this._OrigPpddDateSet = false;
  }
  /** See if the field is actively set: OrigPpddDate (CMF_BALANCE_DETAIL.orig_ppdd_date)
   * @return boolean whether the field is actively set
   */
  public boolean issetOrigPpddDate () {
    return this._OrigPpddDateSet;
  }
  /** set the fields value: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @return Date the value
   */
  public Date getClosedDate () {
    return this.ClosedDate;
  }
  /** Change the field to not being actively set: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   */
  public void unsetClosedDate () {
    this._ClosedDateSet = false;
  }
  /** See if the field is actively set: ClosedDate (CMF_BALANCE_DETAIL.closed_date)
   * @return boolean whether the field is actively set
   */
  public boolean issetClosedDate () {
    return this._ClosedDateSet;
  }
  /** set the fields value: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @return BigInteger the value
   */
  public BigInteger getNewCharges () {
    return this.NewCharges;
  }
  /** Change the field to not being actively set: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   */
  public void unsetNewCharges () {
    this._NewChargesSet = false;
  }
  /** See if the field is actively set: NewCharges (CMF_BALANCE_DETAIL.new_charges)
   * @return boolean whether the field is actively set
   */
  public boolean issetNewCharges () {
    return this._NewChargesSet;
  }
  /** set the fields value: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @return BigInteger the value
   */
  public BigInteger getNetNewCharges () {
    return this.NetNewCharges;
  }
  /** Change the field to not being actively set: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   */
  public void unsetNetNewCharges () {
    this._NetNewChargesSet = false;
  }
  /** See if the field is actively set: NetNewCharges (CMF_BALANCE_DETAIL.net_new_charges)
   * @return boolean whether the field is actively set
   */
  public boolean issetNetNewCharges () {
    return this._NetNewChargesSet;
  }
  /** set the fields value: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("TotalDue") 
  ...
  /** get the value of the field: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @return BigInteger the value
   */
  public BigInteger getTotalDue () {
    return this.TotalDue;
  }
  /** Change the field to not being actively set: TotalDue (CMF_BALANCE_DETAIL.total_due)
   */
  public void unsetTotalDue () {
    this._TotalDueSet = false;
  }
  /** See if the field is actively set: TotalDue (CMF_BALANCE_DETAIL.total_due)
   * @return boolean whether the field is actively set
   */
  public boolean issetTotalDue () {
    return this._TotalDueSet;
  }
  /** set the fields value: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("TotalAdj") 
  ...
  /** get the value of the field: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @return BigInteger the value
   */
  public BigInteger getTotalAdj () {
    return this.TotalAdj;
  }
  /** Change the field to not being actively set: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   */
  public void unsetTotalAdj () {
    this._TotalAdjSet = false;
  }
  /** See if the field is actively set: TotalAdj (CMF_BALANCE_DETAIL.total_adj)
   * @return boolean whether the field is actively set
   */
  public boolean issetTotalAdj () {
    return this._TotalAdjSet;
  }
  /** set the fields value: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @return BigInteger the value
   */
  public BigInteger getTotalPaid () {
    return this.TotalPaid;
  }
  /** Change the field to not being actively set: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   */
  public void unsetTotalPaid () {
    this._TotalPaidSet = false;
  }
  /** See if the field is actively set: TotalPaid (CMF_BALANCE_DETAIL.total_paid)
   * @return boolean whether the field is actively set
   */
  public boolean issetTotalPaid () {
    return this._TotalPaidSet;
  }
  /** set the fields value: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @return BigInteger the value
   */
  public BigInteger getBalanceDue () {
    return this.BalanceDue;
  }
  /** Change the field to not being actively set: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   */
  public void unsetBalanceDue () {
    this._BalanceDueSet = false;
  }
  /** See if the field is actively set: BalanceDue (CMF_BALANCE_DETAIL.balance_due)
   * @return boolean whether the field is actively set
   */
  public boolean issetBalanceDue () {
    return this._BalanceDueSet;
  }
  /** set the fields value: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @return BigInteger the value
   */
  public BigInteger getDisputeAmt () {
    return this.DisputeAmt;
  }
  /** Change the field to not being actively set: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   */
  public void unsetDisputeAmt () {
    this._DisputeAmtSet = false;
  }
  /** See if the field is actively set: DisputeAmt (CMF_BALANCE_DETAIL.dispute_amt)
   * @return boolean whether the field is actively set
   */
  public boolean issetDisputeAmt () {
    return this._DisputeAmtSet;
  }
  /** set the fields value: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @return BigInteger the value
   */
  public BigInteger getLateExemptCharges () {
    return this.LateExemptCharges;
  }
  /** Change the field to not being actively set: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   */
  public void unsetLateExemptCharges () {
    this._LateExemptChargesSet = false;
  }
  /** See if the field is actively set: LateExemptCharges (CMF_BALANCE_DETAIL.late_exempt_charges)
   * @return boolean whether the field is actively set
   */
  public boolean issetLateExemptCharges () {
    return this._LateExemptChargesSet;
  }
  /** set the fields value: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @return Integer the value
   */
  public Integer getCollectionIndicator () {
    return this.CollectionIndicator;
  }
  /** Change the field to not being actively set: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   */
  public void unsetCollectionIndicator () {
    this._CollectionIndicatorSet = false;
  }
  /** See if the field is actively set: CollectionIndicator (CMF_BALANCE_DETAIL.collection_indicator)
   * @return boolean whether the field is actively set
   */
  public boolean issetCollectionIndicator () {
    return this._CollectionIndicatorSet;
  }
  /** set the fields value: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("ChgDate") 
  ...
  /** get the value of the field: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @return Date the value
   */
  public Date getChgDate () {
    return this.ChgDate;
  }
  /** Change the field to not being actively set: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   */
  public void unsetChgDate () {
    this._ChgDateSet = false;
  }
  /** See if the field is actively set: ChgDate (CMF_BALANCE_DETAIL.chg_date)
   * @return boolean whether the field is actively set
   */
  public boolean issetChgDate () {
    return this._ChgDateSet;
  }
  /** set the fields value: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("ChgWho") 
  ...
  /** get the value of the field: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @return String the value
   */
  public String getChgWho () {
    return this.ChgWho;
  }
  /** Change the field to not being actively set: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   */
  public void unsetChgWho () {
    this._ChgWhoSet = false;
  }
  /** See if the field is actively set: ChgWho (CMF_BALANCE_DETAIL.chg_who)
   * @return boolean whether the field is actively set
   */
  public boolean issetChgWho () {
    return this._ChgWhoSet;
  }
  /** set the fields value: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("GlAmount") 
  ...
  /** get the value of the field: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @return BigInteger the value
   */
  public BigInteger getGlAmount () {
    return this.GlAmount;
  }
  /** Change the field to not being actively set: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   */
  public void unsetGlAmount () {
    this._GlAmountSet = false;
  }
  /** See if the field is actively set: GlAmount (CMF_BALANCE_DETAIL.gl_amount)
   * @return boolean whether the field is actively set
   */
  public boolean issetGlAmount () {
    return this._GlAmountSet;
  }
  /** set the fields value: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("RefinanceTrackingId") 
  public void setRefinanceTrackingId (Integer value) throws ServiceException
  {
    this.RefinanceTrackingId = value;
    this._RefinanceTrackingIdSet = true;
  }

  /** Retrieves the RefinanceTrackingId field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The RefinanceTrackingId field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the RefinanceTrackingId field
   */
   public String getRefinanceTrackingIdAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getRefinanceTrackingIdAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getRefinanceTrackingIdAsFormattedString");
       return fmtMgr.formatNumber(this.getRefinanceTrackingId(), _locale);
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("RefinanceTrackingId");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getRefinanceTrackingIdAsFormattedString");
       throw x;
     }
   }
  /** Sets the RefinanceTrackingId field from a formatted string
   *
   * @param _value the RefinanceTrackingId field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the RefinanceTrackingId field
   */
   public void setRefinanceTrackingIdFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getRefinanceTrackingIdFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setRefinanceTrackingId(fmtMgr.parseNumber(_value, _locale));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("RefinanceTrackingId");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setRefinanceTrackingIdFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setRefinanceTrackingIdFromFormattedString");
   }

  /** get the value of the field: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @return Integer the value
   */
  public Integer getRefinanceTrackingId () {
    return this.RefinanceTrackingId;
  }
  /** Change the field to not being actively set: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   */
  public void unsetRefinanceTrackingId () {
    this._RefinanceTrackingIdSet = false;
  }
  /** See if the field is actively set: RefinanceTrackingId (CMF_BALANCE_DETAIL.refinance_tracking_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetRefinanceTrackingId () {
    return this._RefinanceTrackingIdSet;
  }
  /** set the fields value: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  @QueryParam("RefinanceTrackingIdServ") 
  public void setRefinanceTrackingIdServ (Integer value) throws ServiceException
  {
    this.RefinanceTrackingIdServ = value;
    this._RefinanceTrackingIdServSet = true;
  }

  /** Retrieves the RefinanceTrackingIdServ field value as a formatted string
   *
   * @param _locale Locale settings used to format text based display values
   * @return The RefinanceTrackingIdServ field value in formatted form
   * @throws ServiceException thrown if an error occurs formatting the data for the RefinanceTrackingIdServ field
   */
   public String getRefinanceTrackingIdServAsFormattedString(Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getRefinanceTrackingIdServAsFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       if (Logger.TRACE) Logger.traceExit(this.getClass(), "getRefinanceTrackingIdServAsFormattedString");
       return fmtMgr.formatNumber(this.getRefinanceTrackingIdServ(), _locale);
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("RefinanceTrackingIdServ");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "getRefinanceTrackingIdServAsFormattedString");
       throw x;
     }
   }
  /** Sets the RefinanceTrackingIdServ field from a formatted string
   *
   * @param _value the RefinanceTrackingIdServ field value in formatted form
   * @param _locale Locale settings used to format text based display values
   * @throws ServiceException thrown if an error occurs parsing the data for the RefinanceTrackingIdServ field
   */
   public void setRefinanceTrackingIdServFromFormattedString(String _value, Locale _locale) throws ServiceException {
     if (Logger.TRACE) Logger.traceEntry(this.getClass(), "getRefinanceTrackingIdServFromFormattedString");
     try {
       FieldFormatMgr fmtMgr = FieldFormatMgr.getInstance();
       this.setRefinanceTrackingIdServ(fmtMgr.parseNumber(_value, _locale));
     } catch (ServiceException x) {
       x.setErrorObjectName(this.getClass().getName());
       x.setErrorObjectFieldName("RefinanceTrackingIdServ");
       if (Logger.TRACE) Logger.traceError(this.getClass(), "setRefinanceTrackingIdServFromFormattedString");
       throw x;
     }
     if (Logger.TRACE) Logger.traceExit(this.getClass(), "setRefinanceTrackingIdServFromFormattedString");
   }

  /** get the value of the field: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @return Integer the value
   */
  public Integer getRefinanceTrackingIdServ () {
    return this.RefinanceTrackingIdServ;
  }
  /** Change the field to not being actively set: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   */
  public void unsetRefinanceTrackingIdServ () {
    this._RefinanceTrackingIdServSet = false;
  }
  /** See if the field is actively set: RefinanceTrackingIdServ (CMF_BALANCE_DETAIL.refinance_tracking_id_serv)
   * @return boolean whether the field is actively set
   */
  public boolean issetRefinanceTrackingIdServ () {
    return this._RefinanceTrackingIdServSet;
  }
  /** set the fields value: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @return String the value
   */
  public String getExternalId () {
    return this.ExternalId;
  }
  /** Change the field to not being actively set: ExternalId (CMF_BALANCE_DETAIL.external_id)
   */
  public void unsetExternalId () {
    this._ExternalIdSet = false;
  }
  /** See if the field is actively set: ExternalId (CMF_BALANCE_DETAIL.external_id)
   * @return boolean whether the field is actively set
   */
  public boolean issetExternalId () {
    return this._ExternalIdSet;
  }
  /** set the fields value: Converted (CMF_BALANCE_DETAIL.converted)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: Converted (CMF_BALANCE_DETAIL.converted)
   * @return Integer the value
   */
  public Integer getConverted () {
    return this.Converted;
  }
  /** Change the field to not being actively set: Converted (CMF_BALANCE_DETAIL.converted)
   */
  public void unsetConverted () {
    this._ConvertedSet = false;
  }
  /** See if the field is actively set: Converted (CMF_BALANCE_DETAIL.converted)
   * @return boolean whether the field is actively set
   */
  public boolean issetConverted () {
    return this._ConvertedSet;
  }
  /** set the fields value: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @return BigInteger the value
   */
  public BigInteger getNewChargeCredits () {
    return this.NewChargeCredits;
  }
  /** Change the field to not being actively set: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   */
  public void unsetNewChargeCredits () {
    this._NewChargeCreditsSet = false;
  }
  /** See if the field is actively set: NewChargeCredits (CMF_BALANCE_DETAIL.new_charge_credits)
   * @return boolean whether the field is actively set
   */
  ...
  /** CMF_BALANCE_DETAIL.orig_ppdd_date field */
    if(!nonNullOnly || (OrigPpddDate != null))  _OrigPpddDateSet = flag;
  /** CMF_BALANCE_DETAIL.closed_date field */
  ...
  /** CMF_BALANCE_DETAIL.refinance_tracking_id field */
    if(!nonNullOnly || (RefinanceTrackingId != null))  _RefinanceTrackingIdSet = flag;
  /** CMF_BALANCE_DETAIL.refinance_tracking_id_serv field */
    if(!nonNullOnly || (RefinanceTrackingIdServ != null))  _RefinanceTrackingIdServSet = flag;
  /** CMF_BALANCE_DETAIL.external_id field */
