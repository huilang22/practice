 ...
 * Generated  File: GuiIndicatorObjectHelper.java
...
/** Helper class to convert GuiIndicatorObject JavaBean objects to/from HashMaps.
 */
public class GuiIndicatorObjectHelper implements ArubaObjectHelper
{
  /** convert GuiIndicatorObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (GuiIndicatorObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (GuiIndicatorObjectData in, Map record, String rootName)
  {
  ...
  /** convert GuiIndicatorObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (GuiIndicatorObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert GuiIndicatorObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (GuiIndicatorObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "GuiIndicatorObject";
  ...
  /** convert Map to GuiIndicatorObjectData.
   * @param record the Map containing the data to convert to the object
   * @return GuiIndicatorObjectData the converted object
   */
  public static GuiIndicatorObjectData fromMap (Map record)
  {
   ...
   * @return GuiIndicatorObjectData the converted object
   */
  public static GuiIndicatorObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to GuiIndicatorObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return GuiIndicatorObjectFilter the converted object
   */
  public static GuiIndicatorObjectFilter fromMapFilter (Map record) {
   ...
   * @return GuiIndicatorObjectFilter the converted object
   */
  public static GuiIndicatorObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "GuiIndicatorObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to GuiIndicatorObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return GuiIndicatorObjectDataList the converted object
   */
  public static GuiIndicatorObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to GuiIndicatorObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "GuiIndicatorObjectList")
   * @return GuiIndicatorObjectDataList the converted object
   */
  public static GuiIndicatorObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "GuiIndicatorObjectList";
    Object[] root = (Object[]) record.get (rootName);
    GuiIndicatorObjectData[] array = null;
    if (root != null)
    {
      array = new GuiIndicatorObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = GuiIndicatorObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new GuiIndicatorObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new GuiIndicatorObjectDataList (array, index, total);
  }
  /** convert GuiIndicatorObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (GuiIndicatorObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", GuiIndicatorObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert GuiIndicatorObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (GuiIndicatorObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return GuiIndicatorObjectData the converted object
   */
  public static GuiIndicatorObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    GuiIndicatorObjectData out = new GuiIndicatorObjectData ();

    out.Key = GuiIndicatorObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return GuiIndicatorObjectFilter the converted object
   */
  public static GuiIndicatorObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    GuiIndicatorObjectFilter out = new GuiIndicatorObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = GuiIndicatorObjectKeyHelper.getFilter ((Map) record.get ("Key"));
