 ...
 * Generated  File: PaymentObjectKeyFilter.java
...
/** Key Filter for PaymentObject object. */
public class PaymentObjectKeyFilter extends BaseFilter implements Serializable
{
  /** raw field for: BMF.tracking_id) */
  ...
  /** raw field for: BMF.tracking_id_serv) */
  ...
  private String _objName = "PaymentObjectKeyFilter";
  /** default constructor */
  public PaymentObjectKeyFilter ()
  {
  }
  /** copy constructor
   * @param other the filter to copy
   */
  public PaymentObjectKeyFilter (PaymentObjectKeyFilter other)
  {
  ...
  public String toString() {
    return PaymentObjectKeyHelper.toMap(this, null).toString();
  }
  public Map toMap() {
    return PaymentObjectKeyHelper.toMap(this, null);
  }
}
