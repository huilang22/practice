 ...
 * Generated  File: GenderTypeObjectHelper.java
...
/** Helper class to convert GenderTypeObject JavaBean objects to/from HashMaps.
 */
public class GenderTypeObjectHelper implements ArubaObjectHelper
{
  /** convert GenderTypeObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (GenderTypeObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (GenderTypeObjectData in, Map record, String rootName)
  {
  ...
  /** convert GenderTypeObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (GenderTypeObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert GenderTypeObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (GenderTypeObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "GenderTypeObject";
  ...
  /** convert Map to GenderTypeObjectData.
   * @param record the Map containing the data to convert to the object
   * @return GenderTypeObjectData the converted object
   */
  public static GenderTypeObjectData fromMap (Map record)
  {
   ...
   * @return GenderTypeObjectData the converted object
   */
  public static GenderTypeObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to GenderTypeObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return GenderTypeObjectFilter the converted object
   */
  public static GenderTypeObjectFilter fromMapFilter (Map record) {
   ...
   * @return GenderTypeObjectFilter the converted object
   */
  public static GenderTypeObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "GenderTypeObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to GenderTypeObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return GenderTypeObjectDataList the converted object
   */
  public static GenderTypeObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to GenderTypeObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "GenderTypeObjectList")
   * @return GenderTypeObjectDataList the converted object
   */
  public static GenderTypeObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "GenderTypeObjectList";
    Object[] root = (Object[]) record.get (rootName);
    GenderTypeObjectData[] array = null;
    if (root != null)
    {
      array = new GenderTypeObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = GenderTypeObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new GenderTypeObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new GenderTypeObjectDataList (array, index, total);
  }
  /** convert GenderTypeObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (GenderTypeObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", GenderTypeObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert GenderTypeObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (GenderTypeObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return GenderTypeObjectData the converted object
   */
  public static GenderTypeObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    GenderTypeObjectData out = new GenderTypeObjectData ();

    out.Key = GenderTypeObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return GenderTypeObjectFilter the converted object
   */
  public static GenderTypeObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    GenderTypeObjectFilter out = new GenderTypeObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = GenderTypeObjectKeyHelper.getFilter ((Map) record.get ("Key"));
