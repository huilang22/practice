 ...
 * Generated  File: ServerDefinitionObjectData.java
...
/** ServerDefinitionObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class ServerDefinitionObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public ServerDefinitionObjectKeyData Key = null;
  ...
  private String _objName = "ServerDefinitionObjectData";
  /** Default constructor */
  public ServerDefinitionObjectData ()
  {
    super ();
   ...
   */
  public ServerDefinitionObjectData (ServerDefinitionObjectData other)
  {

    if (other == null) return;
    this.Key = new ServerDefinitionObjectKeyData (other.Key);
   ...
   * @return ServerDefinitionObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public ServerDefinitionObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (ServerDefinitionObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setServerId (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new ServerDefinitionObjectKeyData ();
