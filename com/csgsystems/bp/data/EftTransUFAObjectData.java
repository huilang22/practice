 ...
 * Generated  File: EftTransUFAObjectData.java
...
/** EftTransUFAObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class EftTransUFAObjectData extends EftTransactionObjectData  implements Serializable
{

  /** PAYMENT_PROFILE.profile_id field */
  public    BigInteger ProfileId  = null;
  protected boolean _ProfileIdSet = false;
  private String _objName = "EftTransUFAObjectData";
  /** Default constructor */
  public EftTransUFAObjectData ()
  {
    super ();
   ...
   */
  public EftTransUFAObjectData (EftTransUFAObjectData other)
  {
   ...
   * @param other the object to copy
   */
  public EftTransUFAObjectData (EftTransactionObjectData other)
  {
    super (other);
