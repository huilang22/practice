 ...
 * Generated  File: ClearingHouseObjectData.java
...
/** ClearingHouseObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class ClearingHouseObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public ClearingHouseObjectKeyData Key = null;
  ...
  private String _objName = "ClearingHouseObjectData";
  /** Default constructor */
  public ClearingHouseObjectData ()
  {
    super ();
   ...
   */
  public ClearingHouseObjectData (ClearingHouseObjectData other)
  {

    if (other == null) return;
    this.Key = new ClearingHouseObjectKeyData (other.Key);
   ...
   * @return ClearingHouseObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public ClearingHouseObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (ClearingHouseObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setClearingHouseId (String value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new ClearingHouseObjectKeyData ();
