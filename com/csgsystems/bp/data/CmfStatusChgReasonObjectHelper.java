 ...
 * Generated  File: CmfStatusChgReasonObjectHelper.java
...
/** Helper class to convert CmfStatusChgReasonObject JavaBean objects to/from HashMaps.
 */
public class CmfStatusChgReasonObjectHelper implements ArubaObjectHelper
{
  /** convert CmfStatusChgReasonObjectData to a Map.
   * @param in     the object to convert to the Map
   * @param record use this Map instead of creating a new one (Optional)
   * @return Map   the output Map
   */
  public static Map toMap (CmfStatusChgReasonObjectData in, Map record)
  {
   ...
   * @return Map     the output Map
   */
  public static Map toMap (CmfStatusChgReasonObjectData in, Map record, String rootName)
  {
  ...
  /** convert CmfStatusChgReasonObjectFilter to a Map.
   * @param in       the filter object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map toMap (CmfStatusChgReasonObjectFilter in, Map record)
  {
    return toMap (in, record, null);
  }
  /** convert CmfStatusChgReasonObjectFilter to a Map.
   ...
   * @return Map     the output Map
   */
  public static Map toMap (CmfStatusChgReasonObjectFilter in, Map record, String rootName)
  {
    Integer iVal = null;
    if (record == null) record = new HashMap ();
    if (rootName == null) rootName = "CmfStatusChgReasonObject";
  ...
  /** convert Map to CmfStatusChgReasonObjectData.
   * @param record the Map containing the data to convert to the object
   * @return CmfStatusChgReasonObjectData the converted object
   */
  public static CmfStatusChgReasonObjectData fromMap (Map record)
  {
   ...
   * @return CmfStatusChgReasonObjectData the converted object
   */
  public static CmfStatusChgReasonObjectData fromMap (Map record, String rootName)
  {
  ...
  /** convert Map to CmfStatusChgReasonObjectFilter.
   * @param record the Map containing the data to convert to the object
   * @return CmfStatusChgReasonObjectFilter the converted object
   */
  public static CmfStatusChgReasonObjectFilter fromMapFilter (Map record) {
   ...
   * @return CmfStatusChgReasonObjectFilter the converted object
   */
  public static CmfStatusChgReasonObjectFilter fromMapFilter (Map record, String rootName) {
    if (record == null) return null;
    if (rootName == null) rootName = "CmfStatusChgReasonObject";
    Map root = (Map) record.get (rootName);
    if (root == null) return null;
  ...
  /** convert Map to CmfStatusChgReasonObjectDataList.
   * @param record   the Map containing the data to convert to the list
   * @return CmfStatusChgReasonObjectDataList the converted object
   */
  public static CmfStatusChgReasonObjectDataList fromMapList (Map record)
  {
    return fromMapList (record, null);
  }
  /** convert Map to CmfStatusChgReasonObjectDataList.
   * @param record   the Map containing the data to convert to thelist 
   * @param rootName the root name of the object in the mape (defaults to "CmfStatusChgReasonObjectList")
   * @return CmfStatusChgReasonObjectDataList the converted object
   */
  public static CmfStatusChgReasonObjectDataList fromMapList (Map record, String rootName)
  {
    if (record == null) return null;
    if (rootName == null) rootName = "CmfStatusChgReasonObjectList";
    Object[] root = (Object[]) record.get (rootName);
    CmfStatusChgReasonObjectData[] array = null;
    if (root != null)
    {
      array = new CmfStatusChgReasonObjectData[root.length];
      for (int i = 0; i < root.length; i++)
      {
        array[i] = CmfStatusChgReasonObjectHelper.getObj ((Map) root[i]);
      }
    }
    else
    {
      array = new CmfStatusChgReasonObjectData[0];
    }
    Integer count = (Integer) record.get ("Count");
    Integer index = (Integer) record.get ("Index");
    Integer total = (Integer) record.get ("TotalCount");
    return new CmfStatusChgReasonObjectDataList (array, index, total);
  }
  /** convert CmfStatusChgReasonObjectData to a Map (not including the root).
   * @param in       the object to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (CmfStatusChgReasonObjectData in, Map record)
  {
    Object[] list = null;
    if (record == null) record = new HashMap ();
    if (in == null) return record;

    if (in.Key != null) record.put ("Key", CmfStatusChgReasonObjectKeyHelper.getMap (in.Key, (Map) record.get ("Key")));
  ...
  /** convert CmfStatusChgReasonObjectFilter to a Map (not including the root).
   * @param in       the filter to convert to the Map
   * @param record   use this Map instead of creating a new one (Optional)
   * @return Map     the output Map
   */
  public static Map getMap (CmfStatusChgReasonObjectFilter in, Map record)
  {
    Object[] list = null;
    Map map = null;
    if (record == null) record = new HashMap ();
   ...
   * @return CmfStatusChgReasonObjectData the converted object
   */
  public static CmfStatusChgReasonObjectData getObj (Map record)
  {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    CmfStatusChgReasonObjectData out = new CmfStatusChgReasonObjectData ();

    out.Key = CmfStatusChgReasonObjectKeyHelper.getObj ((Map) record.get ("Key"));
   ...
   * @return CmfStatusChgReasonObjectFilter the converted object
   */
  public static CmfStatusChgReasonObjectFilter getFilter (Map record) {
    Object[] list = null;
    Object obj = null;
    if (record == null) return null;
    CmfStatusChgReasonObjectFilter out = new CmfStatusChgReasonObjectFilter ();
    Boolean Fetch = DataHelper.getFetch(record);
    if (Fetch != null) out.setFetch(Fetch);
    Integer Index = DataHelper.getIndex(record);
    if (Index != null) out.setIndex(Index);

    out.Key = CmfStatusChgReasonObjectKeyHelper.getFilter ((Map) record.get ("Key"));
