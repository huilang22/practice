 ...
 * Generated  File: ServiceCenterObjectData.java
...
/** ServiceCenterObjectData Object
 */
@XmlRootElement(namespace ="http://bp.comverse.com/data")
@XmlAccessorType (XmlAccessType.PROPERTY)
public class ServiceCenterObjectData extends BaseObjectData implements Serializable
{

  /** the object's key data */
  public ServiceCenterObjectKeyData Key = null;
  ...
  /** SERVICE_CENTERS.config_tag_id field */
  public    String ConfigTagId  = null;
  protected boolean _ConfigTagIdSet = false;
  private String _objName = "ServiceCenterObjectData";
  /** Default constructor */
  public ServiceCenterObjectData ()
  {
    super ();
   ...
   */
  public ServiceCenterObjectData (ServiceCenterObjectData other)
  {

    if (other == null) return;
    this.Key = new ServiceCenterObjectKeyData (other.Key);
   ...
   * @return ServiceCenterObjectKeyData
   */
  @JsonIgnore 
  @XmlTransient 
  public ServiceCenterObjectKeyData getKey ()
  {
    return this.Key;
  }
   ...
   */
  @JsonProperty 
  public void setKey (ServiceCenterObjectKeyData Key)
  {
    this.Key = Key;
  }
  ...
  public void setServiceCenterId (Integer value) throws ServiceException
  {
    ...
    if (this.Key == null) this.Key = new ServiceCenterObjectKeyData ();
  ...
  /** set the fields value: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @param value the value to set the field to
   * @throws ServiceException if attempt to set a non-nullable field to null
   */
  ...
  /** get the value of the field: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @return String the value
   */
  public String getConfigTagId () {
    return this.ConfigTagId;
  }
  /** Change the field to not being actively set: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   */
  public void unsetConfigTagId () {
    this._ConfigTagIdSet = false;
  }
  /** See if the field is actively set: ConfigTagId (SERVICE_CENTERS.config_tag_id)
   * @return boolean whether the field is actively set
   */
